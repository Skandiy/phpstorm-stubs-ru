 ...
 * @link https://php.net/manual/ru/function.stream-select.php
 ...
 * @link https://php.net/manual/ru/function.stream-context-create.php
 ...
 * @link https://php.net/manual/ru/function.stream-context-set-params.php
 ...
 * @link https://php.net/manual/ru/function.stream-context-get-params.php
 * @param resource $context <p>
 ...
 * @link https://php.net/manual/ru/function.stream-context-set-option.php
 * @param resource $context <p>
 ...
 * @link https://php.net/manual/ru/function.stream-context-get-options.php
 ...
 * @link https://php.net/manual/ru/function.stream-context-get-default.php
 ...
 * @link https://php.net/manual/ru/function.stream-context-set-default.php
 ...
 * @link https://php.net/manual/ru/function.stream-filter-prepend.php
...
/**
 * Attach a filter to a stream
 * @link https://php.net/manual/ru/function.stream-filter-append.php
 * @param resource $stream <p>
 * The target stream.
 * </p>
 * @param string $filter_name <p>
 ...
 * @link https://php.net/manual/ru/function.stream-filter-remove.php
 ...
 * @link https://php.net/manual/ru/function.stream-socket-client.php
 ...
 * @link https://php.net/manual/ru/function.stream-socket-server.php
 * @param string $address <p>
 ...
 * @link https://php.net/manual/ru/function.stream-socket-accept.php
 ...
 * @link https://php.net/manual/ru/function.stream-socket-get-name.php
 ...
 * @link https://php.net/manual/ru/function.stream-socket-recvfrom.php
 * @param resource $socket <p>
 * The remote socket.
 * </p>
 * @param int $length <p>
 ...
 * @link https://php.net/manual/ru/function.stream-socket-sendto.php
 * @param resource $socket <p>
 ...
 * @link https://php.net/manual/ru/function.stream-socket-enable-crypto.php
 * @param resource $stream <p>
 * The stream resource.
 * </p>
 * @param bool $enable <p>
 ...
 * @link https://php.net/manual/ru/function.stream-socket-shutdown.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/ru/function.stream-socket-pair.php
 * @param int $domain <p>
 ...
 * @link https://php.net/manual/ru/function.stream-copy-to-stream.php
 ...
 * @link https://php.net/manual/ru/function.stream-get-contents.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/ru/function.stream-supports-lock.php
 * @param resource $stream <p>
 * The stream to check.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://php.net/manual/ru/function.fgetcsv.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/ru/function.fputcsv.php
 ...
 * @link https://php.net/manual/ru/function.flock.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/ru/function.get-meta-tags.php
 ...
 * @link https://php.net/manual/ru/function.stream-set-write-buffer.php
 * @param resource $stream <p>
 * The file pointer.
 * </p>
 * @param int $size <p>
 ...
 * @link https://php.net/manual/ru/function.stream-set-read-buffer.php
 * @param resource $stream <p>
 * The file pointer.
 * </p>
 * @param int $size <p>
 ...
 * </p>
 * @link https://php.net/manual/ru/function.set-file-buffer.php
 ...
 * </p>
 * @link https://php.net/manual/ru/function.set-socket-blocking.php
 * @param resource $socket
 ...
 * @link https://php.net/manual/ru/function.stream-set-blocking.php
 * @param resource $stream <p>
 * The stream.
 * </p>
 * @param bool $enable <p>
 ...
 * Alias:
 * {@see stream_set_blocking}
 * @link https://php.net/manual/ru/function.socket-set-blocking.php
 * @param resource $stream <p>
 * The stream.
 * </p>
 * @param bool $enable <p>
 ...
 * @link https://php.net/manual/ru/function.stream-get-meta-data.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/ru/function.stream-get-line.php
 * @param resource $stream <p>
 * A valid file handle.
 * </p>
 * @param int $length <p>
 ...
 * @link https://php.net/manual/ru/function.stream-wrapper-register.php
 ...
 * @link https://php.net/manual/ru/function.stream-register-wrapper.php
 * @param string $protocol <p>
 * The wrapper name to be registered.
 * </p>
 * @param string $class <p>
 ...
 * @link https://php.net/manual/ru/function.stream-resolve-include-path.php
 ...
 * @link https://php.net/manual/ru/function.stream-wrapper-unregister.php
 * @param string $protocol <p>
 * </p>
 * @return bool true on success or false on failure.
 */
 ...
 * @link https://php.net/manual/ru/function.stream-wrapper-restore.php
 * @param string $protocol <p>
 * </p>
 * @return bool true on success or false on failure.
 */
 ...
 * @link https://php.net/manual/ru/function.stream-get-wrappers.php
 ...
 * @link https://php.net/manual/ru/function.stream-get-transports.php
 ...
 * @link https://php.net/manual/ru/function.stream-is-local.php
 ...
 * @link https://php.net/manual/ru/function.get-headers.php
 * @param string $url <p>
 * The target URL.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.stream-set-timeout.php
 * @param resource $stream <p>
 * The target stream.
 * </p>
 * @param int $seconds <p>
 ...
 * Set timeout period on a stream
 * @link https://php.net/manual/ru/function.socket-set-timeout.php
 * @param resource $stream <p>
 * The target stream.
 * </p>
 * @param int $seconds <p>
 ...
 * Retrieves header/meta data from streams/file pointers
 * @link https://php.net/manual/ru/function.socket-get-status.php
 * @param resource $stream <p>
 * The stream can be any stream created by fopen,
 * fsockopen and pfsockopen.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.realpath.php
 * @param string $path <p>
 ...
 * @link https://php.net/manual/ru/function.fnmatch.php
