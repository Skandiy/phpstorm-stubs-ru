...
namespace {
    ...
    /**
     * Создаёт массив.
     * @link https://php.net/manual/ru/function.array.php
     * @param mixed ...$_ [optional] <p>
     * Синтаксис "индекс => значения", разделённые запятыми, определяет индексы и их значения.
     * Индекс может быть строкой или целым числом. Если индекс опущен, будет автоматически сгенерирован числовой индекс, начиная с 0.
     * Если индекс - число, следующим сгенерированным индексом будет число, равное максимальному числовому индексу + 1.
     * Обратите внимание, что если определены два одинаковых индекса, последующий перезапишет предыдущий.
     * </p>
     * <p>
     ...
     * </p>
     * @return array Возвращает массив параметров. Параметрам может быть назначен индекс с помощью оператора =>.
     */
    function PS_UNRESERVE_PREFIX_array(...$_) {}

    /**
     * Присваивает переменным из списка значения подобно массиву.
     * @link https://php.net/manual/ru/function.list.php
     * @param mixed $var1 <p>Переменная.</p>
     * @param mixed ...$_ [optional] <p>Дополнительные переменные ...</p>
     * @return array Возвращает присвоенный массив.
     */
     ...
     * @link https://php.net/manual/ru/function.die.php
     ...
     * @link https://php.net/manual/ru/function.exit.php
     * @param int|string $status [optional] <p>
     * If status is a string, this function prints the status just before exiting.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/ru/function.empty.php
     ...
     * @link https://php.net/manual/ru/function.isset.php
     ...
     * @link https://php.net/manual/ru/function.unset.php
     ...
     * @link https://php.net/manual/ru/function.eval.php
     * @param string $code <p>
     ...
     * @link https://secure.php.net/manual/ru/class.generator.php
    ...
    final class Generator implements Iterator
    {
         ...
         * @link https://php.net/manual/ru/generator.wakeup.php
         * @return void
         */
...
namespace ___PHPSTORM_HELPERS {
    ...
    class object
    {
         ...
         *
         * param [ mixed $args [, $... ]]
         * @link https://php.net/manual/ru/language.oop5.decon.php
         */
         ...
         * @return mixed
         * @link https://php.net/manual/ru/language.oop5.overloading.php#language.oop5.overloading.methods
         */
         ...
         * @param string $name
         * @return mixed
         * @link https://php.net/manual/ru/language.oop5.overloading.php#language.oop5.overloading.members
         */
         ...
         *
         * @return string[]
         * @link https://php.net/manual/ru/language.oop5.magic.php#language.oop5.magic.sleep
         */
         ...
         *
         * @return string
         * @link https://php.net/manual/ru/language.oop5.magic.php#language.oop5.magic.tostring
         */
         ...
         *
         * @return mixed
         * @link https://php.net/manual/ru/language.oop5.magic.php#language.oop5.magic.invoke
         */
         ...
         *
         * @return array|null
         * @link https://php.net/manual/ru/language.oop5.magic.php#language.oop5.magic.debuginfo
         */
         ...
         * @return object
         * @link https://php.net/manual/ru/language.oop5.magic.php#language.oop5.magic.set-state
         */
         ...
         *
         * @return void
         * @link https://php.net/manual/ru/language.oop5.cloning.php
         */
