 ...
 *
 * @link https://php.net/manual/ru/function.xhprof-enable.php
 *
 * @param int   $flags   <p>Optional flags to add additional information to the profiling. See the a
 *                       href="https://secure.php.net/manual/ru/xhprof.constants.php">XHprof constants</a> for further
 ...
 *
 * @link https://php.net/manual/ru/function.xhprof-disable.php
 ...
 *
 * @link https://php.net/manual/ru/function.xhprof-sample-enable.php
 * @return null
 */
 ...
 *
 * @link https://php.net/manual/ru/function.xhprof-sample-disable.php
 * @return array an array of xhprof sample data, from the run.
 */
function xhprof_sample_disable() {}

/**
 * @link https://php.net/manual/ru/xhprof.constants.php#constant.xhprof-flags-no-builtins
 */
const XHPROF_FLAGS_NO_BUILTINS = 1;
/**
 * @link https://php.net/manual/ru/xhprof.constants.php#constant.xhprof-flags-cpu
 */
const XHPROF_FLAGS_CPU = 2;
/**
 * @link https://php.net/manual/ru/xhprof.constants.php##constant.xhprof-flags-memory
 */
