...
class Judy implements ArrayAccess
{
     ...
     * @link https://php.net/manual/ru/judy.construct.php
     ...
     * @link https://php.net/manual/ru/judy.destruct.php
     */
     ...
     * @link https://php.net/manual/ru/judy.bycount.php
     ...
     * @link https://php.net/manual/ru/judy.count.php
     ...
     * @link https://php.net/manual/ru/judy.first.php
     ...
     * @link https://php.net/manual/ru/judy.firstempty.php
     * @param mixed $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/ru/judy.free.php
     */
     ...
     * @link https://php.net/manual/ru/judy.gettype.php
     ...
     * @link https://php.net/manual/ru/judy.last.php
     ...
     * @link https://php.net/manual/ru/judy.lastempty.php
     * @param int|string $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/ru/judy.memoryusage.php
     ...
     * @link https://php.net/manual/ru/judy.next.php
     ...
     * @link https://php.net/manual/ru/judy.nextempty.php
     ...
     * @link https://php.net/manual/ru/judy.offsetexists.php
     ...
     * @link https://php.net/manual/ru/judy.offsetget.php
     * @param mixed $offset <p>An offset to check for.</p>
     ...
     * @link https://php.net/manual/ru/judy.offsetset.php
     ...
     * (PECL judy &gt;= 0.1.1)<br/>
     * Unsets an offset.
     * @link https://php.net/manual/ru/judy.offsetunset.php
     * @param mixed $offset <p>The offset to assign the value to.</p>
     */
     ...
     * @link https://php.net/manual/ru/judy.prev.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/ru/judy.prevempty.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/ru/judy.size.php
     * @param int $index_start [optional] <p>Start counting from the given index. Default is first index.</p>
     * @param int $index_end [optional] <p>Stop counting when reaching this index. Default is last index.</p>
     * @return int <p>Return the number of elements.</p>
     */
