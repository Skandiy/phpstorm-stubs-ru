 ...
 * @link https://php.net/manual/ru/class.imagick.php
 */
class Imagick implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/ru/imagick.optimizeimagelayers.php
     ...
     * @link https://php.net/manual/ru/imagick.compareimagelayers.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/ru/imagick.pingimageblob.php
     ...
     * @link https://php.net/manual/ru/imagick.pingimagefile.php
     ...
     * @link https://php.net/manual/ru/imagick.transposeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.transverseimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.trimimage.php
     * @param float $fuzz <p>
     ...
     * @link https://php.net/manual/ru/imagick.waveimage.php
     ...
     * @link https://php.net/manual/ru/imagick.vignetteimage.php
     ...
     * @link https://php.net/manual/ru/imagick.uniqueimagecolors.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.getimagematte.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagematte.php
     * @param bool $matte <p>
     ...
     * @link https://php.net/manual/ru/imagick.adaptiveresizeimage.php
     ...
     * @link https://php.net/manual/ru/imagick.sketchimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a 3D effect
     * @link https://php.net/manual/ru/imagick.shadeimage.php
     * @param bool $gray <p>
     ...
     * @link https://php.net/manual/ru/imagick.getsizeoffset.php
     ...
     * @link https://php.net/manual/ru/imagick.setsizeoffset.php
     * @param int $columns <p>
     * The width in pixels.
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/ru/imagick.adaptiveblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     ...
     * @link https://php.net/manual/ru/imagick.contraststretchimage.php
     ...
     * @link https://php.net/manual/ru/imagick.adaptivesharpenimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.randomthresholdimage.php
     * @param float $low <p>
     * The low point
     * </p>
     * @param float $high <p>
     ...
     * @link https://php.net/manual/ru/imagick.roundcorners.php
     ...
     * @link https://php.net/manual/ru/imagick.setiteratorindex.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/imagick.getiteratorindex.php
     ...
     * @link https://php.net/manual/ru/imagick.transformimage.php
     * @param string $crop <p>
     ...
     * @link https://php.net/manual/ru/imagick.setimageopacity.php
     ...
     * @link https://php.net/manual/ru/imagick.orderedposterizeimage.php
     ...
     * @link https://php.net/manual/ru/imagick.polaroidimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageproperty.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/imagick.setimageproperty.php
     * @param string $name
     * @param string $value
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimageinterpolatemethod.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimageinterpolatemethod.php
     ...
     * @link https://php.net/manual/ru/imagick.linearstretchimage.php
     * @param float $blackPoint <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagelength.php
     ...
     * Set image size
     * @link https://php.net/manual/ru/imagick.extentimage.php
     * @param int $width <p>
     * The new width
     * </p>
     * @param int $height <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimageorientation.php
     ...
     * @link https://php.net/manual/ru/imagick.setimageorientation.php
     ...
     * @link https://php.net/manual/ru/imagick.paintfloodfillimage.php
     * @param mixed $fill <p>
     ...
     * @link https://php.net/manual/ru/imagick.clutimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageproperties.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageprofiles.php
     * @param string $pattern [optional] <p>
     ...
     * @link https://php.net/manual/ru/imagick.distortimage.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/ru/imagick.writeimagefile.php
     * @param resource $filehandle <p>
     ...
     * @link https://php.net/manual/ru/imagick.writeimagesfile.php
     * @param resource $filehandle <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Reset image page
     * @link https://php.net/manual/ru/imagick.resetimagepage.php
     * @param string $page <p>
     ...
     * @link https://php.net/manual/ru/imagick.setimageclipmask.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageclipmask.php
     ...
     * @link https://php.net/manual/ru/imagick.animateimages.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Recolors image
     * @link https://php.net/manual/ru/imagick.recolorimage.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Sets font
     * @link https://php.net/manual/ru/imagick.setfont.php
     * @param string $font <p>
     ...
     * (PECL imagick 2.1.0)<br/>
     * Gets font
     * @link https://php.net/manual/ru/imagick.getfont.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Sets point size
     * @link https://php.net/manual/ru/imagick.setpointsize.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Gets point size
     * @link https://php.net/manual/ru/imagick.getpointsize.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Merges image layers
     * @link https://php.net/manual/ru/imagick.mergeimagelayers.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagealphachannel.php
     * @param int $mode <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/ru/imagick.floodfillpaintimage.php
     * @param mixed $fill <p>
     * ImagickPixel object or a string containing the fill color
     * </p>
     * @param float $fuzz <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/ru/imagick.opaquepaintimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/ru/imagick.transparentpaintimage.php
     * @param mixed $target <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Animates an image or images
     * @link https://php.net/manual/ru/imagick.liquidrescaleimage.php
     * @param int $width <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Enciphers an image
     * @link https://php.net/manual/ru/imagick.encipherimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Deciphers an image
     * @link https://php.net/manual/ru/imagick.decipherimage.php
     * @param string $passphrase <p>
     * The passphrase
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * (No version information available, might only be in SVN)<br/>
     * Sets the gravity
     * @link https://php.net/manual/ru/imagick.setgravity.php
     * @param int $gravity <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Gets the gravity
     * @link https://php.net/manual/ru/imagick.getgravity.php
     ...
     * Gets channel range
     * @link https://php.net/manual/ru/imagick.getimagechannelrange.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagealphachannel.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagechanneldistortions.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagegravity.php
     * @param int $gravity <p>
     * The gravity property. Refer to the list of
     * gravity constants.
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagegravity.php
     ...
     * @link https://php.net/manual/ru/imagick.importimagepixels.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/ru/imagick.deskewimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Segments an image
     * @link https://php.net/manual/ru/imagick.segmentimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Interpolates colors
     * @link https://php.net/manual/ru/imagick.sparsecolorimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Remaps image colors
     * @link https://php.net/manual/ru/imagick.remapimage.php
     ...
     * @link https://php.net/manual/ru/imagick.exportimagepixels.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagechannelkurtosis.php
     * @param int $channel [optional] <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.functionimage.php
     ...
     * @link https://php.net/manual/ru/imagick.haldclutimage.php
    ...
    /**
     * @link https://www.php.net/manual/ru/imagick.blueshiftimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Get image artifact
     * @link https://php.net/manual/ru/imagick.getimageartifact.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Set image artifact
     * @link https://php.net/manual/ru/imagick.setimageartifact.php
     * @param string $artifact <p>
     * The name of the artifact
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.deleteimageartifact.php
     * @param string $artifact <p>
     ...
     * Gets the colorspace
     * @link https://php.net/manual/ru/imagick.getcolorspace.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Set colorspace
     * @link https://php.net/manual/ru/imagick.setcolorspace.php
     * @param int $COLORSPACE <p>
     * One of the COLORSPACE constants
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/ru/imagick.construct.php
     * @param mixed $files <p>
     ...
     * @link https://php.net/manual/ru/imagick.getpixeliterator.php
     ...
     * @link https://php.net/manual/ru/imagick.getpixelregioniterator.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/ru/imagick.readimage.php
     ...
     * @link https://php.net/manual/ru/imagick.readimageblob.php
     * @param string $image
     ...
     * @link https://php.net/manual/ru/imagick.setimageformat.php
     ...
     * @link https://php.net/manual/ru/imagick.scaleimage.php
     * @param int $cols
     * @param int $rows
     ...
     * @link https://php.net/manual/ru/imagick.writeimage.php
     * @param string $filename [optional] <p>
     ...
     * @link https://php.net/manual/ru/imagick.writeimages.php
     * @param string $filename
     * @param bool $adjoin
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.blurimage.php
     * @param float $radius <p>
     * Blur radius
     * </p>
     * @param float $sigma <p>
     ...
     * @link https://php.net/manual/ru/imagick.thumbnailimage.php
     * @param int $columns <p>
     * Image width
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/ru/imagick.cropthumbnailimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagefilename.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagefilename.php
     * @param string $filename
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.getimageformat.php
    ...
    /**
     * @link https://secure.php.net/manual/ru/imagick.getimagemimetype.php
     ...
     * @link https://php.net/manual/ru/imagick.removeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.destroy.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.clear.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the image length in bytes
     * @link https://php.net/manual/ru/imagick.getimagesize.php
     * @return int an int containing the current image size.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.getimageblob.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagesblob.php
     ...
     * @link https://php.net/manual/ru/imagick.setfirstiterator.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setlastiterator.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.previousimage.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.nextimage.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.haspreviousimage.php
     ...
     * @link https://php.net/manual/ru/imagick.hasnextimage.php
     * @return bool <b>TRUE</b> if the object has more images when traversing the list in the
     ...
     * (PECL imagick 2.0.0)<br/>
     * Set the iterator position
     * @link https://php.net/manual/ru/imagick.setimageindex.php
     * @param int $index <p>
     * The position to set the iterator to
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * (PECL imagick 2.0.0)<br/>
     * Gets the index of the current active image
     * @link https://php.net/manual/ru/imagick.getimageindex.php
     * @return int an integer containing the index of the image in the stack.
     */
    #[Deprecated]
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagick.commentimage.php
     ...
     * @link https://php.net/manual/ru/imagick.cropimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/ru/imagick.labelimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagegeometry.php
     ...
     * @link https://php.net/manual/ru/imagick.drawimage.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagecompressionquality.php
     * @param int $quality <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagecompressionquality.php
     ...
     * @link https://php.net/manual/ru/imagick.annotateimage.php
     ...
     * @link https://php.net/manual/ru/imagick.compositeimage.php
     ...
     * @link https://php.net/manual/ru/imagick.modulateimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagecolors.php
     ...
     * @link https://php.net/manual/ru/imagick.montageimage.php
     * @param ImagickDraw $draw <p>
     ...
     * @link https://php.net/manual/ru/imagick.identifyimage.php
     ...
     * @link https://php.net/manual/ru/imagick.thresholdimage.php
     ...
     * @link https://php.net/manual/ru/imagick.adaptivethresholdimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/ru/imagick.blackthresholdimage.php
     ...
     * @link https://php.net/manual/ru/imagick.whitethresholdimage.php
     ...
     * @link https://php.net/manual/ru/imagick.appendimages.php
     ...
     * @link https://php.net/manual/ru/imagick.charcoalimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel
     * </p>
     * @param float $sigma <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Enhances the contrast of a color image
     * @link https://php.net/manual/ru/imagick.normalizeimage.php
     * @param int $channel [optional] <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/ru/imagick.oilpaintimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.posterizeimage.php
     * @param int $levels
     * @param bool $dither
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.radialblurimage.php
     * @param float $angle
     * @param int $channel [optional]
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.raiseimage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/ru/imagick.resampleimage.php
     ...
     * In Imagick 3.0.0 and later the image would be scaled up to size 400x300 as this is the "best fit" for the given dimensions. If bestfit parameter is used both width and height must be given.
     * @link https://php.net/manual/ru/imagick.resizeimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Offsets an image
     * @link https://php.net/manual/ru/imagick.rollimage.php
     * @param int $x <p>
     * The X offset.
     * </p>
     * @param int $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Rotates an image
     * @link https://php.net/manual/ru/imagick.rotateimage.php
     ...
     * @link https://php.net/manual/ru/imagick.sampleimage.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.solarizeimage.php
     * @param int $threshold
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.shadowimage.php
     * @param float $opacity
     * @param float $sigma
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/ru/imagick.setimagebackgroundcolor.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagecompose.php
     * @param int $compose
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagecompression.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagedelay.php
     * @param int $delay <p>
     ...
     * @link https://php.net/manual/ru/imagick.setimagedepth.php
     * @param int $depth
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagegamma.php
     * @param float $gamma
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimageiterations.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagemattecolor.php
     * @param mixed $matte
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagepage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/ru/imagick.setimageresolution.php
     * @param float $x_resolution
     * @param float $y_resolution
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimagescene.php
     * @param int $scene
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagetickspersecond.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image type
     * @link https://php.net/manual/ru/imagick.setimagetype.php
     ...
     * @link https://php.net/manual/ru/imagick.setimageunits.php
     * @param int $units
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sharpens an image
     * @link https://php.net/manual/ru/imagick.sharpenimage.php
     * @param float $radius
     * @param float $sigma
     * @param int $channel [optional]
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/ru/imagick.shaveimage.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.shearimage.php
     * @param mixed $background <p>
     * The background color
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.spliceimage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/ru/imagick.pingimage.php
     ...
     * @link https://php.net/manual/ru/imagick.readimagefile.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Displays an image
     * @link https://php.net/manual/ru/imagick.displayimage.php
     ...
     * @link https://php.net/manual/ru/imagick.displayimages.php
     * @param string $servername <p>
     * The X server name
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/ru/imagick.spreadimage.php
     * @param float $radius
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.swirlimage.php
     * @param float $degrees
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.stripimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.queryformats.php
     ...
     * @link https://php.net/manual/ru/imagick.queryfonts.php
     * @param string $pattern [optional] <p>
     * The query pattern
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.queryfontmetrics.php
     * @param ImagickDraw $properties <p>
     ...
     * @link https://php.net/manual/ru/imagick.steganoimage.php
     ...
     * @link https://php.net/manual/ru/imagick.addnoiseimage.php
     ...
     * @link https://php.net/manual/ru/imagick.motionblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     * </p>
     * @param float $sigma <p>
     ...
     * @link https://php.net/manual/ru/imagick.mosaicimages.php
     * @return Imagick <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Deprecated]
     ...
     * @link https://php.net/manual/ru/imagick.morphimages.php
     ...
     * @link https://php.net/manual/ru/imagick.minifyimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Transforms an image
     * @link https://php.net/manual/ru/imagick.affinetransformimage.php
     ...
     * @link https://php.net/manual/ru/imagick.averageimages.php
     ...
     * @link https://php.net/manual/ru/imagick.borderimage.php
     * @param mixed $bordercolor <p>
     * ImagickPixel object or a string containing the border color
     * </p>
     * @param int $width <p>
     ...
     * @link https://php.net/manual/ru/imagick.chopimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/ru/imagick.clipimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.clippathimage.php
     ...
     * @link https://php.net/manual/ru/imagick.coalesceimages.php
     * @return Imagick a new Imagick object on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/ru/imagick.colorfloodfillimage.php
     * @param mixed $fill <p>
     ...
     * @link https://php.net/manual/ru/imagick.colorizeimage.php
     ...
     * @link https://php.net/manual/ru/imagick.compareimagechannels.php
     ...
     * @link https://php.net/manual/ru/imagick.compareimages.php
     ...
     * @link https://php.net/manual/ru/imagick.contrastimage.php
     ...
     * @link https://php.net/manual/ru/imagick.combineimages.php
     * @param int $channelType <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/ru/imagick.convolveimage.php
     ...
     * @link https://php.net/manual/ru/imagick.cyclecolormapimage.php
     ...
     * @link https://php.net/manual/ru/imagick.deconstructimages.php
     * @return Imagick a new Imagick object on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.despeckleimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.edgeimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.embossimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.enhanceimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.equalizeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.evaluateimage.php
     * @param int $op <p>
     ...
     * </pre>
     * @link https://php.net/manual/ru/imagick.flattenimages.php
     * @return Imagick Returns an Imagick object containing the merged image.
     * @throws ImagickException Throws ImagickException on error.
     * @since 2.0.0
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a vertical mirror image
     * @link https://php.net/manual/ru/imagick.flipimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a horizontal mirror image
     * @link https://php.net/manual/ru/imagick.flopimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.frameimage.php
     ...
     * @link https://php.net/manual/ru/imagick.fximage.php
     ...
     * @link https://php.net/manual/ru/imagick.gammaimage.php
     * @param float $gamma <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Blurs an image
     * @link https://php.net/manual/ru/imagick.gaussianblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     * </p>
     * @param float $sigma <p>
    ...
    /**
     * @link https://www.php.net/manual/ru/imagick.getimageattribute.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagebackgroundcolor.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageblueprimary.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagebordercolor.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagechanneldepth.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     * @return int <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/ru/imagick.getimagechanneldistortion.php
     * @param Imagick $reference <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagechannelextrema.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/ru/imagick.getimagechannelmean.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/ru/imagick.getimagechannelstatistics.php
     * @return array
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagick.getimagecolormapcolor.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimagecolorspace.php
     * @return int <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagick.getimagecompose.php
     * @return int <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagick.getimagedelay.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagedepth.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Compares an image to a reconstructed image
     * @link https://php.net/manual/ru/imagick.getimagedistortion.php
     * @param Imagick $reference <p>
     * Imagick object to compare to.
     * </p>
     * @param int $metric <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimageextrema.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagedispose.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagegamma.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagegreenprimary.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageheight.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagehistogram.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageinterlacescheme.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageiterations.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagemattecolor.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagepage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagepixelcolor.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimageprofile.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/imagick.getimageredprimary.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagerenderingintent.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageresolution.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagescene.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagesignature.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagetickspersecond.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagetype.php
     ...
     * @link https://php.net/manual/ru/imagick.getimageunits.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagevirtualpixelmethod.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagewhitepoint.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagewidth.php
     ...
     * @link https://php.net/manual/ru/imagick.getnumberimages.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagetotalinkdensity.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Extracts a region of the image
     * @link https://php.net/manual/ru/imagick.getimageregion.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/ru/imagick.implodeimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.levelimage.php
     * @param float $blackPoint <p>
     * The image black point
     * </p>
     * @param float $gamma <p>
     ...
     * @link https://php.net/manual/ru/imagick.magnifyimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.mapimage.php
     * @param Imagick $map
     * @param bool $dither
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.mattefloodfillimage.php
     * @param float $alpha <p>
     * The level of transparency: 1.0 is fully opaque and 0.0 is fully
     * transparent.
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.medianfilterimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/ru/imagick.negateimage.php
     * @param bool $gray <p>
     ...
     * @link https://php.net/manual/ru/imagick.paintopaqueimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/ru/imagick.painttransparentimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/ru/imagick.previewimages.php
     * @param int $preview <p>
     ...
     * @link https://php.net/manual/ru/imagick.profileimage.php
     * @param string $name
     ...
     * @link https://php.net/manual/ru/imagick.quantizeimage.php
     ...
     * @link https://php.net/manual/ru/imagick.quantizeimages.php
     * @param int $numberColors
     * @param int $colorspace
     * @param int $treedepth
     * @param bool $dither
     ...
     * @link https://php.net/manual/ru/imagick.reducenoiseimage.php
     * @param float $radius
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.removeimageprofile.php
     * @param string $name
     ...
     * @link https://php.net/manual/ru/imagick.separateimagechannel.php
     * @param int $channel
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.sepiatoneimage.php
     * @param float $threshold
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagebias.php
     * @param float $bias
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimageblueprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimagebordercolor.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagechanneldepth.php
     * @param int $channel
     * @param int $depth
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimagecolormapcolor.php
     * @param int $index
     ...
     * @link https://php.net/manual/ru/imagick.setimagecolorspace.php
     * @param int $colorspace <p>
     * One of the COLORSPACE constants
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/ru/imagick.setimagedispose.php
     * @param int $dispose
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image size
     * @link https://php.net/manual/ru/imagick.setimageextent.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimagegreenprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image compression
     * @link https://php.net/manual/ru/imagick.setimageinterlacescheme.php
     ...
     * @link https://php.net/manual/ru/imagick.setimageprofile.php
     * @param string $name
     * @param string $profile
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimageredprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setimagerenderingintent.php
     ...
     * @link https://php.net/manual/ru/imagick.setimagevirtualpixelmethod.php
     * @param int $method
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setimagewhitepoint.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.sigmoidalcontrastimage.php
     * @param bool $sharpen
     * @param float $alpha
     * @param float $beta
     * @param int $channel [optional]
     ...
     * @link https://php.net/manual/ru/imagick.stereoimage.php
     ...
     * @link https://php.net/manual/ru/imagick.textureimage.php
     ...
     * If legacy is true, the behaviour of this function is incorrect, but consistent with how it behaved before Imagick version 3.4.0
     * @link https://php.net/manual/ru/imagick.tintimage.php
     * @param mixed $tint
     * @param mixed $opacity
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sharpens an image
     * @link https://php.net/manual/ru/imagick.unsharpmaskimage.php
     * @param float $radius
     * @param float $sigma
     * @param float $amount
     * @param float $threshold
     ...
     * @link https://php.net/manual/ru/imagick.getimage.php
     ...
     * @link https://php.net/manual/ru/imagick.addimage.php
     ...
     * @link https://php.net/manual/ru/imagick.setimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a new image
     * @link https://php.net/manual/ru/imagick.newimage.php
     * @param int $cols <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a new image
     * @link https://php.net/manual/ru/imagick.newpseudoimage.php
     * @param int $columns <p>
     * columns in the new image
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/ru/imagick.getcompression.php
     ...
     * @link https://php.net/manual/ru/imagick.getcompressionquality.php
     ...
     * @link https://php.net/manual/ru/imagick.getcopyright.php
     ...
     * @link https://php.net/manual/ru/imagick.getfilename.php
     ...
     * @link https://php.net/manual/ru/imagick.getformat.php
     ...
     * @link https://php.net/manual/ru/imagick.gethomeurl.php
     ...
     * @link https://php.net/manual/ru/imagick.getinterlacescheme.php
     ...
     * @link https://php.net/manual/ru/imagick.getoption.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/imagick.getpackagename.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the page geometry
     * @link https://php.net/manual/ru/imagick.getpage.php
     ...
     * @link https://php.net/manual/ru/imagick.getquantumdepth.php
     ...
     * @link https://php.net/manual/ru/imagick.getquantumrange.php
     ...
     * @link https://php.net/manual/ru/imagick.getreleasedate.php
     ...
     * @link https://php.net/manual/ru/imagick.getresource.php
     * @param int $type <p>
     ...
     * @link https://php.net/manual/ru/imagick.getresourcelimit.php
     * @param int $type <p>
     * Refer to the list of resourcetype constants.
     * </p>
     ...
     * @link https://php.net/manual/ru/imagick.getsamplingfactors.php
     ...
     * @link https://php.net/manual/ru/imagick.getsize.php
     ...
     * @link https://php.net/manual/ru/imagick.getversion.php
     ...
     * @link https://php.net/manual/ru/imagick.setbackgroundcolor.php
     * @param mixed $background
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setcompression.php
     ...
     * @link https://php.net/manual/ru/imagick.setcompressionquality.php
     * @param int $quality
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setfilename.php
     * @param string $filename
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setformat.php
     * @param string $format
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image compression
     * @link https://php.net/manual/ru/imagick.setinterlacescheme.php
     * @param int $interlace_scheme
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Set an option
     * @link https://php.net/manual/ru/imagick.setoption.php
     * @param string $key
     * @param string $value
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.setpage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/ru/imagick.setresourcelimit.php
     * @param int $type <p>
     * Refer to the list of resourcetype constants.
     * </p>
     * @param int $limit <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image resolution
     * @link https://php.net/manual/ru/imagick.setresolution.php
     ...
     * @link https://php.net/manual/ru/imagick.setsamplingfactors.php
     * @param array $factors
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.setsize.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.settype.php
     * @param int $image_type
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.valid.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagick.current.php
     ...
     * @link https://php.net/manual/ru/imagick.brightnesscontrastimage.php
     * @param float $brightness
     ...
     * @link https://php.net/manual/ru/imagick.morphology.php
    ...
    /**
     * Applies a custom convolution kernel to the image.
     * @link https://php.net/manual/ru/imagick.filter.php
     ...
     * @link https://php.net/manual/ru/imagick.colormatriximage.php
     ...
     * @link https://php.net/manual/ru/imagick.deleteimageproperty.php
     ...
     * @link https://php.net/manual/ru/imagick.forwardfouriertransformimage.php
     ...
     * @link https://php.net/manual/ru/imagick.getimagecompression.php
     * @return int
     * @since 3.3.0
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagick.getregistry.php
     * @param string $key
     * @return string|false
     ...
     * @link https://php.net/manual/ru/imagick.getquantum.php
     * @return int
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/ru/imagick.identifyformat.php
     ...
     * @link https://php.net/manual/ru/imagick.inversefouriertransformimage.php
     ...
     * @link https://php.net/manual/ru/imagick.listregistry.php
     ...
     * @link https://php.net/manual/ru/imagick.rotationalblurimage.php
     * @param float $angle
     * @param int $CHANNEL
     * @return void
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/ru/imagick.selectiveblurimage.php
     * @param float $radius
     * @param float $sigma
     * @param float $threshold
    ...
    /**
     * @link https://php.net/manual/ru/imagick.setimagebiasquantum.php
     * @param string $bias
     * @return void
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/ru/imagick.setprogressmonitor.php
     ...
     * @link https://php.net/manual/ru/imagick.setregistry.php
     * @param string $key
     * @param string $value
     * @return void
     * @since 3.3.0
     ...
     * @link https://php.net/manual/ru/imagick.statisticimage.php
     * @param int $type
     * @param int $width
     * @param int $height
     * @param int $channel [optional]
     ...
     *
     * @link https://php.net/manual/ru/imagick.subimagematch.php
 ...
 * @link https://php.net/manual/ru/class.imagickdraw.php
 */
class ImagickDraw
{
     ...
     * @link https://php.net/manual/ru/imagickdraw.construct.php
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfillcolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfillalpha.php
     * @param float $opacity <p>
     * fill alpha
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokecolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokealpha.php
     * @param float $opacity <p>
     * opacity
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokewidth.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.clear.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a circle
     * @link https://php.net/manual/ru/imagickdraw.circle.php
     * @param float $ox <p>
     * origin x coordinate
     * </p>
     * @param float $oy <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.annotation.php
     * @param float $x <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.settextantialias.php
     * @param bool $antiAlias
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.settextencoding.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfont.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfontfamily.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfontsize.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfontstyle.php
     * @param int $style <p>
     * STYLETYPE_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfontweight.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the font
     * @link https://php.net/manual/ru/imagickdraw.getfont.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfontfamily.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfontsize.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfontstyle.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfontweight.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.destroy.php
     * @return bool No value is returned.
     */
    public function destroy() {}
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a rectangle
     * @link https://php.net/manual/ru/imagickdraw.rectangle.php
     * @param float $x1 <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.roundrectangle.php
     * @param float $x1 <p>
     * x coordinate of the top left corner
     * </p>
     * @param float $y1 <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.ellipse.php
     * @param float $ox
     * @param float $oy
     * @param float $rx
     * @param float $ry
     ...
     * @link https://php.net/manual/ru/imagickdraw.skewx.php
     * @param float $degrees <p>
     * degrees to skew
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.skewy.php
     * @param float $degrees <p>
     * degrees to skew
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.translate.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line
     * @link https://php.net/manual/ru/imagickdraw.line.php
     * @param float $sx <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws an arc
     * @link https://php.net/manual/ru/imagickdraw.arc.php
     * @param float $sx <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.matte.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a polygon
     * @link https://php.net/manual/ru/imagickdraw.polygon.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a point
     * @link https://php.net/manual/ru/imagickdraw.point.php
     * @param float $x <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.gettextdecoration.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.gettextencoding.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfontstretch.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokeantialias.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.settextalignment.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.settextdecoration.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.settextundercolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setviewbox.php
     * @param int $x1 <p>
     * left x coordinate
     * </p>
     * @param int $y1 <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.affine.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.bezier.php
     * @param array $coordinates <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.composite.php
     * @param int $compose <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.color.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Adds a comment
     * @link https://php.net/manual/ru/imagickdraw.comment.php
     * @param string $comment <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.getclippath.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getcliprule.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getclipunits.php
     * @return int an int on success.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfillcolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfillopacity.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getfillrule.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getgravity.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokeantialias.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokecolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokedasharray.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokedashoffset.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokelinecap.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokelinejoin.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokemiterlimit.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokeopacity.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getstrokewidth.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.gettextalignment.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.gettextantialias.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.getvectorgraphics.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.gettextundercolor.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathclose.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetoabsolute.php
     * @param float $x1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetorelative.php
     * @param float $x1 <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetoquadraticbezierabsolute.php
     * @param float $x1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetoquadraticbezierrelative.php
     * @param float $x1 <p>
     * starting x coordinate
     * </p>
     * @param float $y1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetoquadraticbeziersmoothabsolute.php
     * @param float $x <p>
     * ending x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetoquadraticbeziersmoothrelative.php
     * @param float $x <p>
     * ending x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetosmoothabsolute.php
     * @param float $x2 <p>
     * x coordinate of the second control point
     * </p>
     * @param float $y2 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/ru/imagickdraw.pathcurvetosmoothrelative.php
     * @param float $x2 <p>
     * x coordinate of the second control point
     * </p>
     * @param float $y2 <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathellipticarcabsolute.php
     * @param float $rx <p>
     * x radius
     * </p>
     * @param float $ry <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws an elliptical arc
     * @link https://php.net/manual/ru/imagickdraw.pathellipticarcrelative.php
     * @param float $rx <p>
     * x radius
     * </p>
     * @param float $ry <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathfinish.php
     * @return bool No value is returned.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line path
     * @link https://php.net/manual/ru/imagickdraw.pathlinetoabsolute.php
     * @param float $x <p>
     * starting x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line path
     * @link https://php.net/manual/ru/imagickdraw.pathlinetorelative.php
     * @param float $x <p>
     * starting x coordinate
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathlinetohorizontalabsolute.php
     * @param float $x <p>
     * x coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathlinetohorizontalrelative.php
     * @param float $x <p>
     * x coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathlinetoverticalabsolute.php
     * @param float $y <p>
     * y coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathlinetoverticalrelative.php
     * @param float $y <p>
     * y coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathmovetoabsolute.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Starts a new sub-path
     * @link https://php.net/manual/ru/imagickdraw.pathmovetorelative.php
     * @param float $x <p>
     * target x coordinate
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pathstart.php
     * @return bool No value is returned.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a polyline
     * @link https://php.net/manual/ru/imagickdraw.polyline.php
     * @param array $coordinates <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.popclippath.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.popdefs.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.poppattern.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.pushclippath.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.pushdefs.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.pushpattern.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.render.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.rotate.php
     * @param float $degrees <p>
     * degrees to rotate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.scale.php
     * @param float $x <p>
     * horizontal factor
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.setclippath.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setcliprule.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setclipunits.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the opacity to use when drawing using the fill color or fill texture
     * @link https://php.net/manual/ru/imagickdraw.setfillopacity.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfillpatternurl.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setfillrule.php
     * @param int $fill_rule <p>
     * FILLRULE_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setgravity.php
     * @param int $gravity <p>
     * GRAVITY_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokepatternurl.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokedashoffset.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokelinecap.php
     * @param int $linecap <p>
     * LINECAP_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokelinejoin.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokemiterlimit.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Specifies the opacity of stroked object outlines
     * @link https://php.net/manual/ru/imagickdraw.setstrokeopacity.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.setvectorgraphics.php
     * @param string $xml <p>
     ...
     * @link https://php.net/manual/ru/imagickdraw.pop.php
     ...
     * @link https://php.net/manual/ru/imagickdraw.push.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickdraw.setstrokedasharray.php
...
/**
 * @link https://php.net/manual/ru/class.imagickpixeliterator.php
 */
class ImagickPixelIterator implements Iterator
{
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.construct.php
     * @param Imagick $wand
     * @throws ImagickPixelIteratorException on error.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.newpixeliterator.php
     * @param Imagick $wand
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns a new pixel iterator
     * @link https://php.net/manual/ru/imagickpixeliterator.newpixelregioniterator.php
     * @param Imagick $wand
     * @param int $x
     * @param int $y
     * @param int $columns
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.getiteratorrow.php
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.setiteratorrow.php
     * @param int $row
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.setiteratorfirstrow.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.setiteratorlastrow.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.getpreviousiteratorrow.php
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.getcurrentiteratorrow.php
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.getnextiteratorrow.php
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.resetiterator.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function resetIterator() {}
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.synciterator.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.destroy.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function destroy() {}
     ...
     * @link https://php.net/manual/ru/imagickpixeliterator.clear.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function clear() {}
...
/**
 * @method clone()
 * @link https://php.net/manual/ru/class.imagickpixel.php
 */
class ImagickPixel
{
    /**
     ...
     * @link https://php.net/manual/ru/imagickpixel.gethsl.php
     ...
     * @link https://php.net/manual/ru/imagickpixel.sethsl.php
     * @param float $hue <p>
     ...
     * @link https://php.net/manual/ru/imagickpixel.construct.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the color
     * @link https://php.net/manual/ru/imagickpixel.setcolor.php
     ...
     * @link https://php.net/manual/ru/imagickpixel.setcolorvalue.php
     * @param int $color <p>
     ...
     * @link https://php.net/manual/ru/imagickpixel.getcolorvalue.php
     * @param int $color <p>
     ...
     * @link https://php.net/manual/ru/imagickpixel.clear.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelException on failure
     */
    public function clear() {}
     ...
     * @link https://php.net/manual/ru/imagickpixel.destroy.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelException on failure
     */
    public function destroy() {}
     ...
     * @link https://php.net/manual/ru/imagickpixel.issimilar.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Check the distance between this color and another
     * @link https://php.net/manual/ru/imagickpixel.ispixelsimilar.php
     * @param ImagickPixel $color <p>
     * The ImagickPixel object to compare this object against.
     * </p>
     * @param float $fuzz <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the color
     * @link https://php.net/manual/ru/imagickpixel.getcolor.php
     ...
     * @link https://php.net/manual/ru/imagickpixel.getcolorasstring.php
     ...
     * @link https://php.net/manual/ru/imagickpixel.getcolorcount.php
     ...
     * @link https://php.net/manual/ru/imagickpixel.ispixelsimilarquantum.php
     * @param string $color
     * @param string $fuzz
     * @return bool
     * @throws ImagickPixelException on failure
     ...
     * @link https://php.net/manual/ru/imagickpixel.getcolorquantum.php
...
/**
 * @link https://php.net/manual/ru/class.imagickkernel.php
 */
class ImagickKernel
{
    /**
     ...
     * @link https://php.net/manual/ru/imagickkernel.addkernel.php
     * @param ImagickKernel $imagickKernel
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     ...
     * @link https://php.net/manual/ru/imagickkernel.addunitykernel.php
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/ru/imagickkernel.frombuiltin.php
     ...
     * @link https://php.net/manual/ru/imagickkernel.getmatrix.php
     ...
     * @link https://php.net/manual/ru/imagickkernel.scale.php
     ...
     * @link https://php.net/manual/ru/imagickkernel.separate.php
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     */
