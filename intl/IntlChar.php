...
class IntlChar
{
    ...
    /**
     * @link https://php.net/manual/ru/intlchar.charfromname.php
     ...
     * @link https://php.net/manual/ru/intlchar.foldcase.php
     * @param int|string $codepoint The integer codepoint value (e.g. 0x2603 for U+2603 SNOWMAN), or the character encoded as a UTF-8 string (e.g. "\u{2603}")
     ...
     * @link https://php.net/manual/ru/intlchar.tolower.php
     * @param int|string $codepoint The integer codepoint value (e.g. 0x2603 for U+2603 SNOWMAN), or the character encoded as a UTF-8 string (e.g. "\u{2603}")
