...
class Collator
{
     ...
     * </p>
     * </p>
     * @link https://php.net/manual/ru/class.collator.php#intl.collator-constants
     */
     ...
     * Create a collator
     * @link https://php.net/manual/ru/collator.construct.php
     * @param string $locale
     */
    #[Pure]
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Create a collator
     * @link https://php.net/manual/ru/collator.create.php
     ...
     * @link https://php.net/manual/ru/collator.compare.php
     ...
     * @link https://php.net/manual/ru/collator.sort.php
     ...
     * @link https://php.net/manual/ru/collator.sortwithsortkeys.php
     ...
     * @link https://php.net/manual/ru/collator.asort.php
     * @param string[] &$array <p>Array of strings to sort.</p>
     * @param int $flags [optional] <p>
     * Optional sorting type, one of the following:
     * <b>Collator::SORT_REGULAR</b>
     ...
     * @link https://php.net/manual/ru/collator.getattribute.php
     ...
     * @link https://php.net/manual/ru/collator.setattribute.php
     ...
     * @link https://php.net/manual/ru/collator.getstrength.php
     ...
     * @link https://php.net/manual/ru/collator.setstrength.php
     ...
     * @link https://php.net/manual/ru/collator.geterrorcode.php
     ...
     * @link https://php.net/manual/ru/collator.getlocale.php
     * @param int $type <p>
     ...
     * @link https://php.net/manual/ru/collator.geterrormessage.php
     ...
     * @link https://php.net/manual/ru/collator.getsortkey.php
...
class NumberFormatter
{
     ...
     * @link https://php.net/manual/ru/class.numberformatter.php#intl.numberformatter-constants
     */
     ...
     * @link https://php.net/manual/ru/class.locale.php#intl.locale-constants
     */
    ...
    /**
     * @link https://www.php.net/manual/ru/class.numberformatter.php
     * @param string $locale
     * @param int $style
     ...
     * @link https://php.net/manual/ru/numberformatter.create.php
     * @param string $locale <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Format a number
     * @link https://php.net/manual/ru/numberformatter.format.php
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Parse a number
     * @link https://php.net/manual/ru/numberformatter.parse.php
     * @param string $string
     * @param int $type [optional] <p>
     * The
     ...
     * @link https://php.net/manual/ru/numberformatter.formatcurrency.php
     ...
     * @link https://php.net/manual/ru/numberformatter.parsecurrency.php
     * @param string $string
     * @param string &$currency <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Set an attribute
     * @link https://php.net/manual/ru/numberformatter.setattribute.php
     * @param int $attribute <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get an attribute
     * @link https://php.net/manual/ru/numberformatter.getattribute.php
     * @param int $attribute <p>
     * Attribute specifier - one of the
     * numeric attribute constants.
     * </p>
     ...
     * @link https://php.net/manual/ru/numberformatter.settextattribute.php
     * @param int $attribute <p>
     * Attribute specifier - one of the
     * text attribute
     * constants.
     ...
     * @link https://php.net/manual/ru/numberformatter.gettextattribute.php
     * @param int $attribute <p>
     * Attribute specifier - one of the
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Set a symbol value
     * @link https://php.net/manual/ru/numberformatter.setsymbol.php
     * @param int $symbol <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get a symbol value
     * @link https://php.net/manual/ru/numberformatter.getsymbol.php
     * @param int $symbol <p>
     * Symbol specifier, one of the
     * format symbol constants.
     * </p>
     ...
     * @link https://php.net/manual/ru/numberformatter.setpattern.php
     ...
     * @link https://php.net/manual/ru/numberformatter.getpattern.php
     ...
     * @link https://php.net/manual/ru/numberformatter.getlocale.php
     * @param int $type [optional] <p>
     * You can choose between valid and actual locale (
     ...
     * @link https://php.net/manual/ru/numberformatter.geterrorcode.php
     ...
     * @link https://php.net/manual/ru/numberformatter.geterrormessage.php
...
class Normalizer
{
     ...
     * @link https://secure.php.net/manual/ru/class.normalizer.php
     */
     ...
     * @link https://php.net/manual/ru/normalizer.normalize.php
     ...
     * @link https://php.net/manual/ru/normalizer.isnormalized.php
     * @param string $string <p>The input string to normalize</p>
     ...
     * @link https://www.php.net/manual/ru/normalizer.getrawdecomposition.php
     * @since 7.3
     */
    #[TentativeType]
...
class Locale
{
     ...
     * @link https://php.net/manual/ru/locale.getdefault.php
     ...
     * @link https://php.net/manual/ru/locale.setdefault.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getprimarylanguage.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getscript.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getregion.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getkeywords.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getdisplayscript.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getdisplayregion.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getdisplayname.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getdisplaylanguage.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getdisplayvariant.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.composelocale.php
     ...
     * @link https://php.net/manual/ru/locale.parselocale.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.getallvariants.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/locale.filtermatches.php
     ...
     * @link https://php.net/manual/ru/locale.lookup.php
    ...
    /**
     * @link https://php.net/manual/ru/locale.canonicalize.php
     * @param string $locale
     * @return string
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/locale.acceptfromhttp.php
...
class MessageFormatter
{
     ...
     * @link https://php.net/manual/ru/messageformatter.create.php
     * @param string $locale <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Format the message
     * @link https://php.net/manual/ru/messageformatter.format.php
     ...
     * @link https://php.net/manual/ru/messageformatter.formatmessage.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/messageformatter.parse.php
     * @param string $string <p>
     * The string to parse
     * </p>
     ...
     * @link https://php.net/manual/ru/messageformatter.parsemessage.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/messageformatter.setpattern.php
     * @param string $pattern <p>
     ...
     * @link https://php.net/manual/ru/messageformatter.getpattern.php
     ...
     * @link https://php.net/manual/ru/messageformatter.getlocale.php
     ...
     * @link https://php.net/manual/ru/messageformatter.geterrorcode.php
     ...
     * @link https://php.net/manual/ru/messageformatter.geterrormessage.php
...
class IntlDateFormatter
{
     ...
     * @link https://php.net/manual/ru/class.intldateformatter.php#intl.intldateformatter-constants
     */
    public const FULL = 0;
     ...
     * @link https://php.net/manual/ru/intldateformatter.create.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/intldateformatter.getdatetype.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.gettimetype.php
     * @return int|false The current date type value of the formatter.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/intldateformatter.getcalendar.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.setcalendar.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.gettimezoneid.php
     ...
     * @link https://secure.php.net/manual/ru/intldateformatter.getcalendarobject.php
     ...
     * @link https://secure.php.net/manual/ru/intldateformatter.gettimezone.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.settimezoneid.php
     * @param string $zone <p>
     ...
     * @link https://php.net/manual/ru/intldateformatter.settimezone.php
     ...
     * the ini setting {@link "https://secure.php.net/manual/ru/datetime.configuration.php#ini.date.timezone" date.timezone} or
     * through the function  {@link "https://secure.php.net/manual/ru/function.date-default-timezone-set.php" date_default_timezone_set()} and as
     * returned by {@link "https://secure.php.net/manual/ru/function.date-default-timezone-get.php" date_default_timezone_get()}.
     * </p>
     * </li>
     * <li>
     * <p>
     * An {@link "https://secure.php.net/manual/ru/class.intltimezone.php" IntlTimeZone}, which will be used directly.
     * </p>
     * </li>
     * <li>
     * <p>
     * A {@link "https://secure.php.net/manual/ru/class.datetimezone.php" DateTimeZone}. Its identifier will be extracted
     ...
     * <li>
     * <p>
     * A {@link "https://secure.php.net/manual/ru/language.types.string.php" string}, which should be a valid ICU timezone identifier.
     ...
     * @link https://php.net/manual/ru/intldateformatter.setpattern.php
     * @param string $pattern <p>
     ...
     * @link https://php.net/manual/ru/intldateformatter.getpattern.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.getlocale.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.setlenient.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.islenient.php
     ...
     * @link https://php.net/manual/ru/intldateformatter.format.php
     ...
     * (PHP 5 &gt;= 5.5.0, PECL intl &gt;= 3.0.0)<br/>
     * Formats an object
     * @link https://secure.php.net/manual/ru/intldateformatter.formatobject.php
     * @param object $datetime <p>
     * An object of type {@link "https://secure.php.net/manual/ru/class.intlcalendar.php" IntlCalendar} or {@link "https://secure.php.net/manual/ru/class.datetime.php" DateTime}. The timezone information in the object will be used.
     * </p>
     * @param mixed $format [optional] <p>
     * How to format the date/time. This can either be an {@link "https://secure.php.net/manual/ru/language.types.array.php" array} with
     ...
     * for the time and the date) or a {@link "https://secure.php.net/manual/ru/language.types.string.php" string} with the format
     ...
     * The locale to use, or <b>NULL</b> to use the {@link "https://secure.php.net/manual/ru/intl.configuration.php#ini.intl.default-locale" default one}.</p>
     ...
     * @link https://php.net/manual/ru/intldateformatter.parse.php
     * @param string $string <p>
     ...
     * @link https://php.net/manual/ru/intldateformatter.localtime.php
     * @param string $string <p>
     * string to convert to a time
     * </p>
     * @param int &$offset [optional] <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get the error code from last operation
     * @link https://php.net/manual/ru/intldateformatter.geterrorcode.php
     * @return int The error code, one of UErrorCode values. Initial value is U_ZERO_ERROR.
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get the error text from the last operation.
     * @link https://php.net/manual/ru/intldateformatter.geterrormessage.php
     * @return string Description of the last error.
     */
    #[Pure]
    #[TentativeType]
...
{
    /**
     * @link https://www.php.net/manual/ru/resourcebundle.create.php
     ...
     * @link https://php.net/manual/ru/resourcebundle.create.php
     * @param string $locale <p>
     ...
     * @link https://php.net/manual/ru/resourcebundle.get.php
     ...
     * @link https://php.net/manual/ru/resourcebundle.count.php
     ...
     * @link https://php.net/manual/ru/resourcebundle.locales.php
     * @param string $bundle <p>
     ...
     * @link https://php.net/manual/ru/resourcebundle.geterrorcode.php
     ...
     * @link https://php.net/manual/ru/resourcebundle.geterrormessage.php
...
class Transliterator
{
     ...
     * @link https://php.net/manual/ru/transliterator.construct.php
     */
     ...
     * @link https://php.net/manual/ru/transliterator.create.php
     * @param string $id <p>
     * The id.
     * </p>
     ...
     * @link https://php.net/manual/ru/transliterator.createfromrules.php
     ...
     * @link https://php.net/manual/ru/transliterator.createinverse.php
     * @return Transliterator|null a <b>Transliterator</b> object on success,
     * or <b>NULL</b> on failure
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/transliterator.listids.php
     ...
     * @link https://php.net/manual/ru/transliterator.transliterate.php
     * @param string $string <p>
     ...
     * (PHP &gt;= 5.4.0, PECL intl &gt;= 2.0.0)<br/>
     * Get last error code
     * @link https://php.net/manual/ru/transliterator.geterrorcode.php
     ...
     * @link https://php.net/manual/ru/transliterator.geterrormessage.php
...
/**
 * @link https://php.net/manual/ru/class.spoofchecker.php
 */
class Spoofchecker
{
     ...
     * (PHP &gt;= 5.4.0, PECL intl &gt;= 2.0.0)<br/>
     * Constructor
     * @link https://php.net/manual/ru/spoofchecker.construct.php
     */
    #[Pure]
    public function __construct() {}
     ...
     * @link https://php.net/manual/ru/spoofchecker.issuspicious.php
     * @param string $string <p>
     * </p>
     ...
     * @link https://php.net/manual/ru/spoofchecker.areconfusable.php
     * @param string $string1 <p>
     * </p>
     * @param string $string2 <p>
     * </p>
     ...
     * @link https://php.net/manual/ru/spoofchecker.setallowedlocales.php
     ...
     * @link https://php.net/manual/ru/spoofchecker.setchecks.php
     * @param int $checks <p>
     * </p>
     * @return void
     */
...
{
    /**
     * @link https://www.php.net/manual/ru/intlgregoriancalendar.construct
...
class IntlCalendar
{
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.add.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}.
     ...
     * https://secure.php.net/manual/ru/intlcalendar.after.php
     ...
     * Also returns <b>FALSE</b> on failure. You can use {@link https://secure.php.net/manual/ru/intl.configuration.php#ini.intl.use-exceptions exceptions} or
     * {@link https://secure.php.net/manual/ru/function.intl-get-error-code.php intl_get_error_code()} to detect error conditions.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.before.php
     * @param IntlCalendar $other <p> The calendar whose time will be checked against this object's time.</p>
     * @return bool
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.clear.php
     * @param int $field [optional] <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.construct.php
     */
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.createinstance.php
     ...
     * </p>
     * @param string|null $locale [optional] <p>
     * A locale to use or <b>NULL</b> to use {@link https://secure.php.net/manual/ru/intl.configuration.php#ini.intl.default-locale the default locale}.
     * </p>
     * @return IntlCalendar|null
     * The created {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} instance or <b>NULL</b> on
     * failure.
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.equals.php
     * @param IntlCalendar $other
     * @return bool <p>
     * Returns <b>TRUE</b> if the current time of both this and the passed in
     * {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} object are the same, or <b>FALSE</b>
     ...
     * distinguished by calling  {@link https://secure.php.net/manual/ru/function.intl-get-error-code.php intl_get_error_code()}.
     * </p>
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.fielddifference.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.fromdatetime.php
     * @param mixed $datetime <p>
     * A {@link https://secure.php.net/manual/ru/class.datetime.php DateTime} object or a {@link https://secure.php.net/manual/ru/language.types.string.php string} that
     * can be passed to  {@link https://secure.php.net/manual/ru/datetime.construct.php DateTime::__construct()}.
     * </p>
     * @param $locale [optional]
     * @return IntlCalendar|null
     * The created {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} object or <b>NULL</b> in case of
     * failure. If a {@link https://secure.php.net/manual/ru/language.types.string.php string} is passed, any exception that occurs
     * inside the {@link https://secure.php.net/manual/ru/class.datetime.php DateTime} constructor is propagated.
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.get.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getactualmaximum.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     * @return int
     * An {@link https://secure.php.net/manual/ru/language.types.integer.php int} representing the maximum value in the units associated
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getactualminimum.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}.
     * These are integer values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     * @return int
     * An {@link https://secure.php.net/manual/ru/language.types.integer.php int} representing the minimum value in the field's
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getavailablelocales.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.geterrorcode.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.geterrormessage.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getfirstdayofweek.php
     * @return int|false
     * One of the constants <b>IntlCalendar::DOW_SUNDAY</b>,
     * <b>IntlCalendar::DOW_MONDAY</b>, ...,
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getgreatestminimum.php
     * @param int $field
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * @return int|false
     * An {@link https://secure.php.net/manual/ru/language.types.integer.php int} representing a field value, in the field's
     * unit, or <b>FALSE</b> on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getleastmaximum.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     * @return int|false
     * An {@link https://secure.php.net/manual/ru/language.types.integer.ph int} representing a field value in the field's
     * unit or <b>FALSE</b> on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getlocale.php
     * @param int $type <p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getmaximum.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getminimaldaysinfirstweek.php
     * @return int|false
     * An {@link https://secure.php.net/manual/ru/language.types.integer.php  int} representing a number of days or <b>FALSE</b> on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getminimum.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     * @return int|false
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getrepeatedwalltimeoption.php
     * @return int
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getskippedwalltimeoption.php
     * @return int
     ...
     * @return float|false
     * A {@link https://secure.php.net/manual/ru/language.types.float.php float} representing the number of milliseconds elapsed since the
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.gettimezone.php
     * @return IntlTimeZone|false
     * An {@link https://secure.php.net/manual/ru/class.intltimezone.php IntlTimeZone} object corresponding to the one used
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.gettype.php
     * @return string
     * A {@link https://secure.php.net/manual/ru/language.types.string.php string} representing the calendar type, such as
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.getweekendtransition.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.indaylighttime.php
     * @return bool
     ...
     * specifying invalid field values on non-lenient mode; use {@link https://secure.php.net/manual/ru/intl.configuration.php#ini.intl.use-exceptions exceptions} or query
     * {@link https://secure.php.net/manual/ru/function.intl-get-error-code.php intl_get_error_code()} to disambiguate.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.isequivalentto.php
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.islenient.php
     * @return bool
     * A {@link https://secure.php.net/manual/ru/language.types.boolean.php bool} representing whether the calendar is set to lenient mode.
     */
    #[Pure]
    #[TentativeType]
    public function isLenient(): bool {}
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.isweekend.php
     ...
     * </p>
     * @return bool
     * <p> A {@link https://secure.php.net/manual/ru/language.types.boolean.php bool} indicating whether the given or this object's time occurs
     * in a weekend.
     * </p>
     * <p>
     * The value <b>FALSE</b> may also be returned on failure, for instance after giving
     * a date out of bounds on non-lenient mode; use {@link https://secure.php.net/manual/ru/intl.configuration.php#ini.intl.use-exceptions exceptions} or query
     * {@link https://secure.php.net/manual/ru/function.intl-get-error-code.php intl_get_error_code()} to disambiguate.</p>
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.roll.php
     * @param int $field
     * <p>One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time
     * {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     * @param mixed $value <p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.isset.php
     * @param int $field <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time
     * {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}.
     * These are integer values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     * </p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.set.php
     * @param int $year <p>
     * One of the {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}. These are integer
     * values between <em>0</em> and
     * <b>IntlCalendar::FIELD_COUNT</b>.
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.setfirstdayofweek.php
     * @param int $dayOfWeek <p>
     * One of the constants <b>IntlCalendar::DOW_SUNDAY</b>,
     * <b>IntlCalendar::DOW_MONDAY</b>, ...,
     * <b>IntlCalendar::DOW_SATURDAY</b>.
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.setlenient.php
     * @param bool $lenient <p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.setrepeatedwalltimeoption.php
     * @param int $option <p>
     * One of the constants <b>IntlCalendar::WALLTIME_FIRST</b> or
     * <b>IntlCalendar::WALLTIME_LAST</b>.
     * </p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.setskippedwalltimeoption.php
     * @param int $option <p>
     * One of the constants <b>IntlCalendar::WALLTIME_FIRST</b>,
     * <b>IntlCalendar::WALLTIME_LAST</b> or
     * <b>IntlCalendar::WALLTIME_NEXT_VALID</b>.
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.settime.php
     * @param float $timestamp <p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.settimezone.php
     * @param mixed $timezone <p>
     ...
     * @link https://secure.php.net/manual/ru/intlcalendar.todatetime.php
     * @return DateTime|false
     * A {@link https://secure.php.net/manual/ru/class.datetime.php DateTime} object with the same timezone as this
    ...
    /**
     * @link https://www.php.net/manual/ru/intlcalendar.setminimaldaysinfirstweek.php
     * @param int $days
     * @return bool
     */
...
class IntlTimeZone
{
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.countequivalentids.php
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.createdefault.php
     * @return IntlTimeZone
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.createenumeration.php
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.createtimezone.php
     * @param string $timezoneId
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.createtimezoneidenumeration.php
     * @param int $type
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.fromdatetimezone.php
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getcanonicalid.php
     * @param string $timezoneId
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getequivalentid.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0 PECL intl &gt;= 3.0.0a1)<br/>
     * Get last error code on the object
     * @link https://secure.php.net/manual/ru/intltimezone.geterrorcode.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0 PECL intl &gt;= 3.0.0a1)<br/>
     * Get last error message on the object
     * @link https://secure.php.net/manual/ru/intltimezone.geterrormessage.php
     * @return string|false
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getgmt.php
     * @return IntlTimeZone
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getoffset.php
     * @param float $timestamp
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getrawoffset.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getregion.php
     * @param string $timezoneId
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.gettzdataversion.php
     * @return string
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getunknown.php
     * @return IntlTimeZone
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.getwindowsid.php
     * @param string $timezoneId
    ...
    /**
     * @link https://www.php.net/manual/ru/intltimezone.getidforwindowsid.php
     * @param string $timezoneId
     ...
     * @link https://secure.php.net/manual/ru/intltimezone.hassamerules.php
...
/**
 * Gets the default locale value from the intl global 'default_locale'
 * @link https://php.net/manual/ru/function.locale-get-default.php
 ...
 * @link https://php.net/manual/ru/function.locale-set-default.php
 * @param string $locale <p>
 ...
 * How to format the date/time. This can either be an {https://secure.php.net/manual/ru/language.types.array.php array}  with
 * two elements (first the date style, then the time style, these being one
 * of the constants <b>IntlDateFormatter::NONE</b>,
 * <b>IntlDateFormatter::SHORT</b>,
 * <b>IntlDateFormatter::MEDIUM</b>,
 ...
 * <b>IntlDateFormatter::FULL</b>), a long with
 * the value of one of these constants (in which case it will be used both
 * for the time and the date) or a {@link https://secure.php.net/manual/ru/language.types.string.php} with the format
 * described in {@link http://www.icu-project.org/apiref/icu4c/classSimpleDateFormat.html#details the ICU documentation}
 ...
 * @link https://php.net/manual/ru/function.grapheme-strlen.php
 * @param string $string <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-strpos.php
 ...
 * @link https://php.net/manual/ru/function.grapheme-stripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-strrpos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-strripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-substr.php
 * @param string $string <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-strstr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-stristr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://php.net/manual/ru/function.grapheme-extract.php
 * @param string $haystack <p>
 * String to search.
 * </p>
 * @param int $size <p>
 ...
 * @link https://php.net/manual/ru/function.idn-to-ascii.php
 ...
 * @link https://php.net/manual/ru/function.idn-to-utf8.php
 * @param string $domain <p>
 ...
 * (PHP 5 &gt;=5.5.0 PECL intl &gt;= 3.0.0a1)<br/>
 * Get number representing the current time
 * @link https://secure.php.net/manual/ru/intlcalendar.getnow.php
 * @return float A float representing a number of milliseconds since the epoch, not counting leap seconds.
 * @since 5.5
 */
#[Pure(true)]
 ...
 * {@link https://secure.php.net/manual/ru/class.intlcalendar.php IntlCalendar} date/time
 * {@link https://secure.php.net/manual/ru/class.intlcalendar.php#intlcalendar.constants field constants}.
 * These are integer values between <em>0</em> and
 * <b>IntlCalendar::FIELD_COUNT</b>.
 * </p>
...
/**
 * (PHP 5 &gt;=5.5.0 PECL intl &gt;= 3.0.0a1)<br/>
 * @link https://secure.php.net/manual/ru/intlcalendar.getdayofweektype.php
 * Tell whether a day is a weekday, weekend or a day that has a transition between the two
 * @param IntlCalendar $calendar <p>
 * The calendar object, on the procedural style interface.
 * </p>
 ...
 * @link https://www.php.net/manual/ru/intlcalendar.get.php
 * @param IntlCalendar $calendar <p>
 * The IntlCalendar resource.
 * </p>
 * @param int $field <p>
 ...
 * </p>
 * @return int
 * <p>An {@link https://secure.php.net/manual/ru/language.types.integer.ph int} representing a field value in the field's
 * unit or <b>FALSE</b> on failure.
 * </p>
 * @since 5.5
 */
 ...
 * (PHP 5 &gt;=5.5.0 PECL intl &gt;= 3.0.0a1)<br/>
 * Get timezone ID
 * @link https://secure.php.net/manual/ru/intltimezone.getid.php
 ...
 * @link https://php.net/manual/ru/function.intl-get-error-code.php
 ...
 * @link https://php.net/manual/ru/function.intl-get-error-message.php
 ...
 * @link https://php.net/manual/ru/function.intl-is-failure.php
 ...
 * @link https://php.net/manual/ru/function.intl-error-name.php
 * @param int $errorCode <p>
 * ICU error code.
 * </p>
 ...
 * @link https://php.net/manual/ru/intl.constants.php
 */
...
/**
 * @link https://secure.php.net/manual/ru/migration54.global-constants.php
 * @since 5.4
 */
...
class IntlBreakIterator implements IteratorAggregate
{
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createcharacterinstance.php
     * @param string $locale
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createcodepointinstance.php
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createlineinstance.php
     * @param string $locale [optional]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createsentenceinstance.php
     * @param string $locale [optional]
     * @return IntlBreakIterator|null
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createtitleinstance.php
     * @param string $locale [optional]
     * @return IntlBreakIterator|null
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.createwordinstance.php
     * @param string $locale [optional]
     * @return IntlBreakIterator|null
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.current.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.first.php
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.following.php
     * @param int $offset
     */
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error code on the object
     * @link https://secure.php.net/manual/ru/intlbreakiterator.geterrorcode.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error message on the object
     * @link https://secure.php.net/manual/ru/intlbreakiterator.geterrormessage.php
     * @return string
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get the locale associated with the object
     * @link https://secure.php.net/manual/ru/intlbreakiterator.getlocale.php
     * @param string $type
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.getpartsiterator.php
     * @param int $type [optional]
     * <p>
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.gettext.php
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.isboundary.php
     * @param int $offset
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.last.php
     * @return int
     */
    #[TentativeType]
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlbreakiterator.next.php
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlbreakiterator.preceding.php
     * @param int $offset
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.previous.php
     * @return int
     */
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/intlbreakiterator.settext.php
     * @param string $text
     */
    #[TentativeType]
...
class IntlRuleBasedBreakIterator extends IntlBreakIterator implements Traversable
{
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlbreakiterator.construct.php
     * @param string $rules
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlrulebasedbreakiterator.getbinaryrules.php
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlrulebasedbreakiterator.getrules.php
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlrulebasedbreakiterator.getrulesstatus.php
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/intlrulebasedbreakiterator.getrulestatusvec.php
...
/**
 * @link https://www.php.net/manual/ru/class.intlpartsiterator.php
 * @since 5.5
 */
...
class IntlCodePointBreakIterator extends IntlBreakIterator implements Traversable
{
     ...
     * @link https://secure.php.net/manual/ru/intlcodepointbreakiterator.getlastcodepoint.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
...
class UConverter
{
     ...
     * @link https://php.net/manual/ru/uconverter.construct.php
     ...
     * @link https://php.net/manual/ru/uconverter.convert.php
     * @param string $str
     ...
     * @link https://php.net/manual/ru/uconverter.fromucallback.php
     * @param int $reason
     * @param string $source
     ...
     * @link https://php.net/manual/ru/uconverter.getaliases.php
     * @param string $name
     ...
     * @link https://php.net/manual/ru/uconverter.getavailable.php
     * @return array
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.getdestinationencoding.php
     ...
     * @link https://php.net/manual/ru/uconverter.getdestinationtype.php
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error code on the object
     * @link https://php.net/manual/ru/uconverter.geterrorcode.php
     * @return int
     */
    #[Pure]
    #[TentativeType]
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error message on the object
     * @link https://php.net/manual/ru/uconverter.geterrormessage.php
     * @return string|null
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.getsourceencoding.php
     * @return string|false|null
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.getsourcetype.php
     * @return int|false|null
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.getstandards.php
     * @return array|null
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.getsubstchars.php
     * @return string|false|null
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.reasontext.php
     * @param int $reason
     * @return string
     */
    #[Pure]
     ...
     * @link https://php.net/manual/ru/uconverter.setdestinationencoding.php
     ...
     * @link https://php.net/manual/ru/uconverter.setsourceencoding.php
     * @param string $encoding
     * @return bool
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.setsubstchars.php
     * @param string $chars
     * @return bool
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/uconverter.toucallback.php
     * @param int $reason
     * @param string $source
     ...
     * @link https://php.net/manual/ru/uconverter.transcode.php
     * @param string $str
