 ...
 * @link https://php.net/manual/ru/class.sqlite3.php
 */
class SQLite3
{
    public const OK = 0;
     ...
     * @link https://php.net/manual/ru/sqlite3.open.php
     ...
     * @link https://php.net/manual/ru/sqlite3.close.php
     ...
     * @link https://php.net/manual/ru/sqlite3.exec.php
     ...
     * @link https://php.net/manual/ru/sqlite3.version.php
     ...
     * @link https://php.net/manual/ru/sqlite3.lastinsertrowid.php
     ...
     * @link https://php.net/manual/ru/sqlite3.lasterrorcode.php
     ...
     * @link https://php.net/manual/ru/sqlite3.lasterrormsg.php
     ...
     * @link https://php.net/manual/ru/sqlite3.busytimeout.php
     ...
     * @link https://php.net/manual/ru/sqlite3.loadextension.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.changes.php
     ...
     * @link https://php.net/manual/ru/sqlite3.escapestring.php
    ...
    /**
     * Prepares an SQL statement for execution 1
     * @link https://php.net/manual/ru/sqlite3.prepare.php
     * @param string $query <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.query.php
     * @param string $query <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.querysingle.php
     * @param string $query <p>
     * The SQL query to execute.
     * </p>
     ...
     * @link https://php.net/manual/ru/sqlite3.createfunction.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.createaggregate.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.createcollation.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/sqlite3.openblob.php
     ...
     * @link https://www.php.net/manual/ru/sqlite3.enableexceptions
     * @param bool $enable
     ...
     * @link https://php.net/manual/ru/sqlite3.construct.php
     * @param string $filename <p>
     * Path to the SQLite database, or :memory: to use in-memory database.
     * </p>
     * @param int $flags [optional] <p>
 ...
 * @link https://php.net/manual/ru/class.sqlite3stmt.php
 */
class SQLite3Stmt
{
    /**
     * Returns the number of parameters within the prepared statement
     * @link https://php.net/manual/ru/sqlite3stmt.paramcount.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.close.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.reset.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.clear.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.execute.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.bindparam.php
     ...
     * @link https://php.net/manual/ru/sqlite3stmt.bindvalue.php
     * @param string $param <p>
     * An string identifying the statement variable to which the
 ...
 * @link https://php.net/manual/ru/class.sqlite3result.php
 */
class SQLite3Result
{
    /**
     * Returns the number of columns in the result set
     * @link https://php.net/manual/ru/sqlite3result.numcolumns.php
     ...
     * @link https://php.net/manual/ru/sqlite3result.columnname.php
     * @param int $column <p>
     ...
     * @link https://php.net/manual/ru/sqlite3result.columntype.php
     * @param int $column <p>
     * The numeric zero-based index of the column.
     * </p>
     ...
     * @link https://php.net/manual/ru/sqlite3result.fetcharray.php
     ...
     * @link https://php.net/manual/ru/sqlite3result.reset.php
     ...
     * @link https://php.net/manual/ru/sqlite3result.finalize.php
     * @return bool <b>TRUE</b>.
     */
 ...
 * @link https://php.net/manual/ru/sqlite3.constants.php
 */
