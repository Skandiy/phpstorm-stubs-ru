...
/**
 * @link https://php.net/manual/ru/class.xsltprocessor.php
 */
class XSLTProcessor
{
    /**
     * Import stylesheet
     * @link https://php.net/manual/ru/xsltprocessor.importstylesheet.php
     ...
     * @link https://php.net/manual/ru/xsltprocessor.transformtodoc.php
     * @param DOMNode $doc <p>
    ...
    /**
     * Transform to URI
     * @link https://php.net/manual/ru/xsltprocessor.transformtouri.php
    ...
    /**
     * Transform to XML
     * @link https://php.net/manual/ru/xsltprocessor.transformtoxml.php
     * @param DOMDocument|SimpleXMLElement $doc <p>
     ...
     * @link https://php.net/manual/ru/xsltprocessor.setparameter.php
     ...
     * @link https://php.net/manual/ru/xsltprocessor.getparameter.php
    ...
    /**
     * Remove parameter
     * @link https://php.net/manual/ru/xsltprocessor.removeparameter.php
     * @param string $namespaceURI <p>
     * The namespace URI of the XSLT parameter.
     * </p>
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/xsltprocessor.hasexsltsupport.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.0.4
     */
     ...
     * @link https://php.net/manual/ru/xsltprocessor.registerphpfunctions.php
     ...
     * @link https://php.net/manual/ru/xsltprocessor.setprofiling.php
     ...
     * @link https://php.net/manual/ru/xsltprocessor.setsecurityprefs.php
     ...
     * @link https://php.net/manual/ru/xsltprocessor.getsecurityprefs.php
     * @return int
     * @since 5.4
     */
...
/** @link https://php.net/manual/ru/xsl.constants.php */
