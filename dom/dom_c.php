...
/**
 * The DOMNode class
 * @link https://php.net/manual/ru/class.domnode.php
 */
class DOMNode
{
    /**
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.nodename
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.nodevalue
     */
     ...
     * <a href="https://secure.php.net/manual/ru/dom.constants.php">XML_xxx_NODE</a> constants
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.nodetype
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.parentnode
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.childnodes
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.firstchild
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMNode|null'], default: '')]
    public $firstChild;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.lastchild
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMNode|null'], default: '')]
    public $lastChild;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.previoussibling
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMNode|null'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.nextsibling
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMNode|null'], default: '')]
    public $nextSibling;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.attributes
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.ownerdocument
     */
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.namespaceuri
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $namespaceURI;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.prefix
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $prefix;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.localname
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $localName;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.baseuri
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $baseURI;
     ...
     * @link https://php.net/manual/ru/class.domnode.php#domnode.props.textcontent
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $textContent;
     ...
     * @link https://php.net/manual/ru/domnode.insertbefore.php
    ...
    /**
     * Replaces a child
     * @link https://php.net/manual/ru/domnode.replacechild.php
     * @param DOMNode $node <p>
     ...
     * @link https://php.net/manual/ru/domnode.removechild.php
     * @param DOMNode $child <p>
     * The removed child.
     * </p>
     ...
     * @link https://php.net/manual/ru/domnode.appendchild.php
     * @param DOMNode $node <p>
     * The appended child.
     * </p>
     ...
     * @link https://php.net/manual/ru/domnode.haschildnodes.php
    ...
    /**
     * Clones a node
     * @link https://php.net/manual/ru/domnode.clonenode.php
    ...
    /**
     * Normalizes the node
     * @link https://php.net/manual/ru/domnode.normalize.php
     * @return void
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domnode.issupported.php
     ...
     * @link https://php.net/manual/ru/domnode.hasattributes.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domnode.issamenode.php
     ...
     * @link https://php.net/manual/ru/domnode.lookupprefix.php
     ...
     * @link https://php.net/manual/ru/domnode.isdefaultnamespace.php
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/ru/domnode.lookupnamespaceuri.php
     ...
     * @link https://secure.php.net/manual/ru/domnode.getnodepath.php
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domnode.getlineno.php
     ...
     * @link https://www.php.net/manual/ru/domnode.c14nfile
 ...
 * @link https://php.net/manual/ru/class.domexception.php
 */
final class DOMException extends Exception
{
    /**
     * @link https://php.net/manual/ru/class.domexception.php#domexception.props.code
...
/**
 * @link https://php.net/manual/ru/ref.dom.php
 * @removed 8.0
 */
class DOMNameList
{
 ...
 * @link https://php.net/manual/ru/class.domimplementation.php
 */
class DOMImplementation
{
     ...
     * @link https://php.net/manual/ru/domimplementation.hasfeature.php
     * @param string $feature <p>
     * The feature to test.
     * </p>
     * @param string $version <p>
     ...
     * @link https://php.net/manual/ru/domimplementation.createdocumenttype.php
     ...
     * @link https://php.net/manual/ru/domimplementation.createdocument.php
 ...
 * @link https://php.net/manual/ru/class.domdocumentfragment.php
 */
class DOMDocumentFragment extends DOMNode implements DOMParentNode
{
    ...
    /**
     * Append raw XML data
     * @link https://php.net/manual/ru/domdocumentfragment.appendxml.php
     * @param string $data <p>
     * XML to append.
     * </p>
     * @return bool true on success or false on failure.
 ...
 * @link https://php.net/manual/ru/class.domdocument.php
 */
class DOMDocument extends DOMNode implements DOMParentNode
{
    /**
     * @var string|null
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.actualencoding
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.config
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.doctype
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.documentelement
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMElement|null'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.documenturi
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $documentURI;
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.encoding
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $encoding;
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.formatoutput
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.implementation
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.preservewhitespace
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.recover
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
    public $recover;
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.resolveexternals
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
    ...
    /**
     * @var bool
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.standalone
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.stricterrorchecking
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.substituteentities
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.validateonparse
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
    ...
    /**
     * @var string
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.version
     */
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.xmlencoding
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $xmlEncoding;
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.xmlstandalone
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
     ...
     * @link https://php.net/manual/ru/class.domdocument.php#domdocument.props.xmlversion
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $xmlVersion;
     ...
     * @link https://php.net/manual/ru/domdocument.createelement.php
     ...
     * @link https://php.net/manual/ru/domdocument.createdocumentfragment.php
     ...
     * @link https://php.net/manual/ru/domdocument.createtextnode.php
     * @param string $data <p>
     ...
     * @link https://php.net/manual/ru/domdocument.createcomment.php
     * @param string $data <p>
     ...
     * @link https://php.net/manual/ru/domdocument.createcdatasection.php
     * @param string $data <p>
    ...
    /**
     * Creates new PI node
     * @link https://php.net/manual/ru/domdocument.createprocessinginstruction.php
     ...
     * @link https://php.net/manual/ru/domdocument.createattribute.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/domdocument.createentityreference.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/domdocument.getelementsbytagname.php
     * @param string $qualifiedName <p>
     ...
     * @link https://php.net/manual/ru/domdocument.importnode.php
     * @param DOMNode $node <p>
     * The node to import.
     * </p>
     * @param bool $deep <p>
     ...
     * @link https://php.net/manual/ru/domdocument.createelementns.php
     * @param string|null $namespace <p>
     ...
     * @link https://php.net/manual/ru/domdocument.createattributens.php
     * @param string|null $namespace <p>
     * The URI of the namespace.
     * </p>
     * @param string $qualifiedName <p>
     ...
     * @link https://php.net/manual/ru/domdocument.getelementsbytagnamens.php
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/ru/domdocument.getelementbyid.php
     ...
     * @link https://php.net/manual/ru/domdocument.normalizedocument.php
     * @return void
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domdocument.load.php
     ...
     * @link https://php.net/manual/ru/domdocument.save.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/domdocument.loadxml.php
     ...
     * @link https://php.net/manual/ru/domdocument.savexml.php
     ...
     * @link https://php.net/manual/ru/domdocument.construct.php
     ...
     * @link https://php.net/manual/ru/domdocument.validate.php
     * @return bool true on success or false on failure.
     ...
     * @link https://php.net/manual/ru/domdocument.xinclude.php
     * @param int $options [optional] <p>
     ...
     * @link https://php.net/manual/ru/domdocument.loadhtml.php
     * @param string $source <p>
     * The HTML string.
     * </p>
     * @param int $options [optional] <p>
     ...
     * @link https://php.net/manual/ru/domdocument.loadhtmlfile.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/domdocument.savehtml.php
     ...
     * @link https://php.net/manual/ru/domdocument.savehtmlfile.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/domdocument.schemavalidate.php
     * @param string $filename <p>
    ...
    /**
     * Validates a document based on a schema
     * @link https://php.net/manual/ru/domdocument.schemavalidatesource.php
     * @param string $source <p>
     ...
     * @link https://php.net/manual/ru/domdocument.relaxngvalidate.php
     * @param string $filename <p>
     * The RNG file.
     * </p>
     * @return bool true on success or false on failure.
    ...
    /**
     * Performs relaxNG validation on the document
     * @link https://php.net/manual/ru/domdocument.relaxngvalidatesource.php
     * @param string $source <p>
     ...
     * @link https://php.net/manual/ru/domdocument.registernodeclass.php
 ...
 * @link https://php.net/manual/ru/class.domnodelist.php
 */
class DOMNodeList implements IteratorAggregate, Countable
{
     ...
     * @link https://php.net/manual/ru/class.domnodelist.php#domnodelist.props.length
     */
    #[LanguageLevelTypeAware(['8.1' => 'int'], default: '')]
    public $length;
     ...
     * @link https://php.net/manual/ru/domnodelist.item.php
     * @param int $index <p>
 ...
 * @link https://php.net/manual/ru/class.domnamednodemap.php
...
class DOMNamedNodeMap implements IteratorAggregate, Countable
{
     ...
     * @link https://php.net/manual/ru/domnamednodemap.getnameditem.php
     * @param string $qualifiedName <p>
    ...
    /**
     * Retrieves a node specified by index
     * @link https://php.net/manual/ru/domnamednodemap.item.php
     * @param int $index <p>
     * Index into this map.
     * </p>
     ...
     * @link https://php.net/manual/ru/domnamednodemap.getnameditemns.php
     * @param string $namespace <p>
 ...
 * @link https://php.net/manual/ru/class.domcharacterdata.php
 */
class DOMCharacterData extends DOMNode implements DOMChildNode
{
     ...
     * @link https://php.net/manual/ru/class.domcharacterdata.php#domcharacterdata.props.data
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $data;
     ...
     * @link https://php.net/manual/ru/class.domcharacterdata.php#domcharacterdata.props.length
     */
    #[LanguageLevelTypeAware(['8.1' => 'int'], default: '')]
    public $length;
     ...
     * @link https://php.net/manual/ru/domcharacterdata.substringdata.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/domcharacterdata.appenddata.php
     * @param string $data <p>
     ...
     * @link https://php.net/manual/ru/domcharacterdata.insertdata.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/domcharacterdata.deletedata.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/domcharacterdata.replacedata.php
     * @param int $offset <p>
 ...
 * @link https://php.net/manual/ru/class.domattr.php
 */
class DOMAttr extends DOMNode
{
     ...
     * (PHP5)<br/>
     * The name of the attribute
     * @link https://php.net/manual/ru/class.domattr.php#domattr.props.name
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $name;
     ...
     * @link https://php.net/manual/ru/class.domattr.php#domattr.props.ownerelement
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMElement|null'], default: '')]
    public $ownerElement;
     ...
     * @link https://php.net/manual/ru/class.domattr.php#domattr.props.schematypeinfo
     */
    #[LanguageLevelTypeAware(['8.1' => 'mixed'], default: '')]
     ...
     * (PHP5)<br/>
     * Not implemented yet, always is NULL
     * @link https://php.net/manual/ru/class.domattr.php#domattr.props.specified
     */
    #[LanguageLevelTypeAware(['8.1' => 'bool'], default: '')]
    public $specified;
     ...
     * @link https://php.net/manual/ru/class.domattr.php#domattr.props.value
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $value;
     ...
     * @link https://php.net/manual/ru/domattr.isid.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domattr.construct.php
 ...
 * @link https://php.net/manual/ru/class.domelement.php
 */
class DOMElement extends DOMNode implements DOMParentNode, DOMChildNode
{
     ...
     * @link https://php.net/manual/ru/class.domelement.php#domelement.props.schematypeinfo
     */
    #[LanguageLevelTypeAware(['8.1' => 'mixed'], default: '')]
    public $schemaTypeInfo;
     ...
     * @var string
     * The element name
     * @link https://php.net/manual/ru/class.domelement.php#domelement.props.tagname
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $tagName;
     ...
     * @link https://php.net/manual/ru/domelement.getattribute.php
     * @param string $qualifiedName <p>
     * The name of the attribute.
     * </p>
    ...
    /**
     * Adds new attribute
     * @link https://php.net/manual/ru/domelement.setattribute.php
     * @param string $qualifiedName <p>
     * The name of the attribute.
     * </p>
    ...
    /**
     * Removes attribute
     * @link https://php.net/manual/ru/domelement.removeattribute.php
     * @param string $qualifiedName <p>
     * The name of the attribute.
     * </p>
     * @return bool true on success or false on failure.
     ...
     * @link https://php.net/manual/ru/domelement.getattributenode.php
     * @param string $qualifiedName <p>
     * The name of the attribute.
     * </p>
     ...
     * @link https://php.net/manual/ru/domelement.setattributenode.php
    ...
    /**
     * Removes attribute
     * @link https://php.net/manual/ru/domelement.removeattributenode.php
     * @param DOMAttr $attr <p>
     * The attribute node.
     * </p>
     * @return bool true on success or false on failure.
     ...
     * @link https://php.net/manual/ru/domelement.getelementsbytagname.php
     * @param string $qualifiedName <p>
    ...
    /**
     * Returns value of attribute
     * @link https://php.net/manual/ru/domelement.getattributens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Adds new attribute
     * @link https://php.net/manual/ru/domelement.setattributens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $qualifiedName <p>
    ...
    /**
     * Removes attribute
     * @link https://php.net/manual/ru/domelement.removeattributens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Returns attribute node
     * @link https://php.net/manual/ru/domelement.getattributenodens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Adds new attribute node to element
     * @link https://php.net/manual/ru/domelement.setattributenodens.php
     * @param DOMAttr $attr
     ...
     * @link https://php.net/manual/ru/domelement.getelementsbytagnamens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/domelement.hasattribute.php
     * @param string $qualifiedName <p>
     * The attribute name.
     * </p>
     * @return bool true on success or false on failure.
    ...
    /**
     * Checks to see if attribute exists
     * @link https://php.net/manual/ru/domelement.hasattributens.php
     * @param string $namespace <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/domelement.setidattribute.php
     * @param string $qualifiedName <p>
     * The name of the attribute.
     * </p>
     * @param bool $isId <p>
     ...
     * @link https://php.net/manual/ru/domelement.setidattributens.php
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/ru/domelement.setidattributenode.php
     * @param DOMAttr $attr <p>
     * The attribute node.
     * </p>
     * @param bool $isId <p>
     ...
     * @link https://php.net/manual/ru/domelement.construct.php
...
class DOMText extends DOMCharacterData
{
     ...
     * @link https://php.net/manual/ru/domtext.splittext.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/domtext.iswhitespaceinelementcontent.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/domtext.construct.php
 ...
 * @link https://php.net/manual/ru/class.domcomment.php
 */
class DOMComment extends DOMCharacterData
{
    /**
     * Creates a new DOMComment object
     * @link https://php.net/manual/ru/domcomment.construct.php
 ...
 * @link https://secure.php.net/manual/ru/class.domcdatasection.php
 */
class DOMCdataSection extends DOMText
{
     ...
     * @link https://secure.php.net/manual/ru/domcdatasection.construct.php
     */
    public function __construct(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $data) {}
}
 ...
 * @link https://php.net/manual/ru/class.domdocumenttype.php
 */
class DOMDocumentType extends DOMNode
{
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.publicid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $publicId;
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.systemid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $systemId;
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.name
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $name;
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.entities
     */
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.notations
     */
    #[LanguageLevelTypeAware(['8.1' => 'DOMNamedNodeMap'], default: '')]
    public $notations;
     ...
     * @link https://php.net/manual/ru/class.domdocumenttype.php#domdocumenttype.props.internalsubset
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
 ...
 * @link https://php.net/manual/ru/class.domnotation.php
 */
class DOMNotation extends DOMNode
{
     ...
     * @var string
     *
     * @link https://php.net/manual/ru/class.domnotation.php#domnotation.props.publicid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $publicId;
     ...
     * @var string
     *
     * @link https://php.net/manual/ru/class.domnotation.php#domnotation.props.systemid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $systemId;
}
 ...
 * @link https://php.net/manual/ru/class.domentity.php
 */
class DOMEntity extends DOMNode
{
     ...
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.publicid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $publicId;
     ...
     * absolute URI or not.
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.systemid
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $systemId;
     ...
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.notationname
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $notationName;
     ...
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.actualencoding
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $actualEncoding;
     ...
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.encoding
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $encoding;
     ...
     * @link https://php.net/manual/ru/class.domentity.php#domentity.props.version
     */
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: '')]
    public $version;
}
...
/**
 * Extends DOMNode.
 * @link https://php.net/manual/ru/class.domentityreference.php
 */
class DOMEntityReference extends DOMNode
{
    /**
     * Creates a new DOMEntityReference object
     * @link https://php.net/manual/ru/domentityreference.construct.php
 ...
 * @link https://php.net/manual/ru/class.domprocessinginstruction.php
 */
class DOMProcessingInstruction extends DOMNode
{
    /**
     * @link https://php.net/manual/ru/class.domprocessinginstruction.php#domprocessinginstruction.props.target
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $target;

    /**
     * @link https://php.net/manual/ru/class.domprocessinginstruction.php#domprocessinginstruction.props.data
     */
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $data;
     ...
     * @link https://php.net/manual/ru/domprocessinginstruction.construct.php
 ...
 * @link https://php.net/manual/ru/class.domxpath.php
 */
class DOMXPath
{
    /**
     * @var DOMDocument
     *
     * @link https://php.net/manual/ru/class.domxpath.php#domxpath.props.document
     */
     ...
     * @link https://php.net/manual/ru/domxpath.construct.php
     ...
     * @link https://php.net/manual/ru/domxpath.registernamespace.php
     * @param string $prefix <p>
     * The prefix.
     * </p>
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/ru/domxpath.query.php
     ...
     * @link https://php.net/manual/ru/domxpath.evaluate.php
     * @param string $expression <p>
     * The XPath expression to execute.
     * </p>
     * @param DOMNode $contextNode [optional] <p>
     ...
     * @link https://php.net/manual/ru/domxpath.registerphpfunctions.php
