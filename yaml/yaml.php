 ...
 * @link https://php.net/manual/ru/yaml.constants.php
 */
 ...
 * @link https://php.net/manual/ru/function.yaml-emit-file.php
...
/**
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.5.0)<br/>
 * @link https://php.net/manual/ru/function.yaml-emit.php
 * @param mixed $data The data being encoded. Can be any type except a resource.
 ...
 * @link https://php.net/manual/ru/function.yaml-parse-file.php
 * @param string $filename Path to the file.
 ...
 * @link https://php.net/manual/ru/function.yaml-parse-url.php
 ...
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.4.0)<br/>
 * Parse a YAML stream
 * @link https://php.net/manual/ru/function.yaml-parse.php
