 ...
 * @link https://php.net/manual/ru/book.mysqli.php
 */
...
/**
 * MySQLi Driver.
 * @link https://php.net/manual/ru/class.mysqli-driver.php
 */
 ...
 * @link https://php.net/manual/ru/class.mysqli.php
 */
class mysqli
{
    /**
     ...
     * @link https://secure.php.net/manual/ru/mysqli.error-list.php
     */
     ...
     * @link https://php.net/manual/ru/mysqli.construct.php
     ...
     * @link https://php.net/manual/ru/mysqli.autocommit.php
     * @param bool $enable <p>
     ...
     * @link https://secure.php.net/manual/ru/mysqli.begin-transaction.php
     ...
     * @link https://php.net/manual/ru/mysqli.change-user.php
     ...
     * @link https://php.net/manual/ru/mysqli.character-set-name.php
     ...
     * @link https://php.net/manual/ru/mysqli.close.php
     * @return bool true on success or false on failure.
     */
     ...
     * @link https://php.net/manual/ru/mysqli.commit.php
    ...
    /**
     * @link https://php.net/manual/ru/function.mysqli-connect.php
     ...
     * @link https://php.net/manual/ru/mysqli.dump-debug-info.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli.debug.php
     ...
     * @link https://php.net/manual/ru/mysqli.get-charset.php
     ...
     * @link https://php.net/manual/ru/mysqli.get-client-info.php
     ...
     * @link https://php.net/manual/ru/mysqli.get-connection-stats.php
     ...
     * @link https://php.net/manual/ru/mysqli.get-server-info.php
     ...
     * @link https://php.net/manual/ru/mysqli.get-warnings.php
     ...
     * @link https://php.net/manual/ru/mysqli.init.php
     * @return bool|null
     * @deprecated 8.1
     */
     ...
     * @link https://php.net/manual/ru/mysqli.kill.php
     ...
     * @link https://php.net/manual/ru/mysqli.multi-query.php
     ...
     * @link https://php.net/manual/ru/mysqli.more-results.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli.next-result.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
    ...
    /**
     * Set options
     * @link https://php.net/manual/ru/mysqli.options.php
     * @param int $option <p>
     ...
     * @link https://php.net/manual/ru/mysqli.ping.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli.prepare.php
     * @param string $query <p>
     ...
     * </p>
     * <p>
     * Эти метки можно встраивать только в определённые места в выражении. Например, они разрешены в списке VALUES()
     * выражения INSERT (чтобы задать значения столбцов для строки),
     * или в операциях сравнения предложения WHERE для задания сравниваемого значения.
     * </p>
     * <p>
     * Однако они не разрешены в качестве идентификаторов (таких как имена таблиц или столбцов)
     * или для указания обоих операндов бинарного оператора, такого как знак равенства =.
     * Последнее ограничение необходимо, поскольку невозможно определить тип параметра.
     * В основном, параметры допустимы в выражениях языка манипулирования данными (DML),
     * и недопустимы в выражениях языка определения данных (DDL).
     * </p>
     * @return mysqli_stmt|false <b>mysqli_prepare</b> возвращает объект запроса или false в случае ошибки.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli.query.php
     * @param string $query <p>
     * The query string.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/ru/mysqli.real-connect.php
     ...
     * @link https://php.net/manual/ru/mysqli.real-escape-string.php
    ...
    /**
     * Poll connections
     * @link https://php.net/manual/ru/mysqli.poll.php
     * @param array &$read <p>
     * </p>
     * @param array &$error <p>
     * </p>
     ...
     * @link https://php.net/manual/ru/mysqli.reap-async-query.php
     ...
     * Characters encoded are NUL (ASCII 0), \n, \r, \, ', ", and Control-Z.
     * @return string
     * @link https://secure.php.net/manual/ru/mysqli.real-escape-string.php
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli.real-query.php
     * @param string $query <p>
     ...
     * @link https://php.net/manual/ru/mysqli.release-savepoint.php
     ...
     * @link https://php.net/manual/ru/mysqli.rollback.php
     ...
     * @link https://secure.php.net/manual/ru/mysqli.savepoint.php
     * @param string $name
     * @return bool Returns TRUE on success or FALSE on failure.
     * @since 5.5
     */
     ...
     * @link https://php.net/manual/ru/mysqli.select-db.php
     * @param string $database <p>
     * The database name.
     * </p>
     * @return bool true on success or false on failure.
     ...
     * @link https://php.net/manual/ru/mysqli.set-charset.php
    ...
    /**
     * @link https://php.net/manual/ru/function.mysqli-set-opt
     * @param int $option
     ...
     * @link https://secure.php.net/manual/ru/mysqli.ssl-set.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/mysqli.stat.php
     ...
     * @link https://php.net/manual/ru/mysqli.stmt-init.php
     ...
     * @link https://php.net/manual/ru/mysqli.store-result.php
     ...
     * @link https://php.net/manual/ru/mysqli.thread-safe.php
     ...
     * @link https://php.net/manual/ru/mysqli.use-result.php
    ...
    /**
     * @link https://php.net/manual/ru/mysqli.refresh
 ...
 * @link https://php.net/manual/ru/class.mysqli-warning.php
 */
final class mysqli_warning
{
     ...
     * @link https://php.net/manual/ru/mysqli-warning.construct.php
     */
     ...
     * @link https://php.net/manual/ru/mysqli-warning.next.php
 ...
 * @link https://php.net/manual/ru/class.mysqli-result.php
 */
class mysqli_result implements IteratorAggregate
{
     ...
     * @return void
     * @link https://php.net/manual/ru/mysqli-result.free.php
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli-result.data-seek.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-field.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-fields.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-field-direct.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-all.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-array.php
     * @param int $mode [optional] <p>
     * This optional parameter is a constant indicating what type of array
     * should be produced from the current row data. The possible values for
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-assoc.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-object.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.fetch-row.php
     ...
     * @link https://php.net/manual/ru/mysqli-result.field-seek.php
     * @param int $index <p>
     * The field number. This value must be in the range from
     * 0 to number of fields - 1.
     * </p>
 ...
 * @link https://php.net/manual/ru/class.mysqli-stmt.php
 */
class mysqli_stmt
{
    /**
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.attr-get.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.attr-set.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.bind-param.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.bind-result.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.close.php
     * @return bool true on success or false on failure.
     */
    public function close() {}
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.data-seek.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.execute.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.fetch.php
     * @return bool|null
     */
    #[TentativeType]
    ...
    /**
     * Get result of SHOW WARNINGS
     * @link https://php.net/manual/ru/mysqli-stmt.get-warnings.php
     * @return object|false
     */
    #[TentativeType]
    public function get_warnings(): mysqli_warning|false {}
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.result-metadata.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.more-results.php
     * @return bool
     */
    #[TentativeType]
    public function more_results(): bool {}
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.next-result.php
     * @return bool
     */
    #[TentativeType]
    public function next_result(): bool {}
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.num-rows.php
    ...
    /**
     * Send data in blocks
     * @link https://php.net/manual/ru/mysqli-stmt.send-long-data.php
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.free-result.php
     * @return void
     */
    #[TentativeType]
    public function free_result(): void {}
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.reset.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.prepare.php
     * @param string $query <p>
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.store-result.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/mysqli-stmt.get-result.php
 ...
 * @link https://secure.php.net/manual/ru/mysqli.affected-rows.php
...
/**
 * Turns on or off auto-committing database modifications
 * @link https://secure.php.net/manual/ru/mysqli.autocommit.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.connect-errno.php
 ...
 * @link https://php.net/manual/ru/mysqli.connect-error.php
 ...
 * @link https://php.net/manual/ru/mysqli.errno.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.error-list.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/ru/mysqli-stmt.error-list.php
 ...
 * @link https://secure.php.net/manual/ru/mysqli.error.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @return string
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-execute.php
 * @param mysqli_stmt $statement
 * @param array|null $params [optional] An optional list array with as many elements
 * as there are bound parameters in the SQL statement being executed. Each value is treated as a string.
 * @return bool
...
/**
 * Returns the next field in the result set
 * @link https://secure.php.net/manual/ru/mysqli-result.fetch-field.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
...
/**
 * Returns an array of objects representing the fields in a result set
 * @link https://secure.php.net/manual/ru/mysqli-result.fetch-fields.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
...
/**
 * Fetch meta-data for a single field
 * @link https://secure.php.net/manual/ru/mysqli-result.fetch-field-direct.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
 ...
 * @link https://php.net/manual/ru/mysqli-result.lengths.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
...
/**
 * Fetch a single column from the next row of a result set
 * @link https://php.net/manual/ru/mysqli-result.fetch-column.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
 * @param int $column [optional] <p>
 * 0-indexed number of the column you wish to retrieve from the row.
 ...
 * @link https://php.net/manual/ru/mysqli.field-count.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli-result.current-field.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-get-cache-stats.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/function.mysqli-get-client-stats.php
 ...
 * @link https://php.net/manual/ru/mysqli.get-client-version.php
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/mysqli.get-host-info.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/function.mysqli-get-links-stats.php
 ...
 * @link https://php.net/manual/ru/mysqli.get-proto-info.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.get-server-version.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.info.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.insert-id.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.set-local-infile-default.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @return void
 * @removed 5.5
 */
 ...
 * @link https://php.net/manual/ru/mysqli.set-local-infile-handler.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli-result.field-count.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/mysqli-result.num-rows.php
 * @param mysqli_result $result A mysqli_result object returned by mysqli_query(),
 * mysqli_store_result(), mysqli_use_result() or mysqli_stmt_get_result().
...
/**
 * Prepares an SQL statement for execution 3
 * @link https://php.net/manual/ru/mysqli.prepare.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/function.mysqli-report.php
 * @param int $flags <p>
 * <table>
 * Supported flags
 * <tr valign="top">
...
/**
 * Removes the named savepoint from the set of savepoints of the current transaction
 * @link https://secure.php.net/manual/ru/mysqli.release-savepoint.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @param string $name
 * @return bool Returns TRUE on success or FALSE on failure.
 * @since 5.5
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.affected-rows.php
 * @param mysqli_stmt $statement
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.field-count.php
 * @param mysqli_stmt $statement
 * @return int
 */
...
/**
 * Prepares an SQL statement for execution 4
 * @link https://php.net/manual/ru/mysqli-stmt.prepare.php
 * @param mysqli_stmt $statement
 * @param string $query
 * @return bool
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.insert-id.php
 * @param mysqli_stmt $statement
 * @return string|int
 */
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.param-count.php
 * @param mysqli_stmt $statement
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/mysqli.sqlstate.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.errno.php
 * @param mysqli_stmt $statement
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.error.php
 * @param mysqli_stmt $statement
 * @return string
 */
 ...
 * @link https://php.net/manual/ru/mysqli-stmt.sqlstate.php
 * @param mysqli_stmt $statement
 * @return string Returns a string containing the SQLSTATE error code for the last error. The error code consists of five characters. '00000' means no error.
 */
 ...
 * @link https://php.net/manual/ru/mysqli.thread-id.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://php.net/manual/ru/mysqli.warning-count.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @return int
 */
 ...
 * @link https://php.net/manual/ru/mysqli.refresh.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @param int $flags
 * @return bool
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-bind-param.php
 * @param mysqli_stmt $statement
 * @param string $types
 * @removed 5.4
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-bind-result.php
 * @param mysqli_stmt $statement
 * @param string $types
 * @param mixed &$var1
 * @removed 5.4
 ...
 * @link https://php.net/manual/ru/function.mysqli-client-encoding.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @return string
 * @removed 5.4
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-escape-string.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @param string $string The string to be escaped
 * @return string
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-fetch.php
 * @param mysqli_stmt $statement
 * @return bool
 * @removed 5.4
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-param-count.php
 * @param mysqli_stmt $statement
 * @return int
 * @removed 5.4
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-get-metadata.php
 * @param mysqli_stmt $statement
 * @return mysqli_result|false Returns a result object or FALSE if an error occurred
 * @removed 5.4
 */
 ...
 * @link https://php.net/manual/ru/function.mysqli-send-long-data.php
 * @param mysqli_stmt $statement
 * @param int $param_num
 * @param string $data
 * @return bool
 ...
 * @link https://php.net/manual/ru/function.mysqli-set-opt.php
 * @param mysqli $mysql A link identifier returned by mysqli_connect() or mysqli_init()
 * @param int $option
 * @param string|int $value
 * @return bool
 ...
 * </p>
 * @link https://php.net/manual/ru/mysqli.constants.php
 */
