 ...
 * @link https://php.net/manual/ru/class.memcached.php
 */
class Memcached
{
    /**
     ...
     * @link https://php.net/manual/ru/memcached.constants.php
     */
    ...
    /**
     * <p>Bad key.</p>
     * @link https://php.net/manual/ru/memcached.constants.php, http://docs.libmemcached.org/index.html
     */
    /**
     ...
     * @link https://php.net/manual/ru/memcached.construct.php, https://github.com/php-memcached-dev/php-memcached/blob/v3.1.5/php_memcached.c
     ...
     * @link https://php.net/manual/ru/memcached.getresultcode.php
     ...
     * @link https://php.net/manual/ru/memcached.getresultmessage.php
     ...
     * (PECL memcached &gt;= 0.1.0)<br/>
     * Retrieve an item
     * @link https://php.net/manual/ru/memcached.get.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.getbykey.php
     ...
     * @link https://php.net/manual/ru/memcached.getmulti.php
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.getmultibykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.getdelayed.php
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.getdelayedbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.fetch.php
     ...
     * @link https://php.net/manual/ru/memcached.fetchall.php
     ...
     * (PECL memcached &gt;= 0.1.0)<br/>
     * Store an item
     * @link https://php.net/manual/ru/memcached.set.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.setbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.touch.php
     * @param string $key <p>
     * The key under which to store the value.
     * </p>
     ...
     * @link https://php.net/manual/ru/memcached.touchbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.setmulti.php
     * @param array $items <p>
     ...
     * @link https://php.net/manual/ru/memcached.setmultibykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param array $items <p>
     ...
     * @link https://php.net/manual/ru/memcached.cas.php
     ...
     * @link https://php.net/manual/ru/memcached.casbykey.php
     * @param float $cas_token <p>
     * Unique value associated with the existing item. Generated by memcache.
     * </p>
     * @param string $server_key <p>
     ...
     * @link https://php.net/manual/ru/memcached.add.php
     * @param string $key <p>
     * The key under which to store the value.
     * </p>
     * @param mixed $value <p>
     ...
     * @link https://php.net/manual/ru/memcached.addbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.append.php
     * @param string $key <p>
     * The key under which to store the value.
     * </p>
     ...
     * @link https://php.net/manual/ru/memcached.appendbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.prepend.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.prependbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.replace.php
     * @param string $key <p>
     * The key under which to store the value.
     * </p>
     * @param mixed $value <p>
     ...
     * @link https://php.net/manual/ru/memcached.replacebykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * (PECL memcached &gt;= 0.1.0)<br/>
     * Delete an item
     * @link https://php.net/manual/ru/memcached.delete.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.deletemulti.php
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.deletebykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.deletemultibykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param array $keys <p>
     ...
     * @link https://php.net/manual/ru/memcached.increment.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.decrement.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.incrementbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.decrementbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     * @param string $key <p>
     ...
     * @link https://php.net/manual/ru/memcached.addserver.php
     * @param string $host <p>
     ...
     * @link https://php.net/manual/ru/memcached.addservers.php
     * @param array $servers
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/memcached.getserverlist.php
     ...
     * @link https://php.net/manual/ru/memcached.getserverbykey.php
     * @param string $server_key <p>
     * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
     * </p>
     ...
     * @link https://php.net/manual/ru/memcached.resetserverlist.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/memcached.quit.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/memcached.getstats.php
     ...
     * @link https://php.net/manual/ru/memcached.getversion.php
     ...
     * @link https://php.net/manual/ru/memcached.getallkeys.php
     ...
     * @link https://php.net/manual/ru/memcached.flush.php
     ...
     * @link https://php.net/manual/ru/memcached.getoption.php
     * @param int $option <p>
     ...
     * @link https://php.net/manual/ru/memcached.setoption.php
     * @param int $option
     * @param mixed $value
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/memcached.setoptions.php
     ...
     * @link https://secure.php.net/manual/ru/memcached.setsaslauthdata.php
     ...
     * @link https://php.net/manual/ru/memcached.ispersistent.php
     ...
     * @link https://php.net/manual/ru/memcached.ispristine.php
...
/**
 * @link https://php.net/manual/ru/class.memcachedexception.php
 */
