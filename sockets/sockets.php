 ...
 * @link https://www.php.net/manual/ru/function.socket-addrinfo-lookup.php
 * @param string $host <p>
 * Hostname to search.
 * </p>
 ...
 * @link https://www.php.net/manual/ru/function.socket-addrinfo-connect.php
 ...
 * @link https://www.php.net/manual/ru/function.socket-addrinfo-bind.php
 * @param resource|AddressInfo $address <p>
 * Resource created from {@see socket_addrinfo_lookup()}
 * </p>
 * @return resource|Socket|null|false Socket resource on success or NULL on failure.
 ...
 * @link https://www.php.net/manual/ru/function.socket-addrinfo-explain.php
 * @param resource|AddressInfo $address <p>
 * Resource created from {@see socket_addrinfo_lookup()}
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-select.php
 ...
 * @link https://php.net/manual/ru/function.socket-create.php
 * @param int $domain <p>
 ...
 * @link https://php.net/manual/ru/function.socket-create-listen.php
 * @param int $port <p>
 ...
 * @link https://php.net/manual/ru/function.socket-create-pair.php
 * @param int $domain <p>
 * The <i>domain</i> parameter specifies the protocol
 ...
 * @link https://php.net/manual/ru/function.socket-accept.php
 ...
 * @link https://php.net/manual/ru/function.socket-set-nonblock.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 ...
 * @link https://php.net/manual/ru/function.socket-set-block.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-listen.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>.
 * </p>
 * @param int $backlog [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.socket-close.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
...
/**
 * Write to a socket
 * @link https://php.net/manual/ru/function.socket-write.php
 * @param resource|Socket $socket
 * @param string $data <p>
 ...
 * @link https://php.net/manual/ru/function.socket-read.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-getsockname.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-getpeername.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-connect.php
 * @param resource|Socket $socket
 * @param string $address <p>
 ...
 * @link https://php.net/manual/ru/function.socket-strerror.php
 ...
 * @link https://php.net/manual/ru/function.socket-bind.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>.
 * </p>
 * @param string $address <p>
 ...
 * @link https://php.net/manual/ru/function.socket-recv.php
 * @param resource|Socket $socket <p>
 ...
 * @link https://php.net/manual/ru/function.socket-send.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * (PHP 5 &gt;=5.5.0)<br/>
 * Send a message
 * @link https://secure.php.net/manual/ru/function.socket-sendmsg.php
 * @param resource|Socket $socket
 * @param array $message
 * @param int $flags
 * @return int|false
 ...
 * @link https://php.net/manual/ru/function.socket-recvfrom.php
 * @param resource|Socket $socket <p>
 * The <i>socket</i> must be a socket resource previously
 * created by socket_create().
 * </p>
...
/**
 * Read a message
 * @link https://secure.php.net/manual/ru/function.socket-recvmsg.php
 * @param resource|Socket $socket
 * @param array &$message
 * @param int $flags
 * @return int|false
 ...
 * @link https://php.net/manual/ru/function.socket-sendto.php
 * @param resource|Socket $socket <p>
 ...
 * @link https://php.net/manual/ru/function.socket-get-option.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-set-option.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>
 * or <b>socket_accept</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.socket-shutdown.php
 * @param resource|Socket $socket <p>
 * A valid socket resource created with <b>socket_create</b>.
 * </p>
 * @param int $mode [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.socket-last-error.php
 ...
 * @link https://php.net/manual/ru/function.socket-clear-error.php
...
/**
 * Import a stream
 * @link https://php.net/manual/ru/function.socket-import-stream.php
 ...
 * @link https://php.net/manual/ru/function.socket-cmsg-space.php
 * @param int $level
 * @param int $type
 ...
 *
 * @link https://www.php.net/manual/ru/function.socket-wsaprotocol-info-export.php
 *
 * @param resource|Socket $socket
 ...
 *
 * @link https://www.php.net/manual/ru/function.socket-wsaprotocol-info-import.php
 *
 ...
 *
 * @link https://www.php.net/manual/ru/function.socket-wsaprotocol-info-release.php
 *
 * @param string $info_id
 * @return bool
 *
 ...
 * @link https://php.net/manual/ru/sockets.constants.php
 */
define('AF_INET6', 10);
