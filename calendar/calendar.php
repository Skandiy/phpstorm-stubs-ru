 ...
 * @link https://php.net/manual/ru/function.jdtogregorian.php
 ...
 * @link https://php.net/manual/ru/function.gregoriantojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/ru/function.jdtojulian.php
 * @param int $julian_day <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://php.net/manual/ru/function.juliantojd.php
 * @param int $month <p>
 * The month as a number from 1 (for January) to 12 (for December)
 * </p>
 * @param int $day <p>
 ...
 * @link https://php.net/manual/ru/function.jdtojewish.php
 ...
 * @link https://php.net/manual/ru/function.jewishtojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/ru/function.jdtofrench.php
 * @param int $julian_day
 ...
 * @link https://php.net/manual/ru/function.frenchtojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/ru/function.jddayofweek.php
 * @param int $julian_day <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://php.net/manual/ru/function.jdmonthname.php
 * @param int $julian_day
 * @param int $mode
 ...
 * @link https://php.net/manual/ru/function.easter-date.php
 ...
 * @link https://php.net/manual/ru/function.easter-days.php
 * @param int|null $year [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.unixtojd.php
 ...
 * @link https://php.net/manual/ru/function.jdtounix.php
 * @param int $julian_day <p>
 ...
 * @link https://php.net/manual/ru/function.cal-to-jd.php
 ...
 * @link https://php.net/manual/ru/function.cal-from-jd.php
 * @param int $julian_day <p>
 ...
 * @link https://php.net/manual/ru/function.cal-days-in-month.php
 * @param int $calendar <p>
 ...
 * @link https://php.net/manual/ru/function.cal-info.php
