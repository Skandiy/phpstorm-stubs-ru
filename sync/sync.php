 ...
 * @link https://php.net/manual/ru/book.sync.php
 */
/**
 * SyncMutex
 *
 ...
 *
 * @link https://php.net/manual/ru/class.syncmutex.php
 */
class SyncMutex
{
    /**
     ...
     * @link https://php.net/manual/ru/syncmutex.construct.php
     */
     ...
     * @link https://php.net/manual/ru/syncmutex.lock.php
     */
     ...
     * @see SyncMutex::lock()
     * @link https://php.net/manual/ru/syncmutex.unlock.php
     */
 ...
 *
 * @link https://php.net/manual/ru/class.syncsemaphore.php
 */
class SyncSemaphore
{
    /**
     ...
     * @link https://php.net/manual/ru/syncsemaphore.construct.php
     */
     ...
     * @link https://php.net/manual/ru/syncsemaphore.lock.php
     */
    public function lock($wait = -1) {}
     ...
     * @link https://php.net/manual/ru/syncsemaphore.unlock.php
     */
 ...
 *
 * @link https://php.net/manual/ru/class.syncevent.php
 */
class SyncEvent
{
    /**
     ...
     * @link https://php.net/manual/ru/syncevent.construct.php
     */
     ...
     * @see SyncEvent::wait()
     * @link https://php.net/manual/ru/syncevent.fire.php
     */
     ...
     * @link https://php.net/manual/ru/syncevent.reset.php
     */
     ...
     * @return bool TRUE if the event was fired, FALSE otherwise.
     * @see SyncEvent::fire()
     * @link https://php.net/manual/ru/syncevent.wait.php
     */
 ...
 *
 * @link https://php.net/manual/ru/class.syncreaderwriter.php
 */
class SyncReaderWriter
{
     ...
     * @link https://php.net/manual/ru/syncreaderwriter.construct.php
     */
     ...
     * @link https://php.net/manual/ru/syncreaderwriter.readlock.php
     */
     ...
     * @link https://php.net/manual/ru/syncreaderwriter.readunlock.php
     */
     ...
     * @link https://php.net/manual/ru/syncreaderwriter.writelock.php
     */
     ...
     * @link https://php.net/manual/ru/syncreaderwriter.writeunlock.php
     */
 ...
 *
 * @since 1.1.0
 * @link https://php.net/manual/ru/class.syncsharedmemory.php
 */
class SyncSharedMemory
{
     ...
     * @link https://php.net/manual/ru/syncsharedmemory.construct.php
     */
     ...
     * @link https://php.net/manual/ru/syncsharedmemory.first.php
     */
     ...
     * @link https://php.net/manual/ru/syncsharedmemory.read.php
     */
     ...
     * @link https://php.net/manual/ru/syncsharedmemory.size.php
     */
     ...
     * @link https://php.net/manual/ru/syncsharedmemory.write.php
     */
