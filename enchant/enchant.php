 ...
 * @link https://php.net/manual/ru/function.enchant-broker-init.php
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-free.php
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-get-error.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource.
 * </p>
 ...
 * @link https://www.php.net/manual/ru/function.enchant-broker-set-dict-path.php
 ...
 * @link https://www.php.net/manual/ru/function.enchant-broker-get-dict-path.php
 * @param resource|EnchantBroker $broker
 * @param int $dict_type
 * @return string|false
 */
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-list-dicts.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-request-dict.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 * @param string $tag <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-request-pwl-dict.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-free-dict.php
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-dict-exists.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 * @param string $tag <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-set-ordering.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 * @param string $tag <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-broker-describe.php
 * @param resource|EnchantBroker $broker <p>
 * Broker resource
 * </p>
 * @return array|false
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-check.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 * @param string $word <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-suggest.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 * @param string $word <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-add-to-personal.php
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-add-to-session.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 * @param string $word <p>
 ...
 * (PHP 8)<br/>
 * Add a word to personal word list
 * @link https://php.net/manual/ru/function.enchant-dict-add.php
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-is-in-session.php
 * @param resource $dict <p>
 * Dictionary resource
 * </p>
 * @param string $word <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-store-replacement.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 * @param string $mis <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-get-error.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictinaray resource
 * </p>
 ...
 * (PHP 8)<br/>
 * Whether or not 'word' exists in this spelling-session
 * @link https://php.net/manual/ru/function.enchant-dict-is-added.php
 * @param EnchantDictionary $dictionary <p>
 * An Enchant dictionary returned by enchant_broker_request_dict() or enchant_broker_request_pwl_dict().
 * </p>
 * @param string $word <p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-describe.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 ...
 * @link https://php.net/manual/ru/function.enchant-dict-quick-check.php
 * @param resource|EnchantDictionary $dict <p>
 * Dictionary resource
 * </p>
 * @param string $word <p>
