 ...
 * @link https://php.net/manual/ru/class.simplexmlelement.php
 */
class SimpleXMLElement implements Traversable, ArrayAccess, Countable, Iterator, Stringable, RecursiveIterator
{
    /**
     * Creates a new SimpleXMLElement object
     * @link https://php.net/manual/ru/simplexmlelement.construct.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.asxml.php
     ...
     * Return a well-formed XML string based on SimpleXML element
     * @link https://php.net/manual/ru/simplexmlelement.savexml.php
     * @param string $filename [optional] <p>
     * If specified, the function writes the data to the file rather than
     * returning it.
     * </p>
     ...
     * @link https://php.net/manual/ru/simplexmlelement.xpath.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.registerxpathnamespace.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.attributes.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.children.php
     * @param string $namespaceOrPrefix [optional] <p>
     * An XML namespace.
     * </p>
     * @param bool $isPrefix [optional] <p>
     ...
     * @link https://php.net/manual/ru/simplexmlelement.getnamespaces.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.getdocnamespaces.php
     * @param bool $recursive [optional] <p>
     ...
     * @link https://php.net/manual/ru/simplexmlelement.getname.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.addchild.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.addattribute.php
     * @param string $qualifiedName <p>
     ...
     * @link https://php.net/manual/ru/simplexmlelement.tostring.php
     ...
     * @link https://php.net/manual/ru/simplexmlelement.count.php
     ...
     * @link https://php.net/manual/ru/simplexmliterator.rewind.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/simplexmliterator.valid.php
     ...
     * @link https://php.net/manual/ru/simplexmliterator.current.php
    ...
    /**
     * Return current key
     * @link https://php.net/manual/ru/simplexmliterator.key.php
     ...
     * @link https://php.net/manual/ru/simplexmliterator.next.php
     * @return void No value is returned.
     */
    #[TentativeType]
 ...
 * @link https://php.net/manual/ru/class.simplexmliterator.php
 */
class SimpleXMLIterator extends SimpleXMLElement implements RecursiveIterator, Countable, Stringable
{
     ...
     * @link https://php.net/manual/ru/simplexmliterator.haschildren.php
     ...
     * @link https://php.net/manual/ru/simplexmliterator.getchildren.php
 ...
 * @link https://php.net/manual/ru/function.simplexml-load-file.php
 ...
 * @link https://php.net/manual/ru/function.simplexml-load-string.php
 * @param string $data <p>
 ...
 * @link https://php.net/manual/ru/function.simplexml-import-dom.php
