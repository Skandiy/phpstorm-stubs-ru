 ...
 * @link https://php.net/manual/ru/function.recode-string.php
 ...
 * @link https://php.net/manual/ru/function.recode-file.php
 * @param string $request <p>
 * The desired recode request type
 * </p>
 ...
 * @link https://php.net/manual/ru/function.recode.php
 * @param $request
 * @param $str
 * @removed 7.4
 */
