 ...
 * @link https://php.net/manual/ru/pthreads.constants.php
 */
 ...
 * @link https://secure.php.net/manual/ru/class.pool.php
 */
class Pool
{
    /**
     ...
     * @link https://secure.php.net/manual/ru/pool.construct.php
     ...
     * @link https://secure.php.net/manual/ru/pool.collect.php
     ...
     * (PECL pthreads &gt;= 2.0.0)<br/>
     * Resize the Pool
     * @link https://secure.php.net/manual/ru/pool.resize.php
     ...
     * @link https://secure.php.net/manual/ru/pool.shutdown.php
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/ru/pool.submit.php
     ...
     * @link https://secure.php.net/manual/ru/pool.submitTo.php
 ...
 *
 * @link https://secure.php.net/manual/ru/class.threaded.php
 */
class Threaded implements Collectable, Traversable, Countable, ArrayAccess
{
     ...
     * @link https://secure.php.net/manual/ru/threaded.chunk.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.count.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.extend.php
     ...
     * @link https://secure.php.net/manual/ru/thread.isrunning.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.isterminated.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/threaded.merge.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.notify.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * Threaded::notify()).
     * @link https://secure.php.net/manual/ru/threaded.notifyone.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/threaded.pop.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.run.php
     * @return void
     */
    public function run() {}
     ...
     * @link https://secure.php.net/manual/ru/threaded.shift.php
     ...
     * @link https://secure.php.net/manual/ru/threaded.synchronized.php
     ...
     * referenced object
     * @link https://secure.php.net/manual/ru/threaded.wait.php
 ...
 *
 * @link https://secure.php.net/manual/ru/class.thread.php
 */
class Thread extends Threaded implements Countable, Traversable, ArrayAccess
{
     ...
     * @link https://secure.php.net/manual/ru/thread.getcreatorid.php
     ...
     * @link https://secure.php.net/manual/ru/thread.getcurrentthread.php
     ...
     * @link https://secure.php.net/manual/ru/thread.getcurrentthreadid.php
     * @return int <p>A numeric identity</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/thread.getthreadid.php
     * @return int <p>A numeric identity</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/thread.isjoined.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/thread.isstarted.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/thread.join.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/thread.start.php
 ...
 * objects run method.
 * @link https://secure.php.net/manual/ru/class.worker.php
 */
class Worker extends Thread implements Traversable, Countable, ArrayAccess
{
     ...
     * optionally given collector
     * @link https://secure.php.net/manual/ru/worker.collect.php
     ...
     * @link https://secure.php.net/manual/ru/worker.getstacked.php
     ...
     * @link https://secure.php.net/manual/ru/worker.isshutdown.php
     ...
     * @link https://secure.php.net/manual/ru/worker.shutdown.php
     ...
     * @link https://secure.php.net/manual/ru/worker.stack.php
     ...
     * @link https://secure.php.net/manual/ru/worker.unstack.php
 ...
 * @link https://secure.php.net/manual/ru/class.collectable.php
 */
interface Collectable
{
     ...
     * @link https://secure.php.net/manual/ru/collectable.isgarbage.php
 ...
 * @see Threaded
 * @link https://secure.php.net/manual/ru/class.volatile.php
 */
