 ...
 * hardware.
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-is-available
 * @return bool
 * @since 7.2
 */
 ...
 * AES-256-GCM
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-decrypt.php
 ...
 * AES-256-GCM
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-encrypt.php
 ...
 * Authenticated Encryption with Associated Data (decrypt)
 * ChaCha20 + Poly1305
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-decrypt.php
 * @param string $ciphertext encrypted message
 * @param string $additional_data additional data
 * @param string $nonce
 * @param string $key
 ...
 * Authenticated Encryption with Associated Data (encrypt)
 * ChaCha20 + Poly1305
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-encrypt.php
 * @param string $message plaintext message
 * @param string $additional_data additional data
 * @param string $nonce
 * @param string $key
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-ietf-decrypt.php
 * @param string $ciphertext encrypted message
 * @param string $additional_data additional data
 * @param string $nonce
 * @param string $key
 ...
 * Authenticated Encryption with Associated Data (encrypt)
 * ChaCha20 + Poly1305 (IETF version)
 * @link https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-ietf-encrypt.php
 * @param string $message plaintext message
 * @param string $additional_data additional data
 * @param string $nonce
 * @param string $key
 ...
 * HMAC SHA-512/256
 * @link https://www.php.net/manual/ru/function.sodium-crypto-auth.php
 ...
 * @link https://php.net/manual/ru/function.sodium-crypto-auth-keygen.php
 * @return string
 * @since 7.2
 */
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-keypair.php
 * @since 7.2
 * @return string
 * @throws SodiumException
 * @since 7.2
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-publickey.php
 * @since 7.2
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-secretkey.php
 * @param string $key_pair
 * @return string
 * @throws SodiumException
 * @since 7.2
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-seed-keypair.php
 * @since 7.2
 * @param string $seed
 * @return string
 * @throws SodiumException
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-server-session-keys.php
 * @since 7.2
...
/**
 * Get random bytes for key
 * @link https://php.net/manual/ru/function.sodium-crypto-generichash-keygen.php
 * @return string
 * @since 7.2
 */
...
/**
 * @link https://php.net/manual/ru/function.sodium-crypto-kx-client-session-keys.php
...
/**
 * @link https://www.php.net/manual/ru/function.sodium-crypto-kdf-derive-from-key.php
...
/**
 * Get random bytes for key
 * @link https://php.net/manual/ru/function.sodium-crypto-kdf-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Get random bytes for key
 * @link https://php.net/manual/ru/function.sodium-crypto-shorthash-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Get random bytes for key
 * @link https://php.net/manual/ru/function.sodium-crypto-stream-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Add padding data
 * @link https://php.net/manual/ru/function.sodium-pad.php
 * @param string $string
...
/**
 * Remove padding data
 * @link https://php.net/manual/ru/function.sodium-unpad.php
 * @param string $string
 * @param int $block_size
 * @return string
 * @throws SodiumException
 ...
 * HMAC SHA-512/256
 * @link https://www.php.net/manual/ru/function.sodium-crypto-auth-verify.php
 * @param string $mac
 * @param string $message
 * @param string $key
 * @return bool
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box.php
 * @param string $message
 * @param string $nonce
 * @param string $key_pair
 * @return string
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-keypair.php
 * @return string
 * @throws SodiumException
 * @since 7.2
 */
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-seed-keypair.php
 * @param string $seed
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-keypair-from-secretkey-and-publickey.php
 ...
 * X25519 + Xsalsa20 + Poly1305
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-open.php
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-publickey.php
 * @param string $key_pair
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-publickey-from-secretkey.php
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-seal.php
 * @param string $message
 * @param string $public_key
 * @return string
 * @throws SodiumException
 ...
 * X25519 + Xsalsa20 + Poly1305 + BLAKE2b
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-seal-open.php
 * @param string $ciphertext
 * @param string $key_pair
 * @return string|false
 * @throws SodiumException
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-box-secretkey.php
 * @param string $key_pair
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-generichash.php
 * @param string $message
 * @param string $key
 * @param int $length
 * @return string
 ...
 * BLAKE2b
 * @link https://www.php.net/manual/ru/function.sodium-crypto-generichash-init.php
 * @param string $key
 * @param int $length
 * @return string
 * @throws SodiumException
 ...
 * BLAKE2b
 * @link https://www.php.net/manual/ru/function.sodium-crypto-generichash-update.php
 * @param string &$state
 * @param string $message
 * @return bool
 * @throws SodiumException
 ...
 * Get the final hash
 * BLAKE2b
 * @link https://www.php.net/manual/ru/function.sodium-crypto-generichash-final.php
 * @param string &$state
 * @param int $length
 * @return string
 * @throws SodiumException
 ...
 * Argon2i
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash.php
 * @param int $length
 ...
 * Argon2i
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash-str.php
 * @param string $password
 * @param int $opslimit
 * @param int $memlimit
 * @return string
 ...
 * Argon2i
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash-str-verify.php
 * @param string $hash
 * @param string $password
 * @return bool
 * @throws SodiumException
 ...
 * Secure password-based key derivation function
 * Scrypt
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash-scryptsalsa208sha256.php
 * @param int $length
 * @param string $password
 * @param string $salt
 * @param int $opslimit
 ...
 * Get a formatted password hash (for storage)
 * Scrypt
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash-scryptsalsa208sha256-str.php
 * @param string $password
 * @param int $opslimit
 * @param int $memlimit
 * @return string
 ...
 * Verify a password against a hash
 * Scrypt
 * @link https://www.php.net/manual/ru/function.sodium-crypto-pwhash-scryptsalsa208sha256-str-verify
 * @param string $hash
 * @param string $password
 * @return bool
 * @since 7.2
 ...
 * X25519
 * @link https://www.php.net/manual/ru/function.sodium-crypto-scalarmult.php
 * @param string $n
 * @param string $p
 * @return string
 * @throws SodiumException
 ...
 * Xsals20 + Poly1305
 * @link https://www.php.net/manual/ru/function.sodium-crypto-secretbox.php
 * @param string $message
 * @param string $nonce
 * @param string $key
 * @return string
 ...
 * Xsals20 + Poly1305
 * @link https://www.php.net/manual/ru/function.sodium-crypto-secretbox-open.php
 * @param string $ciphertext
 * @param string $nonce
 * @param string $key
 * @return string|false
 ...
 * SipHash-2-4
 * @link https://www.php.net/manual/ru/function.sodium-crypto-shorthash.php
 * @param string $message
 * @param string $key
 * @return string
 * @throws SodiumException
 ...
 * Digital Signature
 * Ed25519
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign.php
 * @param string $message
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 ...
 * Ed25519
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-detached.php
 * @param string $message
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php
 * @param string $public_key
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-ed25519-sk-to-curve25519.php
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-keypair.php
 * @return string
 * @throws SodiumException
 * @since 7.2
 */
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-keypair-from-secretkey-and-publickey.php
 * @param string $secret_key
 * @param string $public_key
 * @return string
 * @throws SodiumException
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-open.php
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-publickey.php
 * @param string $key_pair
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-secretkey.php
 * @param string $key_pair
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-publickey-from-secretkey.php
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-seed-keypair.php
 * @param string $seed
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-sign-verify-detached.php
 ...
 * Xsalsa20
 * @link https://www.php.net/manual/ru/function.sodium-crypto-stream.php
 * @param int $length
 * @param string $nonce
 * @param string $key
 * @return string
 ...
 * Xsalsa20
 * @link https://www.php.net/manual/ru/function.sodium-crypto-stream-xor.php
 * @param string $message
 * @param string $nonce
 * @param string $key
 * @return string
 ...
 * @link https://www.php.net/manual/ru/function.sodium-bin2hex.php
 * @param string $string
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-compare.php
 ...
 * @link https://www.php.net/manual/ru/function.sodium-hex2bin.php
 * @param string $string
 ...
 * @link https://www.php.net/manual/ru/function.sodium-increment.php
 * @param string &$string
 * @return void
 * @throws SodiumException
 * @since 7.2
 ...
 * @link https://www.php.net/manual/ru/function.sodium-add.php
 * @param string &$string1
 * @param string $string2
 * @throws SodiumException
 * @since 7.2
...
/**
 * Compare two strings in constant time
 * @link https://www.php.net/manual/ru/function.sodium-memcmp.php
 * @param string $string1
 * @param string $string2
 * @return int
 * @throws SodiumException
...
/**
 * Wipe a buffer
 * @link https://www.php.net/manual/ru/function.sodium-memzero.php
 * @param string &$string
 * @throws SodiumException
 * @since 7.2
 */
 ...
 * @link https://www.php.net/manual/ru/function.sodium-crypto-scalarmult-base
 * @param string $secret_key
 * @return string
 * @throws SodiumException
 * @since 7.2
 ...
 *
 * @since 7.2
 * @see https://secure.php.net/manual/ru/function.sodium-crypto-secretbox-keygen.php
 */
 ...
 *
 * @since 7.2
 * @see https://secure.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-keygen.php
 */
 ...
 *
 * @since 7.2
 * @see https://secure.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-keygen.php
 */
 ...
 *
 * @since 7.2
 * @see https://secure.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-ietf-keygen.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-aead-xchacha20poly1305-ietf-decrypt.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * https://www.php.net/manual/ru/function.sodium-crypto-aead-xchacha20poly1305-ietf-encrypt.php
 */
...
/**
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php
 */
 ...
 * @return bool
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-pwhash-str-needs-rehash.php
 */
function sodium_crypto_pwhash_str_needs_rehash(string $password, int $opslimit, int $memlimit): bool {}

/**
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-secretstream-xchacha20poly1305-keygen.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-secretstream-xchacha20poly1305-init-push.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-crypto-secretstream-xchacha20poly1305-rekey.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-bin2base64.php
 */
 ...
 * @throws SodiumException
 * @since 7.2
 * @see https://www.php.net/manual/ru/function.sodium-base642bin.php
 * @return string
 */
