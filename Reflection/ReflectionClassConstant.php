 ...
 *
 * @link https://www.php.net/manual/ru/class.reflectionclassconstant.php
 * @since 7.1
 */
class ReflectionClassConstant implements Reflector
{
     ...
     * @since 7.1
     * @link https://php.net/manual/ru/reflectionclassconstant.construct.php
     */
    public function __construct(#[LanguageLevelTypeAware(['8.0' => 'string|object'], default: '')] $class, string $constant) {}

    /**
     * @link https://php.net/manual/ru/reflectionclassconstant.export.php
     ...
     * @link https://php.net/manual/ru/reflectionclassconstant.getdeclaringclass.php
     * @since 7.1
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/reflectionclassconstant.getdoccomment.php
     * @since 7.1
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/reflectionclassconstant.getmodifiers.php
     * @since 7.1
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.getname.php
     ...
     * Gets value
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.getvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.isprivate.php
     * @return bool
     * @since 7.1
     */
    #[Pure]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.isprotected.php
     * @return bool
     * @since 7.1
     */
    #[Pure]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.ispublic.php
     * @return bool
     * @since 7.1
     */
    #[Pure]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclassconstant.tostring.php
     * @return string
     * @since 7.1
     */
