 ...
 *
 * @link https://php.net/manual/ru/class.reflectionobject.php
 */
class ReflectionObject extends ReflectionClass
{
     ...
     *
     * @link https://php.net/manual/ru/reflectionobject.construct.php
     ...
     * Export
     *
     * @link https://php.net/manual/ru/reflectionobject.export.php
