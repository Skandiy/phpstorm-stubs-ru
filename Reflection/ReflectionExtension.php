 ...
 *
 * @link https://php.net/manual/ru/class.reflectionextension.php
 */
class ReflectionExtension implements Reflector
{
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.construct.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.export.php
     ...
     * To string
     *
     * @link https://php.net/manual/ru/reflectionextension.tostring.php
     ...
     * Gets extension name
     *
     * @link https://php.net/manual/ru/reflectionextension.getname.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.getversion.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.getfunctions.php
     ...
     * Gets constants
     *
     * @link https://php.net/manual/ru/reflectionextension.getconstants.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.getinientries.php
     ...
     * Gets classes
     *
     * @link https://php.net/manual/ru/reflectionextension.getclasses.php
     ...
     * Gets class names
     *
     * @link https://php.net/manual/ru/reflectionextension.getclassnames.php
     ...
     * Gets dependencies
     *
     * @link https://php.net/manual/ru/reflectionextension.getdependencies.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.info.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.ispersistent.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionextension.istemporary.php
     ...
     * Clones
     *
     * @link https://php.net/manual/ru/reflectionextension.clone.php
