 ...
 * properties.
 *
 * @link https://php.net/manual/ru/class.reflectionproperty.php
 */
class ReflectionProperty implements Reflector
{
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionproperty.php#reflectionproperty.constants.is-static
     */
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionproperty.php#reflectionproperty.constants.is-public
     */
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionproperty.php#reflectionproperty.constants.is-protected
     */
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionproperty.php#reflectionproperty.constants.is-private
     */
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.construct.php
     ...
     * Export
     *
     * @link https://php.net/manual/ru/reflectionproperty.export.php
     ...
     * To string
     *
     * @link https://php.net/manual/ru/reflectionproperty.tostring.php
     * @return string
     */
    #[TentativeType]
     ...
     * Gets property name
     *
     * @link https://php.net/manual/ru/reflectionproperty.getname.php
     ...
     * Gets value
     *
     * @link https://php.net/manual/ru/reflectionproperty.getvalue.php
     ...
     * Set property value
     *
     * @link https://php.net/manual/ru/reflectionproperty.setvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.ispublic.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.isprivate.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.isprotected.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.isstatic.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.isdefault.php
     ...
     * Gets modifiers
     *
     * @link https://php.net/manual/ru/reflectionproperty.getmodifiers.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.getdeclaringclass.php
     ...
     * Gets doc comment
     *
     * @link https://php.net/manual/ru/reflectionproperty.getdoccomment.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.setaccessible.php
     ...
     * Gets property type
     *
     * @link https://php.net/manual/ru/reflectionproperty.gettype.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.hastype.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionproperty.isinitialized.php
     ...
     * Clone
     *
     * @link https://php.net/manual/ru/reflectionproperty.clone.php
     * @return void
     */
