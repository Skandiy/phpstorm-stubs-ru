 ...
 *
 * @link https://php.net/manual/ru/class.reflectionclass.php
 */
class ReflectionClass implements Reflector
{
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionclass.php#reflectionclass.constants.is-implicit-abstract
     */
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionclass.php#reflectionclass.constants.is-explicit-abstract
     */
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionclass.php#reflectionclass.constants.is-final
     */
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.construct.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.export.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.tostring.php
     ...
     * Gets class name
     *
     * @link https://php.net/manual/ru/reflectionclass.getname.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isinternal.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isuserdefined.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isinstantiable.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.iscloneable.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getfilename.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getstartline.php
     ...
     * Gets end line
     *
     * @link https://php.net/manual/ru/reflectionclass.getendline.php
     ...
     * Gets doc comments
     *
     * @link https://php.net/manual/ru/reflectionclass.getdoccomment.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getconstructor.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.hasmethod.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getmethod.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getmethods.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.hasproperty.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getproperty.php
     ...
     * Gets properties
     *
     * @link https://php.net/manual/ru/reflectionclass.getproperties.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getreflectionconstant.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getreflectionconstants.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.hasconstant.php
     ...
     * Gets constants
     *
     * @link https://php.net/manual/ru/reflectionclass.getconstants.php
     * @param int|null $filter [optional] allows the filtering of constants defined in a class by their visibility. Since 8.0.
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getconstant.php
     ...
     * Gets the interfaces
     *
     * @link https://php.net/manual/ru/reflectionclass.getinterfaces.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getinterfacenames.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isanonymous.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     * @since 7.0
     */
    #[Pure]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isinterface.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.gettraits.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.gettraitnames.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.gettraitaliases.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.istrait.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isabstract.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isfinal.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     * Gets modifiers
     *
     * @link https://php.net/manual/ru/reflectionclass.getmodifiers.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isinstance.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.newinstance.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.newinstancewithoutconstructor.php
     * @return object a new instance of the class.
     ...
     * Creates a new class instance from given arguments.
     *
     * @link https://php.net/manual/ru/reflectionclass.newinstanceargs.php
     ...
     * Gets parent class
     *
     * @link https://php.net/manual/ru/reflectionclass.getparentclass.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.issubclassof.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getstaticproperties.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getstaticpropertyvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.setstaticpropertyvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getdefaultproperties.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isiterateable.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.isiterable.php
     * @return bool Returns {@see true} on success or {@see false} on failure.
     * @since 7.2
     */
    #[Pure]
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.implementsinterface.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getextension.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.getextensionname.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionclass.innamespace.php
     * @return bool {@see true} on success or {@see false} on failure.
     */
    #[TentativeType]
     ...
     * Gets namespace name
     *
     * @link https://php.net/manual/ru/reflectionclass.getnamespacename.php
     ...
     * Gets short name
     *
     * @link https://php.net/manual/ru/reflectionclass.getshortname.php
     ...
     * Clones object
     *
     * @link https://php.net/manual/ru/reflectionclass.clone.php
     * @return void
     */
