 ...
 *
 * @link https://php.net/manual/ru/class.reflectionparameter.php
 */
class ReflectionParameter implements Reflector
{
     ...
     * Construct
     *
     * @link https://php.net/manual/ru/reflectionparameter.construct.php
     ...
     * Exports
     *
     * @link https://php.net/manual/ru/reflectionparameter.export.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.tostring.php
     * @return string
     */
    #[TentativeType]
     ...
     * Gets parameter name
     *
     * @link https://php.net/manual/ru/reflectionparameter.getname.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.ispassedbyreference.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.canbepassedbyvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getdeclaringfunction.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getdeclaringclass.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getclass.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.hastype.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.gettype.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.isarray.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.iscallable.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.allowsnull.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getposition.php
     ...
     * Checks if optional
     *
     * @link https://php.net/manual/ru/reflectionparameter.isoptional.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.isdefaultvalueavailable.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getdefaultvalue.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.isdefaultvalueconstant.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.getdefaultvalueconstantname.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionparameter.isvariadic.php
     ...
     * Clone
     *
     * @link https://php.net/manual/ru/reflectionparameter.clone.php
     * @return void
     */
