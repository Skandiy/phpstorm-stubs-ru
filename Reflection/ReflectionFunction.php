 ...
 *
 * @link https://php.net/manual/ru/class.reflectionfunction.php
 */
class ReflectionFunction extends ReflectionFunctionAbstract
{
     ...
     *
     * @link https://www.php.net/manual/ru/class.reflectionfunction.php#reflectionfunction.constants.is-deprecated
     */
     ...
     *
     * @link https://php.net/manual/ru/reflectionfunction.construct.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionfunction.tostring.php
     */
    #[TentativeType]
     ...
     * Exports function
     *
     * @link https://php.net/manual/ru/reflectionfunction.export.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionfunction.isdisabled.php
     ...
     * Invokes function
     *
     * @link https://www.php.net/manual/ru/reflectionfunction.invoke.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionfunction.invokeargs.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionfunction.getclosure.php
