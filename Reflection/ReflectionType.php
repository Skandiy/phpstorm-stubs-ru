 ...
 *
 * @link https://www.php.net/manual/ru/class.reflectiontype.php
 * @since 7.0
 */
abstract class ReflectionType implements Stringable
{
     ...
     *
     * @link https://php.net/manual/ru/reflectiontype.allowsnull.php
     ...
     *
     * @link https://php.net/manual/ru/reflectionnamedtype.isbuiltin.php
     ...
     * To string
     *
     * @link https://php.net/manual/ru/reflectiontype.tostring.php
