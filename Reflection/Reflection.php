 ...
 *
 * @link https://php.net/manual/ru/class.reflection.php
 */
class Reflection
{
    /**
     * Gets modifier names
     *
     * @link https://php.net/manual/ru/reflection.getmodifiernames.php
     ...
     * Exports
     *
     * @link https://php.net/manual/ru/reflection.export.php
