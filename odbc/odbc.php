 ...
 * @link https://php.net/manual/ru/function.odbc-autocommit.php
 ...
 * @link https://php.net/manual/ru/function.odbc-binmode.php
 ...
 * @link https://php.net/manual/ru/function.odbc-close.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-close-all.php
 * @return void No value is returned.
 */
 ...
 * @link https://php.net/manual/ru/function.odbc-columns.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-commit.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
 ...
 * @link https://php.net/manual/ru/function.odbc-connect.php
 * @param string $dsn <p>
...
/**
 * Get cursorname
 * @link https://php.net/manual/ru/function.odbc-cursor.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-data-source.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-execute.php
 * @param resource $result_id <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-error.php
 ...
 * @link https://php.net/manual/ru/function.odbc-errormsg.php
 * @param resource $connection_id [optional] <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return string If <i>connection_id</i> is specified, the last state
 * of that connection is returned, else the last state of any connection
 ...
 * @link https://php.net/manual/ru/function.odbc-exec.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-fetch-array.php
 ...
 * @link https://php.net/manual/ru/function.odbc-fetch-object.php
 * @param resource $result <p>
 * The result resource from <b>odbc_exec</b>.
 * </p>
 * @param int $rownumber [optional] <p>
...
/**
 * Fetch a row
 * @link https://php.net/manual/ru/function.odbc-fetch-row.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-fetch-into.php
 * @param resource $result_id <p>
 * The result resource.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-field-len.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-field-scale.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Get the columnname
 * @link https://php.net/manual/ru/function.odbc-field-name.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Datatype of a field
 * @link https://php.net/manual/ru/function.odbc-field-type.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-field-num.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-free-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-gettypeinfo.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-longreadlen.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $length <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-next-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-num-fields.php
 * @param resource $result_id <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-num-rows.php
 * @param resource $result_id <p>
 * The result identifier returned by <b>odbc_exec</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-pconnect.php
 * @param string $dsn
 * @param string $user
 ...
 * @link https://php.net/manual/ru/function.odbc-prepare.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $query_string <p>
...
/**
 * Get result data
 * @link https://php.net/manual/ru/function.odbc-result.php
 * @param resource $result_id <p>
 * The ODBC resource.
 * </p>
 * @param mixed $field <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-result-all.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.odbc-rollback.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
 ...
 * @link https://php.net/manual/ru/function.odbc-setoption.php
 * @param resource $id <p>
 ...
 * @link https://php.net/manual/ru/function.odbc-specialcolumns.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-statistics.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://php.net/manual/ru/function.odbc-tables.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier [optional] <p>
 * The qualifier.
 ...
 * @link https://php.net/manual/ru/function.odbc-primarykeys.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-columnprivileges.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://php.net/manual/ru/function.odbc-tableprivileges.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://php.net/manual/ru/function.odbc-foreignkeys.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-procedures.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-procedurecolumns.php
 * @param resource $connection_id <p>The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://php.net/manual/ru/function.odbc-do.php
 * @param $connection_id
 * @param $query
 ...
 * @link https://php.net/manual/ru/function.odbc-field-precision.php
 * @param $result_id
 * @param $field_number
 */
