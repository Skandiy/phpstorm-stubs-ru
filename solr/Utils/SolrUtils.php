 ...
 * @link https://php.net/manual/ru/class.solrutils.php
 */
abstract class SolrUtils
{
     ...
     * @link https://php.net/manual/ru/solrutils.digestxmlresponse.php
     ...
     * @link https://php.net/manual/ru/solrutils.escapequerychars.php
     * @param string $str <p>
     ...
     * @link https://php.net/manual/ru/solrutils.getsolrversion.php
     * @return string <p>
     ...
     * @link https://php.net/manual/ru/solrutils.queryphrase.php
     * @param string $str <p>
     * The lucene phrase.
     * </p>
     * @return string <p>
