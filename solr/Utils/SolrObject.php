 ...
 * read-only.
 * @link https://php.net/manual/ru/class.solrobject.php
 */
final class SolrObject implements ArrayAccess
{
     ...
     * @link https://php.net/manual/ru/solrobject.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/ru/solrobject.destruct.php
     */
     ...
     * @link https://php.net/manual/ru/solrobject.getpropertynames.php
     * @return array <p>
     * Returns an array.
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrobject.offsetexists.php
     ...
     * @link https://php.net/manual/ru/solrobject.offsetget.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     ...
     * @link https://php.net/manual/ru/solrobject.offsetset.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     ...
     * @link https://php.net/manual/ru/solrobject.offsetunset.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     * @return bool
