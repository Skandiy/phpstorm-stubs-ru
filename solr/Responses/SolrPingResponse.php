 ...
 * @link https://php.net/manual/ru/class.solrpingresponse.php
 */
final class SolrPingResponse extends SolrResponse
{
     ...
     * @link https://php.net/manual/ru/solrpingresponse.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/ru/solrpingresponse.destruct.php
     */
     ...
     * @link https://php.net/manual/ru/solrpingresponse.getresponse.php
     * @return string <p>
