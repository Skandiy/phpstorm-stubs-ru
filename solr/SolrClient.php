 ...
 * not supported.
 * @link https://php.net/manual/ru/class.solrclient.php
 */
final class SolrClient
{
     ...
     * @link https://php.net/manual/ru/solrclient.adddocument.php
     ...
     * @link https://php.net/manual/ru/solrclient.adddocuments.php
     * @param array $docs <p>
     ...
     * @link https://php.net/manual/ru/solrclient.commit.php
     ...
     * @link https://php.net/manual/ru/solrclient.construct.php
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Delete by Id
     * @link https://php.net/manual/ru/solrclient.deletebyid.php
     * @param string $id <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Deletes by Ids
     * @link https://php.net/manual/ru/solrclient.deletebyids.php
     * @param array $ids <p>
     ...
     * @link https://php.net/manual/ru/solrclient.deletebyqueries.php
     ...
     * @link https://php.net/manual/ru/solrclient.deletebyquery.php
     ...
     * @link https://php.net/manual/ru/solrclient.destruct.php
     */
     ...
     * @link https://php.net/manual/ru/solrclient.getbyid.php
     * @param string $id <p>
     * Document ID
     * </p>
     ...
     * @link https://php.net/manual/ru/solrclient.getbyids.php
     * @param array $ids <p>
     * Document ids
     * </p>
     * @return SolrQueryResponse
     ...
     * @link https://php.net/manual/ru/solrclient.getdebug.php
     * @return string <p>
     ...
     * @link https://php.net/manual/ru/solrclient.getoptions.php
     * @return array <p>
     ...
     * @link https://php.net/manual/ru/solrclient.optimize.php
     ...
     * @link https://php.net/manual/ru/solrclient.ping.php
     ...
     * @link https://php.net/manual/ru/solrclient.query.php
     ...
     * @link https://php.net/manual/ru/solrclient.request.php
     ...
     * @link https://php.net/manual/ru/solrclient.rollback.php
     * @return SolrUpdateResponse <p>
     * Returns a SolrUpdateResponse on success and throws an exception on failure.
     * </p>
     * @throws SolrClientException <p>
     ...
     * @link https://php.net/manual/ru/solrclient.setresponsewriter.php
     ...
     * @link https://php.net/manual/ru/solrclient.setservlet.php
     * @param int $type <p>
     * One of the following :
     * </p>
     * <ul>
     ...
     * @link https://php.net/manual/ru/solrclient.system.php
     ...
     * @link https://php.net/manual/ru/solrclient.threads.php
     * @return SolrGenericResponse <p>
     * Returns a SolrGenericResponse object on success.
     * </p>
     * @throws SolrClientException <p>
