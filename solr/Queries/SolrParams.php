 ...
 * @link https://php.net/manual/ru/class.solrparams.php
 */
abstract class SolrParams implements Serializable
{
     ...
     * @link https://php.net/manual/ru/solrparams.add.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/solrparams.addparam.php
     * @param string $name <p>
     * The name of the parameter
     * </p>
     * @param string $value <p>
     ...
     * @link https://php.net/manual/ru/solrparams.get.php
     ...
     * @link https://php.net/manual/ru/solrparams.getparam.php
     * @param string $param_name <p>
     * The name of the parameter
     * </p>
     * @return mixed <p>
     ...
     * @link https://php.net/manual/ru/solrparams.getparams.php
     * @return array <p>
     * Returns an array of non URL-encoded parameters
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrparams.getpreparedparams.php
     * @return array <p>
     * Returns an array of URL-encoded parameters
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrparams.serialize.php
     * @return string <p>
     * Used for custom serialization
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrparams.set.php
     * @param string $name <p>
     * The name of the parameter
     * </p>
     * @param string $value <p>
     ...
     * @link https://php.net/manual/ru/solrparams.setparam.php
     * @param string $name <p>
     * The name of the parameter
     * </p>
     * @param string $value <p>
     ...
     * @link https://php.net/manual/ru/solrparams.tostring.php
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Used for custom serialization
     * @link https://php.net/manual/ru/solrparams.unserialize.php
