 ...
 * @link https://php.net/manual/ru/class.solrmodifiableparams.php
 */
class SolrModifiableParams extends SolrParams implements Serializable
{
     ...
     * @link https://php.net/manual/ru/solrmodifiableparams.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/ru/solrmodifiableparams.destruct.php
     */
