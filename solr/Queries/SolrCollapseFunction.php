 ...
 * @link https://php.net/manual/ru/class.solrcollapsefunction.php
 */
class SolrCollapseFunction
{
    /** @var string */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.construct.php
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.getfield.php
     * @return string
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.gethint.php
     * @return string
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.getmax.php
     * @return string
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.getmin.php
     * @return string
     */
     ...
     * (PECL solr &gt;= 2.2.0)<br/>
     * Returns null policy
     * @link https://php.net/manual/ru/solrcollapsefunction.getnullpolicy.php
     * @return string
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.getsize.php
     * @return int
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.setfield.php
     ...
     * (PECL solr &gt;= 2.2.0)<br/>
     * Sets collapse hint
     * @link https://php.net/manual/ru/solrcollapsefunction.sethint.php
     * @param string $hint <p>
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.setmax.php
     * @param string $max
     * @return SolrCollapseFunction
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.setmin.php
     * @param string $min
     * @return SolrCollapseFunction
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.setnullpolicy.php
     ...
     * (PECL solr &gt;= 2.2.0)<br/>
     * Sets the initial size of the collapse data structures when collapsing on a numeric field only.
     * @link https://php.net/manual/ru/solrcollapsefunction.setsize.php
     * @param int $size
     * @return SolrCollapseFunction
     */
     ...
     * @link https://php.net/manual/ru/solrcollapsefunction.tostring.php
     * @return string
     */
