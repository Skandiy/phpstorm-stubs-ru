 ...
 * @link https://php.net/manual/ru/class.solrdocumentfield.php
 */
final class SolrDocumentField
{
     ...
     * @link https://php.net/manual/ru/solrdocumentfield.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/ru/solrdocumentfield.destruct.php
     */
