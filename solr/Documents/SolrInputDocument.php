...
final class SolrInputDocument
{
     ...
     * @link https://php.net/manual/ru/solrinputdocument.addchilddocument.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.addchilddocuments.php
     * @param array &$docs <p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.addfield.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.clear.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrinputdocument.clone.php
     */
     ...
     * @link https://php.net/manual/ru/solrinputdocument.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/ru/solrinputdocument.destruct.php
     */
     ...
     * @link https://php.net/manual/ru/solrinputdocument.fieldexists.php
     * @param string $fieldName <p>
     * Name of the field.
     * </p>
     * @return bool <p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getboost.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getchilddocuments.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getchilddocumentscount.php
     * @return int
     */
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getfield.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getfieldboost.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return float|false <p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getfieldcount.php
     * @return int|false <p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.getfieldnames.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.haschilddocuments.php
     * @return bool <p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.merge.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.reset.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/ru/solrinputdocument.setboost.php
     ...
     * https://php.net/manual/ru/solrinputdocument.setfieldboost.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     ...
     * @link https://php.net/manual/ru/solrinputdocument.sort.php
     ...
     * @link https://php.net/manual/ru/solrinputdocument.toarray.php
     * @return array|false <p>
