...
/**
 * Reads a line
 * @link https://php.net/manual/ru/function.readline.php
 ...
 * @link https://php.net/manual/ru/function.readline-info.php
 ...
 * @link https://php.net/manual/ru/function.readline-add-history.php
...
/**
 * Clears the history
 * @link https://php.net/manual/ru/function.readline-clear-history.php
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
...
/**
 * Lists the history
 * @link https://php.net/manual/ru/function.readline-list-history.php
...
/**
 * Reads the history
 * @link https://php.net/manual/ru/function.readline-read-history.php
...
/**
 * Writes the history
 * @link https://php.net/manual/ru/function.readline-write-history.php
 * @param string|null $filename [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.readline-completion-function.php
 ...
 * @link https://php.net/manual/ru/function.readline-callback-handler-install.php
 * @param string $prompt <p>
 * The prompt message.
 * </p>
 * @param callable $callback <p>
 ...
 * @link https://php.net/manual/ru/function.readline-callback-read-char.php
 ...
 * @link https://php.net/manual/ru/function.readline-callback-handler-remove.php
...
/**
 * Redraws the display
 * @link https://php.net/manual/ru/function.readline-redisplay.php
 * @return void No value is returned.
 */
 ...
 * @link https://php.net/manual/ru/function.readline-on-new-line.php
 * @return void No value is returned.
 */
