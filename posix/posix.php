 ...
 * @link https://php.net/manual/ru/function.posix-kill.php
 ...
 * @link https://php.net/manual/ru/function.posix-getpid.php
 ...
 * @link https://php.net/manual/ru/function.posix-getppid.php
 * @return int the identifier, as an integer.
 */
#[Pure]
 ...
 * @link https://php.net/manual/ru/function.posix-getuid.php
 ...
 * @link https://php.net/manual/ru/function.posix-setuid.php
 * @param int $user_id <p>
 * The user id.
 * </p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 ...
 * @link https://php.net/manual/ru/function.posix-geteuid.php
 * @return int the user id, as an integer
 */
#[Pure]
 ...
 * @link https://php.net/manual/ru/function.posix-seteuid.php
 * @param int $user_id <p>
 * The user id.
 * </p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 ...
 * @link https://php.net/manual/ru/function.posix-setrlimit.php
 * @param int $resource <p>
 * The
 * {@link https://php.net/manual/ru/posix.constants.setrlimit.php resource limit constant}
 ...
 * @link https://php.net/manual/ru/function.posix-getgid.php
 ...
 * @link https://php.net/manual/ru/function.posix-setgid.php
 ...
 * @link https://php.net/manual/ru/function.posix-getegid.php
 ...
 * @link https://php.net/manual/ru/function.posix-setegid.php
 * @param int $group_id <p>
 * The group id.
 * </p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 ...
 * @link https://php.net/manual/ru/function.posix-getgroups.php
...
/**
 * Return login name
 * @link https://php.net/manual/ru/function.posix-getlogin.php
 ...
 * @link https://php.net/manual/ru/function.posix-getpgrp.php
 * @return int the identifier, as an integer.
 */
#[Pure]
 ...
 * @link https://php.net/manual/ru/function.posix-setsid.php
 ...
 * @link https://php.net/manual/ru/function.posix-setpgid.php
 * @param int $process_id <p>
 * The process id.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.posix-getpgid.php
 * @param int $process_id <p>
 * The process id.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.posix-getsid.php
 * @param int $process_id <p>
...
/**
 * Get system name
 * @link https://php.net/manual/ru/function.posix-uname.php
...
/**
 * Get process times
 * @link https://php.net/manual/ru/function.posix-times.php
 ...
 * @link https://php.net/manual/ru/function.posix-ctermid.php
 ...
 * @link https://php.net/manual/ru/function.posix-ttyname.php
 ...
 * @link https://php.net/manual/ru/function.posix-isatty.php
 ...
 * @link https://php.net/manual/ru/function.posix-getcwd.php
 ...
 * @link https://php.net/manual/ru/function.posix-mkfifo.php
 ...
 * @link https://php.net/manual/ru/function.posix-mknod.php
 * @param string $filename <p>
 * The file to create
 * </p>
 * @param int $flags <p>
 ...
 * @link https://php.net/manual/ru/function.posix-access.php
 * @param string $filename <p>
 ...
 * @link https://php.net/manual/ru/function.posix-getgrnam.php
 ...
 * @link https://php.net/manual/ru/function.posix-getgrgid.php
 * @param int $group_id <p>
 * The group id.
 * </p>
 * @return array|false The array elements returned are:
 ...
 * @link https://php.net/manual/ru/function.posix-getpwnam.php
 ...
 * @link https://php.net/manual/ru/function.posix-getpwuid.php
 * @param int $user_id <p>
 * The user identifier.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.posix-getrlimit.php
 ...
 * @link https://php.net/manual/ru/function.posix-get-last-error.php
 ...
 * @link https://php.net/manual/ru/function.posix-errno.php
 */
#[Pure(true)]
 ...
 * @link https://php.net/manual/ru/function.posix-strerror.php
 ...
 * @link https://php.net/manual/ru/function.posix-initgroups.php
 * @param string $username <p>
 ...
 * @link https://php.net/manual/ru/posix.constants.php
 */
define('POSIX_F_OK', 0);
 ...
 * @link https://php.net/manual/ru/posix.constants.setrlimit.php
 */
...
/**
 * The maximum value to which the process can be <a href="https://php.net/manual/ru/function.pcntl-setpriority.php"> reniced</a> to. The value that will be used will be 20 - limit, as resource limit values cannot be negative.
 * @link https://php.net/manual/ru/posix.constants.setrlimit.php
 */
