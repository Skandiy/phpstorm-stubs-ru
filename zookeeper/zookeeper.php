...
/**
 * Zookeeper class.
 * @link https://www.php.net/manual/ru/class.zookeeper.php
 */
class Zookeeper
{
    /* class constants */
     ...
     *
     * @link https://www.php.net/manual/ru/zookeeper.construct.php
     *
     ...
     * @param int      $recv_timeout
     *
     * @link https://www.php.net/manual/ru/zookeeper.connect.php
     *
     * @throws ZookeeperException
     ...
     *
     * @link https://www.php.net/manual/ru/zookeeper.close.php
     *
     * @throws ZookeeperException
     ...
     * @return string
     *
     * @link https://www.php.net/manual/ru/zookeeper.create.php
     *
     * @throws ZookeeperException
     ...
     * @return bool
     *
     * @link https://www.php.net/manual/ru/zookeeper.delete.php
     *
     * @throws ZookeeperException
     ...
     * @return bool
     *
     * @link https://www.php.net/manual/ru/zookeeper.set.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperNoNodeException when path does not exist
     */
     ...
     * @return string
     *
     * @link https://www.php.net/manual/ru/zookeeper.get.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperNoNodeException when path does not exist
     */
     ...
     * @return array|false
     *
     * @link https://www.php.net/manual/ru/zookeeper.getchildren.php
     *
     ...
     * @return bool
     *
     * @link https://www.php.net/manual/ru/zookeeper.exists.php
     *
     * @throws ZookeeperException
     */
     ...
     * @return array
     *
     * @link https://www.php.net/manual/ru/zookeeper.getacl.php
     *
     * @throws ZookeeperException when connection not in connected status
     */
    #[Pure]
     ...
     * @param array  $acls
     *
     * @link https://www.php.net/manual/ru/zookeeper.setacl.php
     *
     * @return bool
     *
     * @throws ZookeeperException when connection not in connected status
     ...
     * @return int
     *
     * @link https://www.php.net/manual/ru/zookeeper.getclientid.php
     *
     * @throws ZookeeperException
     ...
     * @return bool
     *
     * @link https://www.php.net/manual/ru/zookeeper.setwatcher.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperConnectionException when connection not in connected status
     */
     ...
     * @return int
     *
     * @link https://www.php.net/manual/ru/zookeeper.getstate.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperConnectionException when connection not in connected status
     */
     ...
     * @return int
     *
     * @link https://www.php.net/manual/ru/zookeeper.getrecvtimeout.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperConnectionException when connection not in connected status
     */
     ...
     *
     * @link https://www.php.net/manual/ru/zookeeper.addauth.php
     *
     * @return bool
     *
     * @throws ZookeeperException
     ...
     * @return bool
     *
     * @link https://www.php.net/manual/ru/zookeeper.isrecoverable.php
     *
     * @throws ZookeeperException
     * @throws ZookeeperConnectionException when connection not in connected status
     */
     ...
     * @param resource $file
     *
     * @link https://www.php.net/manual/ru/zookeeper.setlogstream.php
     *
     * @return bool
     */
     ...
     * @param int $level
     *
     * @link https://www.php.net/manual/ru/zookeeper.setdebuglevel.php
     *
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/ru/zookeeper.setdeterministicconnorder.php
     *
     * @return bool
     */
