 ...
 * @link https://php.net/manual/ru/function.pcntl-fork.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-waitpid.php
...
/**
 * Waits on or returns the status of a forked child
 * @link https://php.net/manual/ru/function.pcntl-wait.php
 * @param int &$status <p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-signal.php
 * @param int $signal <p>
 * The signal number.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-signal-dispatch.php
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
 ...
 * @link https://php.net/manual/ru/function.pcntl-wifexited.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-wifstopped.php
 * @param int $status <p>The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-wifsignaled.php
 * @param int $status <p>The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-wexitstatus.php
 * @param int $status <p>The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-wtermsig.php
 * @param int $status <p>The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-wstopsig.php
 * @param int $status <p>The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-exec.php
 * @param string $path <p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-alarm.php
 * @param int $seconds <p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-get-last-error.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-errno.php
 * @return int error code.
 * @since 5.3.4
 */
#[Pure(true)]
 ...
 * @link https://php.net/manual/ru/function.pcntl-strerror.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-getpriority.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-setpriority.php
 ...
 * @link https://php.net/manual/ru/function.pcntl-sigprocmask.php
 * @param int $mode <p>
...
/**
 * Waits for signals
 * @link https://php.net/manual/ru/function.pcntl-sigwaitinfo.php
 * @param array $signals <p>
 ...
 * @link https://php.net/manual/ru/function.pcntl-sigtimedwait.php
 * @param array $signals <p>
 * Array of signals to wait for.
 * </p>
 * @param array &$info [optional] <p>
 ...
 * @link https://www.php.net/manual/ru/function.pcntl-async-signals.php
 *
 ...
 * @link https://www.php.net/manual/ru/function.pcntl-signal-get-handler.php
 *
 * @param int $signal <p>
 * The signal number.
 * </p>
...
/**
 * @link https://php.net/manual/ru/pcntl.constants.php
 */
define('SIG_BLOCK', 0);
