 ...
 * https://www.php.net/manual/ru/book.xlswriter.php
 */
...
namespace Vtiful\Kernel;
    ...
    /**
     * Class Excel
     * @link https://www.php.net/manual/ru/class.vtiful-kernel-excel.php
     ...
     * Class Format
     *
     * @link https://www.php.net/manual/ru/class.vtiful-kernel-format.php
     * @package Vtiful\Kernel
     */
    class Format
    {
