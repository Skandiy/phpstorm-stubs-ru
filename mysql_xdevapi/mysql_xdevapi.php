 ...
 * @link https://secure.php.net/manual/ru/book.mysql-xdevapi.php
...
/**
 * @link https://secure.php.net/manual/ru/function.mysql-xdevapi-getsession.php
...
/**
 * @link https://www.php.net/manual/ru/function.mysql-xdevapi-expression.php
...
interface BaseResult
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-baseresult.getwarnings.php
     * @return array
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-baseresult.getwarningscount.php
     * @return int
     */
...
/**
 * Class Collection
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-collection.php
 * @package mysql_xdevapi
 */
class Collection
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.construct.php
     */
    public function __construct() {}

    /**
     * Add collection document
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.add.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.addorreplaceone.php
     * @param string $id
     * @param mixed $document
    ...
    /**
     * Get document count
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.count.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.createindex.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.dropindex.php
     * @param string $index_name
     * @return bool
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.existsindatabase.php
     * @return bool
     */
    public function existsInDatabase(): bool {}

    /**
     * @link https://secure.php.net/manual/ru/mysql-xdevapi-collection.find.php
    ...
    /**
     * Get collection name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.getname.php
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.getone.php
     * @param string $id
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.getschema.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.getsession.php
     * @return \mysql_xdevapi\Session
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.modify.php
     * @param string $search_condition
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.remove.php
     * @param string $search_condition
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collection.removeone.php
     * @param string $id
     * @return \mysql_xdevapi\Result
     */
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-collectionfind.php
 * @package mysql_xdevapi
 */
class CollectionFind implements \mysql_xdevapi\Executable, \mysql_xdevapi\CrudOperationBindable, \mysql_xdevapi\CrudOperationLimitable, \mysql_xdevapi\CrudOperationSortable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionfind.execute.php
     ...
     *
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionfind.lockexclusive.php
     *
     ...
     *
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionfind.lockshared.php
     *
     * @param int $lock_waiting_option
     * @return \mysql_xdevapi\CollectionFind
     */
...
class CollectionModify implements \mysql_xdevapi\Executable, \mysql_xdevapi\CrudOperationBindable, \mysql_xdevapi\CrudOperationLimitable, \mysql_xdevapi\CrudOperationSkippable, \mysql_xdevapi\CrudOperationSortable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.arrayappend.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.arrayinsert.php
     * @param string $collection_field
     * @param string $expression_or_literal
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.bind.php
     * @param array $placeholder_values
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.execute.php
     * @return \mysql_xdevapi\Result
     */
    public function execute(): Result {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.limit.php
     * @param int $rows
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.patch.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.replace.php
     * @param string $collection_field
     * @param string $expression_or_literal
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.set.php
     * @param string $collection_field
     * @param string $expression_or_literal
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.skip.php
     * @param int $position
     * @return \mysql_xdevapi\CollectionModify
     */
    ...
    /**
     * Sort the result set by the field selected in the sort_expr argument. The allowed orders are ASC (Ascending) or DESC (Descending). This operation is equivalent to the 'ORDER BY' SQL operation and it follows the same set of rules.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.sort.php
     * @param string $sort_expr
     * @return \mysql_xdevapi\CollectionModify
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.unset.php
     * @param array $fields
     * @return \mysql_xdevapi\CollectionModify
     */
...
class CollectionRemove implements \mysql_xdevapi\Executable, \mysql_xdevapi\CrudOperationBindable, \mysql_xdevapi\CrudOperationLimitable, \mysql_xdevapi\CrudOperationSortable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionremove.bind.php
     * @param array $placeholder_values
     * @return \mysql_xdevapi\CollectionRemove
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionremove.execute.php
     * @return \mysql_xdevapi\Result
     */
    public function execute(): Result {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionremove.limit.php
     * @param int $rows
     * @return \mysql_xdevapi\CollectionRemove
     */
    ...
    /**
     * Sort the result set by the field selected in the sort_expr argument. The allowed orders are ASC (Ascending) or DESC (Descending). This operation is equivalent to the 'ORDER BY' SQL operation and it follows the same set of rules.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-collectionremove.sort.php
     * @param string $sort_expr
     * @return \mysql_xdevapi\CollectionRemove
     */
...
class ColumnResult
{
    /**
     * Get character set
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getcharactersetname.php
     * @return string
     */
    ...
    /**
     * Get collation name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getcollationname.php
     * @return string
     */
    ...
    /**
     * Get column label
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getcolumnlabel.php
     * @return string
     */
    ...
    /**
     * Get column name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getcolumnname.php
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getfractionaldigits.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getlength.php
     * @return int
     */
    ...
    /**
     * Get schema name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.getschemaname.php
     * @return string
     */
    ...
    /**
     * Get table label
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.gettablelabel.php
     * @return string
     */
    ...
    /**
     * Get table name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.gettablename.php
     * @return string
     */
    ...
    /**
     * Get column type
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.gettype.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.isnumbersigned.php
     * @return int
     */
    ...
    /**
     * Check if padded
     * @link https://www.php.net/manual/ru/mysql-xdevapi-columnresult.ispadded.php
     * @return int
     */
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-crudoperationbindable.php
 * @package mysql_xdevapi
 */
interface CrudOperationBindable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-crudoperationbindable.bind.php
     * @param array $placeholder_values
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-crudoperationlimitable.php
 * @package mysql_xdevapi
 */
interface CrudOperationLimitable
{
    /**
     * Set result limit
     * @link https://www.php.net/manual/ru/mysql-xdevapi-crudoperationlimitable.limit.php
     * @param int $rows
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-crudoperationskippable.php
 * @package mysql_xdevapi
 */
interface CrudOperationSkippable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-crudoperationskippable.skip.php
     * @param int $skip
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-crudoperationsortable.php
 * @package mysql_xdevapi
 */
interface CrudOperationSortable
{
    /**
     * Sort results
     * @link https://www.php.net/manual/ru/mysql-xdevapi-crudoperationsortable.sort.php
     * @param string $sort_expr
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-databaseobject.php
 * @package mysql_xdevapi
 */
interface DatabaseObject
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-databaseobject.existsindatabase.php
     * @return bool
     */
    public function existsInDatabase(): bool;
    ...
    /**
     * Get object name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-databaseobject.getname.php
     * @return string
     */
    public function getName(): string;
    ...
    /**
     * Get session name
     * @link https://www.php.net/manual/ru/mysql-xdevapi-databaseobject.getsession.php
     * @return  \mysql_xdevapi\Session
     */
    public function getSession(): Session;
}
...
/**
 * Class DocResult
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-docresult.php
 * @package mysql_xdevapi
 */
class DocResult implements \mysql_xdevapi\BaseResult, \Traversable
{
    /**
     * Get all rows
     * @link https://www.php.net/manual/ru/mysql-xdevapi-docresult.fetchall.php
     * @return array
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-docresult.fetchone.php
     * @return array
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-docresult.getwarnings.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-docresult.getwarningscount.php
     * @return int
     */
    public function getWarningsCount(): int {}
}
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-exception.php
 * @package mysql_xdevapi
 */
interface Executable
{
    /**
     * Execute statement
     * @link https://www.php.net/manual/ru/class.mysql-xdevapi-executable.php
     * @return Result
     */
    public function execute(): Result;
}
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-executionstatus.php
 * @package mysql_xdevapi
 */
class ExecutionStatus
{
...
/**
 * Class Expression
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-expression.php
 * @package mysql_xdevapi
 */
class Expression
{
...
/**
 * Class Result
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-result.php
 * @package mysql_xdevapi
 */
class Result implements \mysql_xdevapi\BaseResult, \Traversable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-result.getautoincrementvalue.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-result.getgeneratedids.php
     * @return string[]
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-result.getwarnings.php
     * @return \mysql_xdevapi\Warning[]
     */
    public function getWarnings(): array {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-result.getwarningscount.php
     * @return int
     */
    public function getWarningsCount(): int {}
}
...
/**
 * Class RowResult
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-rowresult.php
 * @package mysql_xdevapi
 */
class RowResult implements \mysql_xdevapi\BaseResult, \Traversable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.fetchall.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.fetchone.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.getcolumncount.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.getcolumnnames.php
     * @return array
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.getcolumns.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.getwarnings.php
     * @return \mysql_xdevapi\Warning[]
     */
    public function getWarnings(): array {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-rowresult.getwarningscount.php
     * @return int
     */
    public function getWarningsCount(): int {}
}
...
/**
 * Class Schema
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-schema.php
 * @package mysql_xdevapi
 */
class Schema implements \mysql_xdevapi\DatabaseObject
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.createcollection.php
     * @param string $name
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.dropcollection.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.existsindatabase.php
     * @return bool
     */
    public function existsInDatabase(): bool {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.getcollection.php
     * @param string $name
     * @return \mysql_xdevapi\Collection
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.getcollectionastable.php
     * @param string $name
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.getcollections.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.getname.php
     * @return string
     */
    public function getName(): string {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.getsession.php
     * @return \mysql_xdevapi\Session
     */
    public function getSession(): Session {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.gettable.php
     * @param string $name
     * @return \mysql_xdevapi\Table
     */
    ...
    /**
     * Get schema tables
     * @link https://www.php.net/manual/ru/mysql-xdevapi-schema.gettables.php
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-schemaobject.php
 * @package mysql_xdevapi
 */
...
/**
 * Class Session
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-session.php
 * @package mysql_xdevapi
 */
class Session
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.close.php
     * @return bool
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.commit.php
     * @return object
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.createschema.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.dropschema.php
     * @param string $schema_name
     * @return bool
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.generateuuid.php
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.getschemas.php
     * @return \mysql_xdevapi\Schema[]
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.getserverversion.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.listclients.php
     * @return array
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.quotename.php
     * @param string $name
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.releasesavepoint.php
     * @param string $name
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.rollback.php
     */
    public function rollback(): void {}

    /**
     * Rollback transaction to savepoint
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.rollbackto.php
     * @param string $name
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.setsavepoint.php
     * @param string $name
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.sql.php
     * @param string $query
     * @return SqlStatement
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-session.starttransaction.php
     */
...
/**
 * Class SqlStatement
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-sqlstatement.php
 * @package mysql_xdevapi
 */
class SqlStatement
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatement.bind.php
     * @param string $param
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatement.execute.php
     * @return \mysql_xdevapi\Result
     */
    public function execute(): Result {}
    ...
    /**
     * Get next result
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatement.getnextresult.php
     * @return \mysql_xdevapi\Result
     */
    ...
    /**
     * Get result
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatement.getresult.php
     * @return \mysql_xdevapi\Result
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatement.hasmoreresults.php
     * @return bool
     */
 ...
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-sqlstatementresult.php
 * @package mysql_xdevapi
 */
class SqlStatementResult implements \mysql_xdevapi\BaseResult, \Traversable
{
    ...
    /**
     * Fetch all the rows from the result set.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.fetchall.php
     * @return array
     */
    public function fetchAll(): array {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.fetchone.php
     * @return array
     */
    public function fetchOne(): array {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getaffecteditemscount.php
     * @return int
     */
    ...
    /**
     * Get column count
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getcolumncount.php
     * @return int
     */
    public function getColumnsCount(): int {}
    ...
    /**
     * Get column names
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getcolumnnames.php
     * @return array
     */
    public function getColumnNames(): array {}
    ...
    /**
     * Get columns
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getcolumns.php
     * @return array
     */
    public function getColumns(): array {}
    ...
    /**
     * Get generated ids
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getgeneratedids.php
     * @return array
     */
    public function getGeneratedIds(): array {}
    ...
    /**
     * Get last insert id
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getlastinsertid.php
     * @return string
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getwarnings.php
     * @return \mysql_xdevapi\Warning[]
     */
    public function getWarnings(): array {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.getwarningcount.php
     * @return int
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.hasdata.php
     * @return bool
     */
    ...
    /**
     * Get next result
     * @link https://www.php.net/manual/ru/mysql-xdevapi-sqlstatementresult.nextresult.php
     * @return \mysql_xdevapi\Result
     */
...
/**
 * Class Statement
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-statement.php
 * @package mysql_xdevapi
 */
class Statement
{
    ...
    /**
     * Get next result
     * @link https://www.php.net/manual/ru/mysql-xdevapi-statement.getnextresult.php
     * @return \mysql_xdevapi\Result
     */
    public function getNextResult(): Result {}
    ...
    /**
     * Get result
     * @link https://www.php.net/manual/ru/mysql-xdevapi-statement.getresult.php
     * @return Result
     */
    public function getResult(): Result {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-statement.hasmoreresults.php
     * @return bool
     */
    public function hasMoreResults(): bool {}
}
...
/**
 * Class Table
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-table.php
 * @package mysql_xdevapi
 */
class Table implements \mysql_xdevapi\SchemaObject
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.count.php
     * @return int
     */
    public function count(): int {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.delete.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.existsindatabase.php
     * @return bool
     */
    public function existsInDatabase(): bool {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.getname.php
     * @return string
     */
    public function getName(): string {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.getschema.php
     * @return \mysql_xdevapi\Schema
     */
    public function getSchema(): Schema {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.getsession.php
     * @return \mysql_xdevapi\Session
     */
    public function getSession(): Session {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.insert.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.isview.php
     * @return bool
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.select.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-table.update.php
...
/**
 * Class TableDelete
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-tabledelete.php
 * @package mysql_xdevapi
 */
class TableDelete implements \mysql_xdevapi\Executable
{
    ...
    /**
     * Binds a value to a specific placeholder.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tabledelete.bind.php
     * @param array $placeholder_values
     * @return \mysql_xdevapi\TableDelete
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tabledelete.execute.php
     * @return \mysql_xdevapi\Result
     */
    public function execute(): Result {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tabledelete.limit.php
     * @param int $rows
     * @return \mysql_xdevapi\TableDelete
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tabledelete.orderby.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tabledelete.where.php
...
/**
 * Class TableInsert
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-tableinsert.php
 * @package mysql_xdevapi
 */
class TableInsert implements \mysql_xdevapi\Executable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableinsert.execute.php
     * @return \mysql_xdevapi\Result
     */
    public function execute(): Result {}
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableinsert.values.php
...
/**
 * Class TableSelect
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-tableselect.php
 * @package mysql_xdevapi
 */
class TableSelect implements \mysql_xdevapi\Executable
{
    /**
     * Binds a value to a specific placeholder.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.bind.php
     * @param array $placeholder_values
     * @return \mysql_xdevapi\TableSelect
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.execute.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.groupby.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.having.php
     * @param string $sort_expr
     * @return \mysql_xdevapi\TableSelect
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.limit.php
     * @param int $rows
     * @return \mysql_xdevapi\TableSelect
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.lockexclusive.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.lockshared.php
     * @param int|null $lock_waiting_option
     * @return \mysql_xdevapi\TableSelect
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.offset.php
     * @param int $position
     * @return \mysql_xdevapi\TableSelect
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.orderby.php
    ...
    /**
     * Sets the search condition to filter.
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableselect.where.php
     * @param string $where_expr
     * @return \mysql_xdevapi\TableSelect
     */
...
/**
 * Class TableUpdate
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-tableupdate.php
 * @package mysql_xdevapi
 */
class TableUpdate implements \mysql_xdevapi\Executable
{
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.bind.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.execute.php
     * @return \mysql_xdevapi\TableUpdate
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.limit.php
     * @param int $rows
     * @return \mysql_xdevapi\TableUpdate
     */
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.orderby.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.set.php
     ...
     * @link https://www.php.net/manual/ru/mysql-xdevapi-tableupdate.where.php
     * @param string $where_expr
     * @return \mysql_xdevapi\TableUpdate
     */
...
/**
 * Class Warning
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-warning.php
 * @package mysql_xdevapi
 */
class Warning
{
...
/**
 * Class XSession
 * @link https://www.php.net/manual/ru/class.mysql-xdevapi-xsession.php
 * @package mysql_xdevapi
 */
class XSession {}
