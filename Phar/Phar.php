 ...
 * @link https://php.net/manual/ru/class.pharexception.php
 */
 ...
 * phar archives.
 * @link https://php.net/manual/ru/class.phar.php
 */
class Phar extends RecursiveDirectoryIterator implements RecursiveIterator, SeekableIterator, Countable, ArrayAccess
{
     ...
     * @link https://php.net/manual/ru/phar.construct.php
     ...
     * @link https://php.net/manual/ru/phar.addemptydir.php
     ...
     * @link https://php.net/manual/ru/phar.addfile.php
     * @param string $filename <p>
     ...
     * (Unknown)<br/>
     * Add a file from the filesystem to the phar archive
     * @link https://php.net/manual/ru/phar.addfromstring.php
     ...
     * @link https://php.net/manual/ru/phar.buildfromdirectory.php
     * @param string $directory <p>
     ...
     * @link https://php.net/manual/ru/phar.buildfromiterator.php
     ...
     * @link https://php.net/manual/ru/phar.compressfiles.php
     ...
     * @link https://php.net/manual/ru/phar.decompressfiles.php
     ...
     * @link https://php.net/manual/ru/phar.compress.php
     * @param int $compression <p>
     * Compression must be one of Phar::GZ,
     * Phar::BZ2 to add compression, or Phar::NONE
     * to remove compression.
     ...
     * @link https://php.net/manual/ru/phar.decompress.php
     * @param string $extension [optional] <p>
     ...
     * @link https://php.net/manual/ru/phar.converttoexecutable.php
     ...
     * @link https://php.net/manual/ru/phar.converttodata.php
     * @param int $format [optional] <p>
     ...
     * @link https://php.net/manual/ru/phar.copy.php
     * @param string $to
     * @param string $from
     ...
     * @link https://php.net/manual/ru/phar.count.php
     ...
     * @link https://php.net/manual/ru/phar.delete.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/phar.delmetadata.php
     * @return bool returns <b>TRUE</b> on success, but it is better to check for thrown exception,
     * and assume success if none is thrown.
     */
     ...
     * @link https://php.net/manual/ru/phar.extractto.php
     * @param string $directory <p>
     * Path within an archive to the file to delete.
     * </p>
     ...
     * @link https://php.net/manual/ru/phar.getmetadata.php
     ...
     * @link https://php.net/manual/ru/phar.getmodified.php
     ...
     * @link https://php.net/manual/ru/phar.getsignature.php
     ...
     * @link https://php.net/manual/ru/phar.getstub.php
     ...
     * @link https://php.net/manual/ru/phar.getversion.php
     ...
     * @link https://php.net/manual/ru/phar.hasmetadata.php
     ...
     * @link https://php.net/manual/ru/phar.isbuffering.php
     ...
     * @link https://php.net/manual/ru/phar.iscompressed.php
     ...
     * @link https://php.net/manual/ru/phar.isfileformat.php
     * @param int $format <p>
     ...
     * @link https://php.net/manual/ru/phar.iswritable.php
     ...
     * @link https://php.net/manual/ru/phar.offsetexists.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/phar.offsetget.php
     * @param string $localName <p>
     * The filename (relative path) to look for in a Phar.
     * </p>
     ...
     * @link https://php.net/manual/ru/phar.offsetset.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/phar.offsetunset.php
     * @param string $localName <p>
     * The filename (relative path) to modify in a Phar.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/ru/phar.setalias.php
     ...
     * @link https://php.net/manual/ru/phar.setdefaultstub.php
     ...
     * @link https://php.net/manual/ru/phar.setmetadata.php
     ...
     * @link https://php.net/manual/ru/phar.setsignaturealgorithm.php
     * @param int $algo <p>
     * One of Phar::MD5,
     ...
     * @link https://php.net/manual/ru/phar.setstub.php
     * @param string $stub <p>
     ...
     * @link https://php.net/manual/ru/phar.startbuffering.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/phar.stopbuffering.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/phar.apiversion.php
     ...
     * @link https://php.net/manual/ru/phar.cancompress.php
     * @param int $compression [optional] <p>
     ...
     * @link https://php.net/manual/ru/phar.canwrite.php
     ...
     * @link https://php.net/manual/ru/phar.createdefaultstub.php
     ...
     * @link https://php.net/manual/ru/phar.getsupportedcompression.php
     ...
     * @link https://php.net/manual/ru/phar.getsupportedsignatures.php
     ...
     * @link https://php.net/manual/ru/phar.interceptfilefuncs.php
     * @return void
     */
     ...
     * @link https://php.net/manual/ru/phar.isvalidpharfilename.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/phar.loadphar.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/phar.mapphar.php
     * @param string|null $alias [optional] <p>
     ...
     * @link https://php.net/manual/ru/phar.running.php
     ...
     * @link https://php.net/manual/ru/phar.mount.php
     ...
     * @link https://php.net/manual/ru/phar.mungserver.php
     ...
     * @link https://php.net/manual/ru/phar.unlinkarchive.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/phar.webphar.php
 ...
 * @link https://php.net/manual/ru/class.phardata.php
 */
class PharData extends Phar
{
     ...
     * @link https://php.net/manual/ru/phardata.construct.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/phardata.offsetset.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/ru/phardata.offsetunset.php
     * @param string $localName <p>
 ...
 * @link https://php.net/manual/ru/class.pharfileinfo.php
 */
class PharFileInfo extends SplFileInfo
{
     ...
     * @link https://php.net/manual/ru/pharfileinfo.construct.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/pharfileinfo.chmod.php
     * @param int $perms <p>
     ...
     * @link https://php.net/manual/ru/pharfileinfo.compress.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.decompress.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/pharfileinfo.delmetadata.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.getcompressedsize.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.getcrc32.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.getmetadata.php
     * @param array $unserializeOptions [optional] if is set to anything other than the default,
     * the resulting metadata won't be cached and this won't return the value from the cache
     ...
     * @link https://php.net/manual/ru/pharfileinfo.getpharflags.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.hasmetadata.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.iscompressed.php
     * @param int $compression [optional] <p>
     ...
     * @link https://php.net/manual/ru/pharfileinfo.iscrcchecked.php
     ...
     * @link https://php.net/manual/ru/pharfileinfo.setmetadata.php
     * @param mixed $metadata <p>
