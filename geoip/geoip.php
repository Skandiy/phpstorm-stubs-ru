 ...
 * @link https://php.net/manual/ru/function.geoip-database-info.php
 ...
 * @link https://php.net/manual/ru/function.geoip-country-code-by-name.php
 ...
 * @link https://php.net/manual/ru/function.geoip-country-code3-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.geoip-country-name-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.geoip-continent-code-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.geoip-org-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://php.net/manual/ru/function.geoip-record-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://php.net/manual/ru/function.geoip-id-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://php.net/manual/ru/function.geoip-region-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://php.net/manual/ru/function.geoip-isp-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.geoip-db-avail.php
 ...
 * @link https://php.net/manual/ru/function.geoip-db-get-all-info.php
 ...
 * @link https://php.net/manual/ru/function.geoip-db-filename.php
 * @param int $database <p>
 * The database type as an integer. You can use the
 * various constants defined with
 * this extension (ie: GEOIP_*_EDITION).
 ...
 * @link https://php.net/manual/ru/function.geoip-region-name-by-code.php
 ...
 * @link https://php.net/manual/ru/function.geoip-time-zone-by-country-and-region.php
 * @param string $country_code <p>
 * The two-letter country code (see
 * <b>geoip_country_code_by_name</b>)
 * </p>
 ...
 * </p>
 * @link https://secure.php.net/manual/ru/function.geoip-asnum-by-name.php
 ...
 * - Corporate<br>
 * </p>
 * @link https://secure.php.net/manual/ru/function.geoip-netspeedcell-by-name.php
 * @param string $hostname The hostname or IP address
 *
 ...
 * </p>
 * @link https://secure.php.net/manual/ru/function.geoip-setup-custom-directory.php
