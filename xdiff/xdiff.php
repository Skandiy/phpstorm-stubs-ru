 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-bdiff-size.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-bdiff.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-bpatch.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-diff-binary.php
 * @param string $old_file Path to the first file. This file acts as "old" file.
 * @param string $new_file Path to the second file. This file acts as "new" file.
 * @param string $dest Path of the resulting patch file. Resulting file contains differences between
 * "old" and "new" files. It is in binary format and is human-unreadable.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-diff.php
 * @param string $old_file Path to the first file. This file acts as "old" file.
 * @param string $new_file Path to the second file. This file acts as "new" file.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-merge3.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-patch-binary.php
 * @param string $file The original file.
 * @param string $patch The binary patch file.
 * @param string $dest Path of the resulting file.
 * @return bool true on success or false on failure.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-patch.php
 * @param string $file The original file.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-file-rabdiff.php
 * @param string $old_file Path to the first file. This file acts as "old" file.
 * @param string $new_file Path to the second file. This file acts as "new" file.
...
/**
 * Read a size of file created by applying a binary diff
 * @link https://www.php.net/manual/ru/function.xdiff-string-bdiff-size.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-bdiff.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-bpatch.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-diff-binary.php
 * @param string $old_data First string with binary data. It acts as "old" data.
 * @param string $new_data Second string with binary data. It acts as "new" data.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-diff.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-merge3.php
 * @param string $old_data First string with data. It acts as "old" data.
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-patch-binary.php
 * @param string $str The original binary string.
 * @param string $patch The binary patch string.
 * @return string|false the patched string, or false on error.
 */
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-patch.php
 ...
 * @link https://www.php.net/manual/ru/function.xdiff-string-rabdiff.php
 * @param string $old_data First string with binary data. It acts as "old" data.
 * @param string $new_data Second string with binary data. It acts as "new" data.
