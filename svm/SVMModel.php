 ...
 * @since 7.0
 * @link https://www.php.net/manual/ru/class.svmmodel.php
 */
class SVMModel
{
    /* Methods */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.checkprobabilitymodel.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.construct.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.getlabels.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.getnrclass.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.getsvmtype.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.getsvrprobability.php
     */
     ...
     * @throws SVMException
     * @link https://www.php.net/manual/ru/svmmodel.load.php
     */
     ...
     * @link https://www.php.net/manual/ru/svmmodel.predict-probability.php
     */
     ...
     * @return float the predicted value. This will be a class label in the case of classification, a real value in the case of regression. Throws SVMException on error
     * @throws SVMException Throws SVMException on error
     * @link https://www.php.net/manual/ru/svmmodel.predict.php
     */
     ...
     * @throws SVMException Throws SVMException on error
     * @link https://www.php.net/manual/ru/svmmodel.save.php
     */
