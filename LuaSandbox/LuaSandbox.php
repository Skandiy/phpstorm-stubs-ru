 ...
 *
 * @link https://www.php.net/manual/ru/book.luasandbox.php
 * @package luasandbox
 * @version 3.0.3
 */
 ...
 *
 * @link https://www.php.net/manual/ru/class.luasandbox.php
...
class LuaSandbox
{
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.callFunction.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.disableProfiler.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.enableprofiler.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.getcpuusage.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.getmemoryusage.php
     * @return int
     * @since luasandbox >= 1.0.0
     * @see LuaSandbox::getMemoryUsage()
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.getpeakmemoryusage.php
     ...
     * elapsed wall-clock time, not CPU time.</p>
     *
     * @link https://www.php.net/manual/ru/luasandbox.getprofilerfunctionreport.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.getversioninfo.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.loadbinary.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.loadString.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.pauseusagetimer.php
     ...
     * see <code>LuaSandboxFunction::call()</code>.</p>
     *
     * @link https://www.php.net/manual/ru/luasandbox.registerlibrary.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.setcpulimit.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.setmemorylimit.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandbox.unpauseusagetimer.php
     * @since luasandbox >= 1.0.0
     * @see LuaSandbox::setCPULimit()
     * @see LuaSandbox::unpauseUsageTimer()
     */
     ...
     * see <code>LuaSandboxFunction::call()</code>.</p>
     *
     * @link https://www.php.net/manual/ru/luasandbox.wrapPhpFunction.php
...
class LuaSandboxFunction
{
     ...
     *
     * @link https://www.php.net/manual/ru/luasandboxfunction.call.php
     ...
     *
     * @link https://www.php.net/manual/ru/luasandboxfunction.dump.php
