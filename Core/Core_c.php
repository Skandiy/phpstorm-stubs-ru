 ...
 * @link https://php.net/manual/ru/reserved.classes.php
 */
class stdClass {}
 ...
 *
 * @link https://php.net/manual/ru/class.traversable.php
 * @template TKey
 * @template TValue
 *
 ...
 * @link https://php.net/manual/ru/class.iteratoraggregate.php
 * @template TKey
 * @template TValue
...
interface IteratorAggregate extends Traversable
{
     ...
     * @link https://php.net/manual/ru/iteratoraggregate.getiterator.php
 ...
 * @link https://php.net/manual/ru/class.iterator.php
 * @template TKey
 * @template TValue
 * @template-implements Traversable<TKey, TValue>
 */
 ...
 * @link https://php.net/manual/ru/class.arrayaccess.php
 * @template TKey
 * @template TValue
 */
 ...
 * @link https://php.net/manual/ru/class.serializable.php
 */
 ...
 * @link https://php.net/manual/ru/class.throwable.php
 * @since 7.0
 */
interface Throwable extends Stringable
{
    /**
     * Gets the message
     * @link https://php.net/manual/ru/throwable.getmessage.php
     * @return string
     * @since 7.0
     */
     ...
     * @link https://php.net/manual/ru/throwable.getcode.php
     * @return int <p>
     ...
     * @link https://php.net/manual/ru/throwable.getfile.php
     ...
     * @link https://php.net/manual/ru/throwable.getline.php
     ...
     * @link https://php.net/manual/ru/throwable.gettrace.php
     * @return array <p>
     ...
     * @link https://php.net/manual/ru/throwable.gettraceasstring.php
     ...
     * @link https://php.net/manual/ru/throwable.getprevious.php
     ...
     * @link https://php.net/manual/ru/throwable.tostring.php
 ...
 * all Exceptions.
 * @link https://php.net/manual/ru/class.exception.php
 */
class Exception implements Throwable
{
     ...
     * @link https://php.net/manual/ru/exception.getmessage.php
    ...
    /**
     * Gets the Exception code
     * @link https://php.net/manual/ru/exception.getcode.php
    ...
    /**
     * Gets the file in which the exception occurred
     * @link https://php.net/manual/ru/exception.getfile.php
     ...
     * @link https://php.net/manual/ru/exception.getline.php
    ...
    /**
     * Gets the stack trace
     * @link https://php.net/manual/ru/exception.gettrace.php
     ...
     * @link https://php.net/manual/ru/exception.getprevious.php
     * @return null|Throwable Returns the previous {@see Throwable} if available, or <b>NULL</b> otherwise.
     * or null otherwise.
     */
    #[Pure]
    ...
    /**
     * Gets the stack trace as a string
     * @link https://php.net/manual/ru/exception.gettraceasstring.php
 ...
 * @link https://php.net/manual/ru/class.error.php
 * @since 7.0
 */
class Error implements Throwable
{
     ...
     * @link https://php.net/manual/ru/error.construct.php
     ...
     * @return void
     * @link https://php.net/manual/ru/error.clone.php
     */
 ...
 * @link https://php.net/manual/ru/class.typeerror.php
 * @since 7.0
 */
 ...
 * @link https://php.net/manual/ru/class.parseerror.php
 * @since 7.0
 */
 ...
 * @link https://php.net/manual/ru/class.arithmeticerror.php
 * @since 7.0
 */
...
/**
 * Class CompileError
 * @link https://secure.php.net/manual/ru/class.compileerror.php
 * @since 7.3
 */
 ...
 * @link https://php.net/manual/ru/class.divisionbyzeroerror.php
 * @since 7.0
 */
...
/**
 * An Error Exception.
 * @link https://php.net/manual/ru/class.errorexception.php
 */
class ErrorException extends Exception
{
     ...
     * @link https://php.net/manual/ru/errorexception.construct.php
     * @param string $message [optional] The Exception message to throw.
     * @param int $code [optional] The Exception code.
     ...
     * @link https://php.net/manual/ru/errorexception.getseverity.php
 ...
 * @link https://secure.php.net/manual/ru/class.closure.php
 */
final class Closure
{
    /**
     ...
     * @link https://secure.php.net/manual/ru/closure.construct.php
     */
     ...
     * @link https://secure.php.net/manual/ru/closure.bindto.php
     ...
     * @link https://secure.php.net/manual/ru/closure.bind.php
     ...
     * @link https://php.net/manual/ru/closure.call.php
 ...
 * <b>count</b> function.
 * @link https://php.net/manual/ru/class.countable.php
 */
interface Countable
{
    /**
 ...
 * @link https://www.php.net/manual/ru/class.weakreference.php
 * @since 7.4
 */
final class WeakReference
{
     ...
     * @link https://www.php.net/manual/ru/weakreference.create.php
     ...
     * @link https://www.php.net/manual/ru/weakreference.get.php
     * @return object|null
     * @since 7.4
     */
