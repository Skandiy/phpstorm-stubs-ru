...
class Lexer
{
     ...
     *
     * @link https://php.net/manual/ru/parle-lexer.advance.php
     * @return void
     */
     ...
     *
     * @see Lexer::push()
     * @link https://php.net/manual/ru/parle-lexer.build.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-lexer.callout.php
     ...
     *
     * @link https://php.net/manual/ru/parle-lexer.consume.php
     ...
     *
     * @link https://php.net/manual/ru/parle-lexer.dump.php
     * @return void
     */
     ...
     *
     * @see https://php.net/manual/ru/parle-lexer.insertmacro.php
