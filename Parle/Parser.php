...
class Parser
{
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.advance.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.build.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.consume.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.dump.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.errorinfo.php
     * @return ErrorInfo
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.left.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.nonassoc.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.precedence.php
     * @param string $token
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.push.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.reset.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.right.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.sigil.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.token.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.tokenid.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.trace.php
     ...
     *
     * @link https://php.net/manual/ru/parle-parser.validate.php
