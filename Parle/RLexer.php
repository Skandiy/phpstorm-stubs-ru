...
class RLexer
{
     ...
     *
     * @link https://php.net/manual/ru/parle-rlexer.advance.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rlexer.build.php
     * @see RLexer::push()
     * @return void
     */
     ...
     *
     * @see https://php.net/manual/ru/parle-rlexer.callout.php
     ...
     *
     * @see https://php.net/manual/ru/parle-rlexer.consume.php
     ...
     *
     * @see https://php.net/manual/ru/parle-rlexer.dump.php
     * @return void
     */
     ...
     * @see RParser::tokenId()
     * @return void
     * @link https://php.net/manual/ru/parle-rlexer.push.php
     */
     ...
     *
     * @see RLexer::push()
     * @link https://php.net/manual/ru/parle-rlexer.pushstate.php
