...
class RParser
{
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.advance.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.build.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.consume.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.dump.php
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.errorinfo.php
     * @return ErrorInfo
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.left.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.nonassoc.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.precedence.php
     * @param string $token
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.push.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.reset.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.right.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.sigil.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.token.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.tokenid.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.trace.php
     ...
     *
     * @link https://php.net/manual/ru/parle-rparser.validate.php
