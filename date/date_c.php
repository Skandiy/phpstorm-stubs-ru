...
interface DateTimeInterface
{
     ...
     * @link https://secure.php.net/manual/ru/datetime.diff.php
     ...
     * @return DateInterval
     * The https://secure.php.net/manual/ru/class.dateinterval.php DateInterval} object representing the
     ...
     * @link https://secure.php.net/manual/ru/datetime.format.php
     * @param string $format <p>
     * Format accepted by  {@link https://secure.php.net/manual/ru/function.date.php date()}.
     * </p>
     * @return string
     ...
     * @link https://secure.php.net/manual/ru/datetime.gettimezone.php
     * @return DateTimeZone|false
     * Returns a {@link https://secure.php.net/manual/ru/class.datetimezone.php DateTimeZone} object on success
     ...
     * @link https://secure.php.net/manual/ru/datetime.wakeup.php
...
class DateTimeImmutable implements DateTimeInterface
{
    ...
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * @link https://secure.php.net/manual/ru/datetimeimmutable.construct.php
     * @param string $datetime [optional]
     * <p>A date/time string. Valid formats are explained in {@link https://secure.php.net/manual/ru/datetime.formats.php Date and Time Formats}.</p>
     ...
     * A {@link https://secure.php.net/manual/ru/class.datetimezone.php DateTimeZone} object representing the timezone of <em>$datetime</em>.
     * </p>
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.createfromformat.php
     * @param string $format
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.createfrommutable.php
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.getlasterrors.php
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.modify.php
     * @param string $modifier <p>A date/time string. Valid formats are explained in
     * {@link https://secure.php.net/manual/ru/datetime.formats.php Date and Time Formats}.</p>
     * @return static|false Returns the newly created object or false on failure.
     * Returns the {@link https://secure.php.net/manual/ru/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    #[Pure]
    #[TentativeType]
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.set-state.php
     * @param array $array <p>Initialization array.</p>
     * @return DateTimeImmutable
     * Returns a new instance of a {@link https://secure.php.net/manual/ru/class.datetimeimmutable.php DateTimeImmutable} object.
     */
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the date
     * @link https://secure.php.net/manual/ru/datetimeimmutable.setdate.php
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the ISO date
     * @link https://php.net/manual/ru/class.datetimeimmutable.php
     * @param int $year <p>Year of the date.</p>
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the time
     * @link https://secure.php.net/manual/ru/datetimeimmutable.settime.php
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.settimestamp.php
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the time zone
     * @link https://secure.php.net/manual/ru/datetimeimmutable.settimezone.php
     * @param DateTimeZone $timezone <p>
     * A {@link https://secure.php.net/manual/ru/class.datetimezone.php DateTimeZone} object representing the
     * desired time zone.
     * </p>
     * @return static
     * Returns the {@link https://secure.php.net/manual/ru/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     ...
     * @link https://secure.php.net/manual/ru/datetimeimmutable.sub.php
     * @param DateInterval $interval <p>
     * A {@link https://secure.php.net/manual/ru/class.dateinterval.php DateInterval} object
     * </p>
     * @return static
     * Returns the {@link https://secure.php.net/manual/ru/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
     ...
     * @return DateInterval
     * The {@link https://secure.php.net/manual/ru/class.dateinterval.php DateInterval} object representing the
 ...
 * @link https://php.net/manual/ru/class.datetime.php
 */
class DateTime implements DateTimeInterface
{
    ...
    /**
     * (PHP 5 &gt;=5.2.0)<br/>
     * @link https://php.net/manual/ru/datetime.construct.php
     * @param string $datetime [optional]
     * <p>A date/time string. Valid formats are explained in {@link https://php.net/manual/ru/datetime.formats.php Date and Time Formats}.</p>
     * <p>
     * Enter <b>now</b> here to obtain the current time when using
     * the <em>$timezone</em> parameter.
     * </p>
     * @param null|DateTimeZone $timezone [optional] <p>
     * A {@link https://php.net/manual/ru/class.datetimezone.php DateTimeZone} object representing the
    ...
    /**
     * @return void
     * @link https://php.net/manual/ru/datetime.wakeup.php
     */
    #[TentativeType]
    public function __wakeup(): void {}
     ...
     * @param string $format
     * @return string
     * @link https://php.net/manual/ru/datetime.format.php
     */
    #[TentativeType]
    public function format(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $format): string {}
     ...
     * @param string $modifier A date/time string. Valid formats are explained in <a href="https://secure.php.net/manual/ru/datetime.formats.php">Date and Time Formats</a>.
     * @return static|false Returns the DateTime object for method chaining or FALSE on failure.
     * @link https://php.net/manual/ru/datetime.modify.php
     */
    #[TentativeType]
     ...
     * @param DateInterval $interval
     * @return static
     * @link https://php.net/manual/ru/datetime.add.php
     */
    #[TentativeType]
     ...
     * @param DateInterval $interval
     * @return static
     * @link https://php.net/manual/ru/datetime.sub.php
     */
    #[TentativeType]
     ...
     * @return DateTimeZone|false
     * @link https://php.net/manual/ru/datetime.gettimezone.php
     */
    #[TentativeType]
    public function getTimezone(): DateTimeZone|false {}
     ...
     * @return static
     * @link https://php.net/manual/ru/datetime.settimezone.php
     */
    #[TentativeType]
     ...
     * Returns the timezone offset
     * @return int
     * @link https://php.net/manual/ru/datetime.getoffset.php
     */
    #[TentativeType]
    public function getOffset(): int {}
     ...
     * @return static
     * @link https://php.net/manual/ru/datetime.settime.php
     */
    #[TentativeType]
    public function setTime(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $hour,
     ...
     * @param int $day
     * @return static
     * @link https://php.net/manual/ru/datetime.setdate.php
     */
    #[TentativeType]
    public function setDate(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $year,
     ...
     * @param int $dayOfWeek
     * @return static
     * @link https://php.net/manual/ru/datetime.setisodate.php
     */
    #[TentativeType]
    public function setISODate(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $year,
     ...
     * @param int $timestamp
     * @return static
     * @link https://php.net/manual/ru/datetime.settimestamp.php
     */
    #[TentativeType]
     ...
     * Gets the Unix timestamp.
     * @return int
     * @link https://php.net/manual/ru/datetime.gettimestamp.php
     */
    #[TentativeType]
    public function getTimestamp(): int {}
     ...
     * @link https://php.net/manual/ru/datetime.diff.php
     */
    #[TentativeType]
    public function diff(
        #[LanguageLevelTypeAware(['8.0' => 'DateTimeInterface'], default: '')] $targetObject,
     ...
     * @link https://php.net/manual/ru/datetime.createfromformat.php
     */
    #[TentativeType]
    public static function createFromFormat(
        #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $format,
     ...
     * @return array|false
     * @link https://php.net/manual/ru/datetime.getlasterrors.php
     */
    #[ArrayShape(["warning_count" => "int", "warnings" => "string[]", "error_count" => "int", "errors" => "string[]"])]
    #[TentativeType]
    public static function getLastErrors(): array|false {}
    ...
    /**
     * The __set_state handler
     * @link https://php.net/manual/ru/datetime.set-state.php
     * @param array $array <p>Initialization array.</p>
 ...
 * @link https://php.net/manual/ru/class.datetimezone.php
 */
class DateTimeZone
{
     ...
     * @link https://php.net/manual/ru/datetimezone.construct.php
     */
     ...
     * @return string
     * @link https://php.net/manual/ru/datetimezone.getname.php
     */
    #[TentativeType]
     ...
     * @return array|false
     * @link https://php.net/manual/ru/datetimezone.getlocation.php
     */
    #[TentativeType]
     ...
     * @return int
     * @link https://php.net/manual/ru/datetimezone.getoffset.php
     */
    #[TentativeType]
     ...
     * @return array|false
     * @link https://php.net/manual/ru/datetimezone.gettransitions.php
     */
    #[TentativeType]
     ...
     * @return array
     * @link https://php.net/manual/ru/datetimezone.listabbreviations.php
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/datetimezone.listidentifiers.php
     */
 ...
 * @link https://php.net/manual/ru/class.dateinterval.php
 */
class DateInterval
{
    /**
     ...
     * @link https://php.net/manual/ru/dateinterval.construct.php
     */
     ...
     * @param string $format
     * @return string
     * @link https://php.net/manual/ru/dateinterval.format.php
     */
    #[TentativeType]
    public function format(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $format): string {}
     ...
     * @param string $datetime
     * @return DateInterval|false Returns a new {@link https://www.php.net/manual/ru/class.dateinterval.php DateInterval}
     * instance on success, or <b>FALSE</b> on failure.
     * @link https://php.net/manual/ru/dateinterval.createfromdatestring.php
     */
    #[TentativeType]
 ...
 * @link https://php.net/manual/ru/class.dateperiod.php
 */
class DatePeriod implements IteratorAggregate
{
     ...
     * @link https://php.net/manual/ru/dateperiod.construct.php
     */
     ...
     * Gets the interval
     * @return DateInterval
     * @link https://php.net/manual/ru/dateperiod.getdateinterval.php
     * @since 5.6.5
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/dateperiod.getenddate.php
     * @since 5.6.5
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/dateperiod.getstartdate.php
     * @since 5.6.5
     */
    #[TentativeType]
     ...
     * @return int|null
     * @link https://php.net/manual/ru/dateperiod.getrecurrences.php
     * @since 7.2.17
     */
    #[TentativeType]
