...
/**
 * @link https://php.net/manual/ru/ref.sqlite.php
 */
class SQLiteDatabase
{
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/ru/function.sqlite-open.php
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/ru/function.sqlite-query.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     * Data inside the query should be {@link https://php.net/manual/ru/function.sqlite-escape-string.php properly escaped}.
     * </p>
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/ru/function.sqlite-exec.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * {@link https://php.net/manual/ru/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration
     * option.</p>
     */
     ...
     * @link https://php.net/manual/ru/function.sqlite-array-query.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/ru/function.sqlite-single-query.php
     * @param string $query
     ...
     * @link https://php.net/manual/ru/function.sqlite-unbuffered-query.php
     * @param string $query  <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/ru/function.sqlite-last-insert-rowid.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-changes.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-create-aggregate.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-create-function.php
     * @param string $function_name <p>The name of the function used in SQL statements.</p>
     ...
     * {@link https://php.net/manual/ru/language.types.intro.php scalar type}).
     * </p></blockquote>
     ...
     * @link https://php.net/manual/ru/function.sqlite-busy-timeout.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-last-error.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-fetch-column-types.php
...
final class SQLiteResult implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/ru/function.sqlite-fetch-array.php
     * @param int $result_type [optional]
     * <p>
     ...
     * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
     * it applied to the data if it was encoded using the
     * {@link https://php.net/manual/ru/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case}. You should normally leave this
     * value at its default, unless you are interoperating with databases created by
     * other sqlite capable applications.</p>
     * @return array
     * <p>
     ...
     * @link https://php.net/manual/ru/function.sqlite-fetch-object.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-fetch-single.php
     * @param bool $decode_binary [optional]
     ...
     * (PHP 5 &lt; 5.4.0)
     * Fetches the next row from a result set as an object
     * @link https://www.php.net/manual/ru/function.sqlite-fetch-all.php
     * @param int $result_type [optional] <p>
     ...
     * @link https://php.net/manual/ru/function.sqlite-column.php
     * @param $index_or_name
     ...
     * @link https://php.net/manual/ru/function.sqlite-num-fields.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-field-name.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-current.php
     * @param int $result_type [optional] <p>The optional <i>result_type</i>
     * parameter accepts a constant and determines how the returned array will be
     ...
     * @link https://php.net/manual/ru/function.sqlite-next.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-prev.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-has-prev.php
     * @return bool <p>
     ...
     * @link https://php.net/manual/ru/function.sqlite-num-rows.php
     ...
     * @link https://php.net/manual/ru/function.sqlite-seek.php
     * @param $row
     * <p>
...
final class SQLiteUnbuffered
{
    ...
    /**
     * @link https://www.php.net/manual/ru/function.sqlite-fetch-object.php
     * @param string $class_name [optional]
     * @param array $ctor_params [optional]
     * @param bool $decode_binary [optional]
     */
...
final class SQLiteException extends RuntimeException
{
    ...
    /**
     * Clone the exception
     * @link https://php.net/manual/ru/exception.clone.php
     * @return void
     * @since 5.1.0
     */
     ...
     * @link https://php.net/manual/ru/exception.construct.php
     ...
     * @link https://php.net/manual/ru/exception.tostring.php
 ...
 * @link https://php.net/manual/ru/function.sqlite-popen.php
 * @param string $filename <p>
 * The filename of the SQLite database. If the file does not exist, SQLite
 * will attempt to create it. PHP must have write permissions to the file
 * if data is inserted, the database schema is modified or to create the
 ...
 * @link https://php.net/manual/ru/function.sqlite-close.php
 ...
 * <b>SQLITE_ASSOC</b> and <b>SQLITE_BOTH</b> will be
 * case-folded according to the value of the
 * {@link php.net/ru/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration
 * option.</p>
 */
 ...
 * @link https://php.net/manual/ru/function.sqlite-fetch-string.php
 * @param resource $result <p>The SQLite result resource. This parameter is not required when using the object-oriented method.</p>
 * @param bool $decode_binary [optional] <p>When the <b>decode_binary</b>
 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
 * it applied to the data if it was encoded using the
 ...
 * @link https://php.net/manual/ru/function.sqlite-fetch-all.php
 * @param int $result_type [optional]
 * @param bool $decode_binary [optional]
 ...
 * {@link https://php.net/manual/ru/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration option.</p>
 */
 ...
 * @link https://php.net/manual/ru/function.sqlite-libversion.php
 ...
 * @link https://php.net/manual/ru/function.sqlite-libencoding.php
 ...
 * @link https://php.net/manual/ru/function.sqlite-rewind.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-valid.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-has-more.php
 * @param resource $result <p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-escape-string.php
 * @param string $item <p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-error-string.php
 ...
 * @link https://php.net/manual/ru/function.sqlite-factory.php
 * @param string $filename <p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-udf-encode-binary.php
 * @param string $data <p>
 ...
 * @link https://php.net/manual/ru/function.sqlite-udf-decode-binary.php
 * @param string $data <p>
 ...
 * @link https://php.net/manual/ru/sqlite.constants.php
 */
