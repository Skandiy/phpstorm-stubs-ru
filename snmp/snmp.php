 ...
 * @link https://php.net/manual/ru/class.snmp.php
 */
class SNMP
{
    /**
     * @var int Maximum OID per GET/SET/GETBULK request
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.max-oids
     */
    public $max_oids;
     ...
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.quick-print
     */
    public $quick_print;
     ...
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.enum-print
     */
    public $enum_print;
     ...
     * </dl>
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.oid-output-format
     */
     ...
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.oid-increasing-check
     */
     ...
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.exceptions-enabled
     */
     ...
     * @link https://secure.php.net/manual/ru/class.snmp.php#snmp.props.info
     */
    public $info;
     ...
     * @link https://php.net/manual/ru/snmp.construct.php
    ...
    /**
     * Close SNMP session
     * @link https://php.net/manual/ru/snmp.close.php
     ...
     * @link https://php.net/manual/ru/snmp.setsecurity.php
     ...
     * @link https://php.net/manual/ru/snmp.get.php
     ...
     * @link https://php.net/manual/ru/snmp.getnext.php
     ...
     * @link https://php.net/manual/ru/snmp.walk.php
     ...
     * @link https://php.net/manual/ru/snmp.set.php
    ...
    /**
     * Get last error code
     * @link https://php.net/manual/ru/snmp.geterrno.php
     ...
     * @link https://php.net/manual/ru/snmp.geterror.php
 ...
 * @link https://php.net/manual/ru/class.snmpexception.php
 */
...
/**
 * Fetch an SNMP object
 * @link https://php.net/manual/ru/function.snmpget.php
 ...
 * @link https://php.net/manual/ru/function.snmpgetnext.php
 ...
 * @link https://php.net/manual/ru/function.snmpwalk.php
 * @param string $hostname <p>
 ...
 * @link https://php.net/manual/ru/function.snmprealwalk.php
 * @param string $host <p>The hostname of the SNMP agent (server).</p>
 * @param string $community <p>The read community.</p>
 * @param string $object_id <p>The SNMP object id which precedes the wanted one.</p>
 * @param int $timeout [optional] <p>The number of microseconds until the first timeout.</p>
 ...
 * @link https://php.net/manual/ru/function.snmpwalkoid.php
 * @param string $hostname <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link https://php.net/manual/ru/function.snmpset.php
 * @param string $host <p>
 ...
 * @link https://php.net/manual/ru/function.snmp-get-quick-print.php
 ...
 * @link https://php.net/manual/ru/function.snmp-set-quick-print.php
 ...
 * @link https://php.net/manual/ru/function.snmp-set-enum-print.php
 ...
 * @link https://php.net/manual/ru/function.snmp-set-oid-output-format.php
...
/**
 * Set the oid output format
 * @link https://php.net/manual/ru/function.snmp-set-oid-numeric-print.php
...
/**
 * Fetch an SNMP object
 * @link https://php.net/manual/ru/function.snmp2-get.php
 * @param string $host <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link https://php.net/manual/ru/function.snmp2-getnext.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link https://php.net/manual/ru/function.snmp2-walk.php
 * @param string $host <p>
 * The SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link https://php.net/manual/ru/function.snmp2-real-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link https://php.net/manual/ru/function.snmp2-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch an SNMP object
 * @link https://php.net/manual/ru/function.snmp3-get.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link https://php.net/manual/ru/function.snmp3-getnext.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link https://php.net/manual/ru/function.snmp3-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link https://php.net/manual/ru/function.snmp3-real-walk.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Set the value of an SNMP object
 * @link https://php.net/manual/ru/function.snmp3-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
 ...
 * @link https://php.net/manual/ru/function.snmp-set-valueretrieval.php
 ...
 * @link https://php.net/manual/ru/function.snmp-get-valueretrieval.php
 ...
 * @link https://php.net/manual/ru/function.snmp-read-mib.php
...
/**
 * As of 5.4
 * @link https://php.net/manual/ru/snmp.constants.php
 */
