...
/**
 * Frees a private key
 * @link https://php.net/manual/ru/function.openssl-pkey-free.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkey-new.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkey-export.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkey-export-to-file.php
 * @param OpenSSLAsymmetricKey|OpenSSLCertificate|array|string $key
...
/**
 * Get a private key
 * @link https://php.net/manual/ru/function.openssl-pkey-get-private.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkey-get-public.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkey-get-details.php
 * @param OpenSSLAsymmetricKey|resource $key <p>
 * Resource holding the key.
 * </p>
...
/**
 * Free key resource
 * @link https://php.net/manual/ru/function.openssl-free-key.php
 ...
 * @link https://php.net/manual/ru/function.openssl-get-privatekey.php
 * @param OpenSSLAsymmetricKey|OpenSSLCertificate|array|string $private_key
 * <p>
 * <b><em>key</em></b> can be one of the following:
 * <ol>
 ...
 * @link https://php.net/manual/ru/function.openssl-get-publickey.php
 ...
 * @link https://php.net/manual/ru/function.openssl-spki-new.php
 * @param OpenSSLAsymmetricKey|resource $private_key <p>
 * <b>privkey</b> should be set to a private key that was
 * previously generated by {@link https://php.net/ru/manual/function.openssl-pkey-new.php openssl_pkey_new()} (or
 ...
 * @link https://php.net/manual/ru/function.openssl-spki-verify.php
 ...
 * @link https://php.net/manual/ru/function.openssl-spki-export-challenge.php
 * @param string $spki <p>Expects a valid signed public key and challenge</p>
 ...
 * @link https://php.net/manual/ru/function.openssl-spki-export.php
 * @param string $spki <p>Expects a valid signed public key and challenge</p>
 ...
 * it
 * @link https://php.net/manual/ru/function.openssl-x509-read.php
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-free.php
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-parse.php
 * @param OpenSSLCertificate|string|resource $certificate
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-checkpurpose.php
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-check-private-key.php
 * @param OpenSSLCertificate|string|resource $certificate <p>
 * The certificate.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-export.php
 * @param OpenSSLCertificate|string|resource $certificate
 ...
 * @link https://php.net/manual/ru/function.openssl-x509-export-to-file.php
 * @param OpenSSLCertificate|string|resource $certificate
 * @param string $output_filename <p>
 * Path to the output file.
 * </p>
 ...
 * @link https://www.php.net/manual/ru/function.openssl-x509-verify.php
 * @param OpenSSLCertificate|string|resource $certificate
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs12-export.php
 * @param OpenSSLCertificate|string|resource $certificate
 * @param string &$output <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs12-export-to-file.php
 * @param OpenSSLCertificate|string|resource $certificate
 * @param string $output_filename <p>
 * Path to the output file.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs12-read.php
 * @param string $pkcs12
...
/**
 * Generates a CSR
 * @link https://php.net/manual/ru/function.openssl-csr-new.php
 ...
 * @link https://php.net/manual/ru/function.openssl-csr-export.php
 ...
 * @link https://php.net/manual/ru/function.openssl-csr-export-to-file.php
 * @param OpenSSLCertificateSigningRequest|string|resource $csr
 * @param string $output_filename <p>
 * Path to the output file.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.openssl-csr-sign.php
 ...
 * @link https://php.net/manual/ru/function.openssl-csr-get-subject.php
 * @param OpenSSLCertificateSigningRequest|string|resource $csr
 ...
 * @link https://php.net/manual/ru/function.openssl-csr-get-public-key.php
 * @param OpenSSLCertificateSigningRequest|string|resource $csr
 * @param bool $short_names [optional]
...
/**
 * Computes a digest
 * @link https://php.net/manual/ru/function.openssl-digest.php
 * @param string $data <p>
 * The data.
 * </p>
...
/**
 * Encrypts data
 * @link https://php.net/manual/ru/function.openssl-encrypt.php
 * @param string $data <p>
 * The data.
 * </p>
...
/**
 * Decrypts data
 * @link https://php.net/manual/ru/function.openssl-decrypt.php
 * @param string $data <p>
 * The data.
 * </p>
 * @param string $cipher_algo <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-cipher-iv-length.php
 * @param string $cipher_algo <p>
 * The method.
 * </p>
...
/**
 * Generate signature
 * @link https://php.net/manual/ru/function.openssl-sign.php
 * @param string $data
...
/**
 * Verify signature
 * @link https://php.net/manual/ru/function.openssl-verify.php
 * @param string $data
...
/**
 * Seal (encrypt) data
 * @link https://php.net/manual/ru/function.openssl-seal.php
 * @param string $data
...
/**
 * Open sealed data
 * @link https://php.net/manual/ru/function.openssl-open.php
 * @param string $data
 * @param string &$output <p>
 ...
 * @link https://secure.php.net/manual/ru/function.openssl-pbkdf2.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs7-verify.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs7-decrypt.php
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs7-sign.php
 * @param string $input_filename
 ...
 * @link https://php.net/manual/ru/function.openssl-pkcs7-encrypt.php
 * @param string $input_filename
 * @param string $output_filename
 * @param OpenSSLCertificate|string|resource $certificate <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-private-encrypt.php
 * @param string $data
 ...
 * @link https://php.net/manual/ru/function.openssl-private-decrypt.php
 * @param string $data
 ...
 * @link https://php.net/manual/ru/function.openssl-public-encrypt.php
 * @param string $data
 ...
 * @link https://php.net/manual/ru/function.openssl-public-decrypt.php
 * @param string $data
 * @param string &$decrypted_data
 * @param OpenSSLAsymmetricKey|OpenSSLCertificate|array|string $public_key <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-get-md-methods.php
 ...
 * @link https://php.net/manual/ru/function.openssl-get-cipher-methods.php
 * @param bool $aliases [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-dh-compute-key.php
 ...
 * @link https://php.net/manual/ru/function.openssl-random-pseudo-bytes.php
 * @param int $length <p>
 ...
 * @link https://php.net/manual/ru/function.openssl-error-string.php
 ...
 * @link https://php.net/manual/ru/function.openssl-get-cert-locations.php
 ...
 * <b>openssl_verify</b>.
 * @link https://php.net/manual/ru/openssl.constants.php
 */
...
/** @link https://php.net/manual/ru/openssl.ciphers.php */
