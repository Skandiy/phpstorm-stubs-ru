...
/**
 * @link https://secure.php.net/manual/ru/class.lua.php
 */
class Lua
{
    /**
     * @var string
     *
     * @link https://secure.php.net/manual/ru/class.lua.php#lua.constants.lua-version
     */
    public const LUA_VERSION = '5.1.4';

    /**
     * @param null|string $lua_script_file
     * @link https://secure.php.net/manual/ru/lua.construct.php
     */
    public function __construct(?string $lua_script_file = null) {}

    /**
     * @link https://secure.php.net/manual/ru/lua.assign.php
     *
     * @param string $name
     * @param mixed $value
     *
    ...
    /**
     * @link https://secure.php.net/manual/ru/lua.call.php
     *
    ...
    /**
     * @link https://secure.php.net/manual/ru/lua.eval.php
     *
    ...
    /**
     * @link https://secure.php.net/manual/ru/lua.include.php
     *
     * @param string $file
     *
    ...
    /**
     * @link https://secure.php.net/manual/ru/lua.getversion.php
     *
    ...
    /**
     * @link https://secure.php.net/manual/ru/lua.registercallback.php
     *
     * @param string $name
