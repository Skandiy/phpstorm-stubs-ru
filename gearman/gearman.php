<?php
/**
 * @link https://php.net/manual/ru/gearman.constants.php
 */
...
class GearmanClient
{
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.construct.php
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.returncode.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.error.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.geterrno.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.removeoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.timeout.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.settimeout.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.context.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setcontext.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addservers.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.dohigh.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     ...
     * priority tasks in the job queue.
     *
     * @link https://php.net/manual/ru/gearmanclient.dolow.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string A string representing the results of running a task
     ...
     * the task.
     *
     * @link https://php.net/manual/ru/gearmanclient.dojobhandle.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.dostatus.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.dobackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.dohighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.dolowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.jobstatus.php
     ...
     * parallel.
     *
     * @link https://php.net/manual/ru/gearmanclient.addtask.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addtaskhigh.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addtasklow.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * perform the work.
     *
     * @link https://php.net/manual/ru/gearmanclient.addtaskbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * selected from the queue before those of normal or low priority.
     *
     * @link https://php.net/manual/ru/gearmanclient.addtaskhighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addtasklowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.addtaskstatus.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setworkloadcallback.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setcreatedcallback.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setdatacallback.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setwarningcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setstatuscallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setcompletecallback.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setexceptioncallback.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.setfailcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.clearcallbacks.php
     * @return bool Always returns true
     */
     ...
     * parallel.
     *
     * @link https://php.net/manual/ru/gearmanclient.runtasks.php
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanclient.ping.php
     * @param string $workload
     * @return bool
     */
...
class GearmanTask
{
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.functionname.php
     ...
     * server.
     *
     * @link https://php.net/manual/ru/gearmantask.unique.php
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.jobhandle.php
     ...
     * server.
     *
     * @link https://php.net/manual/ru/gearmantask.isknown.php
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.isrunning.php
     ...
     * as a fraction.
     *
     * @link https://php.net/manual/ru/gearmantask.tasknumerator.php
     ...
     * as a fraction.
     *
     * @link https://php.net/manual/ru/gearmantask.taskdenominator.php
     * @return int|false A number between 0 and 100, or false if cannot be determined
     */
     ...
     * .
     *
     * @link https://php.net/manual/ru/gearmantask.sendworkload.php
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.data.php
     ...
     *
     * @link https://php.net/manual/ru/gearmantask.datasize.php
     ...
     * .
     *
     * @link https://php.net/manual/ru/gearmantask.recvdata.php
...
class GearmanWorker
{
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.construct.php
     */
    public function __construct() {}
     ...
     * Returns the last Gearman return code.
     *
     * @link https://php.net/manual/ru/gearmanworker.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     * Returns an error string for the last error encountered.
     *
     * @link https://php.net/manual/ru/gearmanworker.error.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.geterrno.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.options.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.setoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.addoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.removeoptions.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.timeout.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.settimeout.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.setid.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.addservers.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.wait.php
     * @return bool
     */
    public function wait() {}
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.register.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.unregister.php
     * @param string $function_name The name of a function to register with the job
     *        server
     * @return bool A standard Gearman return value
     */
     ...
     * sent to this worker.
     *
     * @link https://php.net/manual/ru/gearmanworker.unregisterall.php
     * @return bool A standard Gearman return value
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.addfunction.php
     * @param string $function_name The name of a function to register with the job
     *        server
     ...
     *
     * @link https://php.net/manual/ru/gearmanworker.work.php
     * @return bool
     */
...
class GearmanJob
{
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.setreturn.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.senddata.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.sendwarning.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.sendstatus.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.sendcomplete.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.sendexception.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.sendfail.php
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.handle.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.functionname.php
     ...
     * client.
     *
     * @link https://php.net/manual/ru/gearmanjob.unique.php
     ...
     *
     * @link https://php.net/manual/ru/gearmanjob.workload.php
     ...
     * bytes.
     *
     * @link https://php.net/manual/ru/gearmanjob.workloadsize.php
