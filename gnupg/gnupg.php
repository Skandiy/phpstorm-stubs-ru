...
/** GNUPG Constants
 * @link https://php.net/manual/ru/gnupg.constants.php
 */
 ...
 * @link https://php.net/manual/ru/book.gnupg.php
 * Class gnupg
 */
class gnupg
{
     ...
     * @link https://php.net/manual/ru/function.gnupg-adddecryptkey.php
     *
     * @param string $kye
     ...
     * @link https://php.net/manual/ru/function.gnupg-verify.php
     *
     * @param string $text
     ...
     * @link https://php.net/manual/ru/function.gnupg-addencryptkey.php
     *
     * @param string $kye
     *
     * @return bool
     ...
     * @link https://php.net/manual/ru/function.gnupg-addsignkey.php
     *
     * @param string $kye
     * @param string $passphrase
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-cleardecryptkeys.php
     *
     * @return bool
     */
     ...
     * @link https://php.net/manual/ru/function.gnupg-clearencryptkeys.php
     *
     * @return bool
     */
     ...
     * @link https://php.net/manual/ru/function.gnupg-clearsignkeys.php
     *
     * @return bool
     */
     ...
     * @link https://php.net/manual/ru/function.gnupg-decrypt.php
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-decryptverify.php
     *
     * @param string $enctext
     * @param string &$plaintext
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-encrypt.php
     *
     * @param string $text
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-encryptsign.php
     *
     * @param string $text
     *
    ...
    /**
     * Exports a key
     * @link https://php.net/manual/ru/function.gnupg-export.php
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-geterror.php
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-getprotocol.php
     *
    ...
    /**
     * Imports a key
     * @link https://php.net/manual/ru/function.gnupg-import.php
     *
     * @param string $kye
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-init.php
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-keyinfo.php
     *
     * @param string $pattern
     *
     ...
     * @link https://php.net/manual/ru/function.gnupg-setarmor.php
     *
     * @param int $armor
     *
     * @return bool
     ...
     * @link https://php.net/manual/ru/function.gnupg-seterrormode.php
     *
     * @param int $errnmode
     *
     * @return void
     ...
     * @link https://php.net/manual/ru/function.gnupg-setsignmode.php
     *
     * @param int $signmode
     *
     * @return bool
    ...
    /**
     * Signs a given text
     * @link https://php.net/manual/ru/function.gnupg-sign.php
     *
     * @param string $text
     *
...
/**
 * Initialize a connection
 * @link https://www.php.net/manual/ru/function.gnupg-init.php
 * @param $options
 * @return resource
 */
...
/**
 * Returns an array with information about all keys that matches the given pattern
 * @link https://www.php.net/manual/ru/function.gnupg-keyinfo.php
...
/**
 * Signs a given text
 * @link https://www.php.net/manual/ru/function.gnupg-sign.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Removes all keys which were set for signing before
 * @link https://www.php.net/manual/ru/function.gnupg-clearsignkeys.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Verifies a signed text
 * @link https://www.php.net/manual/ru/function.gnupg-verify.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Removes all keys which were set for encryption before
 * @link https://www.php.net/manual/ru/function.gnupg-clearencryptkeys.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @return bool Returns true on success or false on failure.
 */
...
/**
 * Removes all keys which were set for decryption before
 * @link https://www.php.net/manual/ru/function.gnupg-cleardecryptkeys.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @return bool Returns true on success or false on failure.
 */
...
/**
 * Add a key for decryption
 * @link https://www.php.net/manual/ru/function.gnupg-adddecryptkey.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Add a key for encryption
 * @link https://www.php.net/manual/ru/function.gnupg-addencryptkey.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @param string $kye The fingerprint key.
 * @return bool Returns true on success or false on failure.
 */
...
/**
 * Toggle armored output
 * @link https://www.php.net/manual/ru/function.gnupg-setarmor.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Encrypts a given text
 * @link https://www.php.net/manual/ru/function.gnupg-encrypt.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Decrypts a given text
 * @link https://www.php.net/manual/ru/function.gnupg-decrypt.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Exports a key
 * @link https://www.php.net/manual/ru/function.gnupg-export.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Imports a key
 * @link https://www.php.net/manual/ru/function.gnupg-import.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Returns the currently active protocol for all operations
 * @link https://www.php.net/manual/ru/function.gnupg-getprotocol.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Sets the mode for signing
 * @link https://www.php.net/manual/ru/function.gnupg-setsignmode.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
...
/**
 * Encrypts and signs a given text
 * @link https://www.php.net/manual/ru/function.gnupg-encryptsign.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @param string $text The text being encrypted.
 * @return string|false On success, this function returns the encrypted and signed text.
 * On failure, this function returns false.
 ...
 * @link https://www.php.net/manual/ru/function.gnupg-decryptverify.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @param string $enctext The text being decrypted.
...
/**
 * Returns the errortext, if a function fails
 * @link https://www.php.net/manual/ru/function.gnupg-geterror.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @return string|false Returns an errortext, if an error has occurred, otherwise false.
 */
...
/**
 * Add a key for signing
 * @link https://www.php.net/manual/ru/function.gnupg-addsignkey.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
 * @param string $kye The fingerprint key.
 * @param string $passphrase The pass phrase.
 * @return bool Returns true on success or false on failure.
...
/**
 * Sets the mode for error_reporting
 * @link https://www.php.net/manual/ru/function.gnupg-seterrormode.php
 * @param resource $res The gnupg identifier, from a call to gnupg_init() or gnupg.
