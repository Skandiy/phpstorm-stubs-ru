 ...
 * @license CC-BY 3.0, https://www.php.net/manual/ru/cc.license.php
 */
...
namespace Ds;
    ...
    interface Collection extends Traversable, Countable, JsonSerializable
    {
         ...
         * @link https://www.php.net/manual/ru/ds-collection.clear.php
         */
        public function clear(): void;

        /**
         * Returns a shallow copy of the collection.
         * @link https://www.php.net/manual/ru/ds-collection.copy.php
         * @return Collection
         */
         ...
         * @link https://www.php.net/manual/ru/ds-collection.isempty.php
         * @return bool
         */
         ...
         * @link https://www.php.net/manual/ru/ds-collection.toarray.php
    ...
    interface Hashable
    {
         ...
         * same hash value.
         * @see https://www.php.net/manual/ru/ds-hashable.hash.php
         * @link https://www.php.net/manual/ru/ds-hashable.equals.php
         ...
         * @link https://www.php.net/manual/ru/ds-hashable.hash.php
         */
    ...
    interface Sequence extends Collection
    {
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.allocate.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.apply.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.capacity.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.contains.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.filter.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.find.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.first.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.get.php
         */
         ...
         * @throws OutOfRangeException if the index is not valid.
         * @link https://www.php.net/manual/ru/ds-sequence.insert.php
         */
         ...
         * string.
         * @link https://www.php.net/manual/ru/ds-sequence.join.php
         */
         ...
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-sequence.last.php
         */
         ...
         * affected.</p>
         * @link https://www.php.net/manual/ru/ds-sequence.map.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.merge.php
         */
         ...
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-sequence.pop.php
         */
        public function pop();
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.reduce.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.remove.php
         */
        public function remove(int $index);

        /**
         * Reverses the sequence in-place.
         * @link https://www.php.net/manual/ru/ds-sequence.reverse.php
         */
         ...
         * rotated.
         * @link https://www.php.net/manual/ru/ds-sequence.rotate.php
         */
         ...
         * @throws OutOfRangeException if the index is not valid.
         * @link https://www.php.net/manual/ru/ds-sequence.set.php
         */
         ...
         * @return mixed
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-sequence.shift.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-sequence.slice.php
         */
         ...
         * values as equal.</p>
         * @link https://www.php.net/manual/ru/ds-sequence.sort.php
         */
     ...
     * </ul>
     *
     * @link https://www.php.net/manual/ru/class.ds-vector.php
     *
     * @package Ds
     */
    class Vector implements Sequence
    {
         ...
         * @link https://www.php.net/manual/ru/ds-vector.allocate.php
         */
        public function allocate(int $capacity): void {}
         ...
         * @link https://www.php.net/manual/ru/ds-vector.apply.php
         */
        public function apply(callable $callback): void {}
         ...
         * Returns the current capacity.
         * @return int The current capacity.
         * @link https://www.php.net/manual/ru/ds-vector.capacity.php
         */
        public function capacity(): int {}

        /**
         * Removes all values from the vector.
         * @link https://www.php.net/manual/ru/ds-vector.clear.php
         */
        public function clear(): void {}
         ...
         * @link https://www.php.net/manual/ru/ds-vector.contains.php
         */
        public function contains(...$values): bool {}
         ...
         * either the callback returned TRUE, or all values that convert to
         * TRUE if a callback was not provided.
         * @link https://www.php.net/manual/ru/ds-vector.filter.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-vector.find.php
         */
        public function find($value) {}
         ...
         * @return mixed
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-vector.first.php
         */
        public function first() {}
         ...
         * @param int $index The index to access, starting at 0.
         * @return mixed
         * @link https://www.php.net/manual/ru/ds-vector.get.php
         */
        public function get(int $index) {}
         ...
         * @link https://www.php.net/manual/ru/ds-vector.insert.php
         */
        public function insert(int $index, ...$values): void {}
         ...
         * @link https://www.php.net/manual/ru/ds-vector.join.php
         */
         ...
         *
         * @return mixed The last value in the sequence.
         * @link https://www.php.net/manual/ru/ds-vector.last.php
         */
        public function last() {}
         ...
         *
         * @return Vector
         * @link https://www.php.net/manual/ru/ds-vector.map.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-vector.merge.php
         */
         ...
         *
         * @return mixed
         * @link https://www.php.net/manual/ru/ds-vector.pop.php
         */
        public function pop() {}
         ...
         * Adds values to the end of the sequence.
         * @param array $values
         * @link https://www.php.net/manual/ru/ds-vector.push.php
         */
        public function push(...$values): void {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-vector.reduce.php
         */
        public function reduce(callable $callback, $initial = null) {}
         ...
         * @param int $index The index of the value to remove.
         * @return mixed The value that was removed.
         * @link https://www.php.net/manual/ru/ds-vector.remove.php
         */
        public function remove(int $index) {}

        /**
         * Reverses the sequence in-place.
         * @link https://www.php.net/manual/ru/ds-vector.reverse.php
         */
        public function reverse(): void {}
         ...
         * @link https://www.php.net/manual/ru/ds-vector.reversed.php
         */
         ...
         * if negative.
         *
         * @link https://www.php.net/manual/ru/ds-vector.rotate.php
         *
         ...
         * Updates a value at a given index.
         *
         * @link https://www.php.net/manual/ru/ds-vector.set.php
         *
         * @param int $index The index of the value to update.
         * @param mixed $value The new value.
         *
         ...
         * Removes and returns the first value.
         *
         * @link https://www.php.net/manual/ru/ds-vector.shift.php
         *
        ...
        /**
         * Creates a sub-sequence of a given range.
         * @link https://www.php.net/manual/ru/ds-vector.slice.php
        ...
        /**
         * Sorts the sequence in-place, using an optional comparator function.
         * @link https://www.php.net/manual/ru/ds-vector.sort.php
        ...
        /**
         * Returns a sorted copy, using an optional comparator function.
         * @link https://www.php.net/manual/ru/ds-vector.sorted.php
         ...
         * calculating the sum.
         * @link https://www.php.net/manual/ru/ds-vector.sum.php
         * @return float
         */
         ...
         * passed.
         * @link https://www.php.net/manual/ru/ds-vector.unshift.php
         */
        public function unshift($values): void {}

        /**
         * Count elements of an object
         * @link https://php.net/manual/ru/ds-vector.count.php
        ...
        /**
         * Returns whether the collection is empty.
         * @link https://www.php.net/manual/ru/ds-vector.isempty.php
         * @return bool
         */
        public function isEmpty(): bool {}
         ...
         * Converts the collection to an array.
         * <p><b>Note:</b> Casting to an array is not supported yet.</p>
         * @link https://www.php.net/manual/ru/ds-vector.toarray.php
         * @return array An array containing all the values in the same order as
         * the collection.
         */
        public function toArray(): array {}
         ...
         * @link https://php.net/manual/ru/ds-vector.jsonserialize.php
    ...
    class Deque implements Sequence
    {
         ...
         *
         * @link https://www.php.net/manual/ru/ds-deque.construct.php
         */
        public function __construct(...$values) {}

        /**
         * Count elements of an object
         * @link https://php.net/manual/ru/countable.count.php
         * @return int The custom count as an integer.
         * <p>
         * The return value is cast to an integer.
         * </p>
         ...
         * @link https://www.php.net/manual/ru/ds-deque.clear.php
         */
        public function clear(): void {}

        /**
         * Returns a shallow copy of the deque.
         * @link https://www.php.net/manual/ru/ds-deque.copy.php
         * @return Collection
         */
         ...
         * @link https://www.php.net/manual/ru/ds-deque.isempty.php
         * @return bool
         */
        public function isEmpty(): bool {}
         ...
         * <p><b>Note:</b> Casting to an array is not supported yet.</p>
         * @link https://www.php.net/manual/ru/ds-deque.toarray.php
         * @return array An array containing all the values in the same order as
         * the deque.
         */
        public function toArray(): array {}
         ...
         * @link https://www.php.net/manual/ru/ds-deque.allocate.php
         */
        public function allocate(int $capacity): void {}
         ...
         * <code>callback ( mixed $value ) : mixed</code>
         * </p>
         * @link https://www.php.net/manual/ru/ds-deque.apply.php
         */
        public function apply(callable $callback): void {}
         ...
         * Returns the current capacity.
         * @return int The current capacity.
         * @link https://www.php.net/manual/ru/ds-deque.capacity.php
         */
        public function capacity(): int {}
         ...
         * @link https://www.php.net/manual/ru/ds-deque.contains.php
         */
        public function contains(...$values): bool {}
         ...
         * either the callback returned TRUE, or all values that convert to
         * TRUE if a callback was not provided.
         * @link https://www.php.net/manual/ru/ds-deque.filter.php
         */
         ...
         * @param mixed $value The value to find.
         * @return int|false The index of the value, or FALSE if not found.
         * @link https://www.php.net/manual/ru/ds-deque.find.php
         */
        public function find($value) {}
         ...
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-deque.first.php
         */
        public function first() {}
         ...
         * @return mixed The value at the requested index.
         * @throws OutOfRangeException if the index is not valid.
         * @link https://www.php.net/manual/ru/ds-deque.get.php
         */
        public function get(int $index) {}
         ...
         * @param mixed ...$values The value or values to insert.
         * @throws OutOfRangeException if the index is not valid.
         * @link https://www.php.net/manual/ru/ds-deque.insert.php
         */
        public function insert(int $index, ...$values): void {}
         ...
         * string.
         * @link https://www.php.net/manual/ru/ds-deque.join.php
         */
        public function join(string $glue = ''): string {}
         ...
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-deque.last.php
         */
        public function last() {}
         ...
         * affected.</p>
         * @link https://www.php.net/manual/ru/ds-deque.map.php
         */
         ...
         * then returning that copy.
         * @link https://www.php.net/manual/ru/ds-deque.merge.php
         */
         ...
         * @return mixed The removed last value.
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-deque.pop.php
         */
        public function pop() {}
         ...
         * @param mixed $initial The initial value of the carry value. Can be NULL.
         * @return mixed The return value of the final callback.
         * @link https://www.php.net/manual/ru/ds-deque.reduce.php
         */
        public function reduce(callable $callback, $initial = null) {}
         ...
         * @param int $index The index of the value to remove.
         * @return mixed The value that was removed.
         * @link https://www.php.net/manual/ru/ds-deque.remove.php
         */
        public function remove(int $index) {}

        /**
         * Reverses the deque in-place.
         * @link https://www.php.net/manual/ru/ds-deque.reverse.php
         */
        public function reverse(): void {}
         ...
         * rotated.
         * @link https://www.php.net/manual/ru/ds-deque.rotate.php
         */
        public function rotate(int $rotations): void {}
         ...
         * @param mixed $value The new value.
         * @throws OutOfRangeException if the index is not valid.
         * @link https://www.php.net/manual/ru/ds-deque.set.php
         */
        public function set(int $index, $value): void {}
         ...
         * @return mixed
         * @throws UnderflowException if empty.
         * @link https://www.php.net/manual/ru/ds-deque.shift.php
         */
        public function shift() {}
         ...
         * @link https://www.php.net/manual/ru/ds-deque.slice.php
         */
         ...
         * both be cast to an integer value of 0, which will compare such
         * values as equal.</p>
         * @link https://www.php.net/manual/ru/ds-deque.sort.php
         */
        public function sort(?callable $comparator = null): void {}
    ...
    class Map implements Collection
    {
         ...
         * @param mixed ...$values A traversable object or an array to use for the initial values.
         *
         * @link https://www.php.net/manual/ru/ds-map.construct.php
         */
        public function __construct(...$values) {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.allocate.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.apply.php
         */
         ...
         * @return int
         *
         * @link https://www.php.net/manual/ru/ds-map.capacity.php
         */
        public function capacity(): int {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.diff.php
         */
         ...
         * @return Map
         *
         * @link https://www.php.net/manual/ru/ds-map.filter.php
         */
         ...
         * @throws UnderflowException if empty
         *
         * @link https://www.php.net/manual/ru/ds-map.first.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.get.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.hasKey.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.hasValue.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.intersect.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.isempty.php
         */
        public function isEmpty(): bool {}
         ...
         * </p>
         *
         * @link https://www.php.net/manual/ru/ds-map.toarray.php
         * @return array An array containing all the values in the same order as
         * the map.
         */
        public function toArray(): array {}
        ...
        /**
         * Specify data which should be serialized to JSON
         * @link https://php.net/manual/ru/jsonserializable.jsonserialize.php
         * @return mixed data which can be serialized by <b>json_encode</b>,
         * which is a value of any type other than a resource.
         * @since 5.4
         */
         ...
         * @link https://www.php.net/manual/ru/ds-map.keys.php
         ...
         * equal.</p>
         * @link https://www.php.net/manual/ru/ds-map.ksort.php
         */
         ...
         * @link https://www.php.net/manual/ru/ds-map.ksorted.php
         */
         ...
         * @throws UnderflowException if empty
         * @link https://www.php.net/manual/ru/ds-map.last.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.map.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.merge.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.pairs.php
         */
         ...
         * the string key.
         *
         * @link https://www.php.net/manual/ru/ds-map.put.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.putall.php
         */
         ...
         * NULL.
         *
         * @link https://www.php.net/manual/ru/ds-map.reduce.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.remove.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.reverse.php
         */
         ...
         * <p><b>Note:</b> The current instance is not affected.</p>
         *
         * @link https://www.php.net/manual/ru/ds-map.reversed.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.skip.php
         */
         ...
         * length.
         *
         * @link https://www.php.net/manual/ru/ds-map.slice.php
         */
         ...
         * equal.
         *
         * @link https://www.php.net/manual/ru/ds-map.sort.php
         */
         ...
         * @return Map
         *
         * @link https://www.php.net/manual/ru/ds-map.sorted.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.sum.php
         */
        public function sum(): float|int {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.union.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.values.php
         */
         ...
         *
         * @link https://www.php.net/manual/ru/ds-map.xor.php
         */
    ...
    class Pair implements JsonSerializable
    {
         ...
         * @param mixed $value
         *
         * @link https://php.net/manual/ru/ds-pair.construct.php
         */
         ...
         *
         * @link https://php.net/manual/ru/ds-pair.clear.php
         */
         ...
         *
         * @link https://php.net/manual/ru/ds-pair.copy.php
         */
         ...
         *
         * @link https://php.net/manual/ru/ds-pair.isempty.php
         */
        public function isEmpty(): bool {}
         ...
         * the pair.
         *
         * @link https://php.net/manual/ru/ds-pair.toarray.php
         */
        public function toArray(): array {}

        /**
         * Specify data which should be serialized to JSON
         * @link https://php.net/manual/ru/ds-pair.jsonserialize.php
         * @return mixed data which can be serialized by <b>json_encode</b>,
         * which is a value of any type other than a resource.
         */
        public function jsonSerialize() {}
     ...
     * is ignored.
     *
     * @link https://www.php.net/manual/ru/class.ds-set.php
     *
     * @package Ds
     */
    class Set implements Collection
    {
         ...
         *
         * @link https://php.net/manual/ru/ds-set.construct.php
         */
         ...
         *
         * @link https://php.net/manual/ru/ds-set.add.php
         */
         ...
         *
         * @link https://php.net/manual/ru/ds-set.allocate.php
         */
        public function allocate(int $capacity) {}
         ...
         * @return bool
         *
         * @link https://php.net/manual/ru/ds-set.contains.php
         */
        public function contains(...$values): bool {}

        /**
         * Returns the current capacity.
         * @link https://www.php.net/manual/ru/ds-set.capacity.php
         *
         * @return int
         */
        public function capacity(): int {}
         ...
         * @link https://www.php.net/manual/ru/ds-set.clear.php
         */
        public function clear(): void {}

        /**
         * Count elements of an object
         * @link https://php.net/manual/ru/ds-set.count.php
         * @return int The custom count as an integer.
         * </p>
         * <p>
         * The return value is cast to an integer.
         ...
         * @link https://www.php.net/manual/ru/ds-set.copy.php
         * @return Set
         */
         ...
         * A \ B = {x ∈ A | x ∉ B}
         *
         * @link https://www.php.net/manual/ru/ds-set.diff.php
         *
         ...
         * include
         *
         * @link https://www.php.net/manual/ru/ds-set.filter.php
         *
         * @param null|callable $callback Optional callable which returns TRUE if the
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.first.php
         *
         ...
         * Returns the value at a given index.
         *
         * @link https://www.php.net/manual/ru/ds-set.get.php
         *
         * @param int $index The index to access, starting at 0.
         *
         * @return mixed The value at the requested index.
         ...
         * A ∩ B = {x : x ∈ A ∧ x ∈ B}
         *
         * @link https://www.php.net/manual/ru/ds-set.intersect.php
         *
         ...
         * @link https://www.php.net/manual/ru/ds-set.isempty.php
         *
         * @return bool
         */
        public function isEmpty(): bool {}
         ...
         * between each value.
         *
         * @link https://www.php.net/manual/ru/ds-set.join.php
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.merge.php
         *
         * @param iterable $values A traversable object or an array.
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.reduce.php
         *
         * @param callable $callback
         * <code>callback ( mixed $carry , mixed $value ) : mixed</code>
         ...
         * the set.
         *
         * @link https://www.php.net/manual/ru/ds-set.remove.php
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.reverse.php
         */
        public function reverse() {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.reversed.php
         *
         * <p><b>Note:</b> The current instance is not affected.</p>
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-set.last.php
         *
         ...
         * as equal.</note>
         *
         * @link https://www.php.net/manual/ru/ds-set.sort.php
         */
        public function sort(?callable $comparator = null) {}
         ...
         * Returns a sorted copy, using an optional comparator function.
         *
         * @link https://www.php.net/manual/ru/ds-set.sorted.php
         *
         ...
         * calculating the sum.</p>
         *
         * @link https://www.php.net/manual/ru/ds-set.sum.php
         *
         ...
         * A ∪ B = {x: x ∈ A ∨ x ∈ B}
         *
         * @link https://www.php.net/manual/ru/ds-set.union.php
         *
         ...
         * A ⊖ B = {x : x ∈ (A \ B) ∪ (B \ A)}
         *
         * @link https://www.php.net/manual/ru/ds-set.xor.php
         *
         * @param Set $set The other set.
         *
         ...
         * <p><b>Note:</b> Casting to an array is not supported yet.</p>
         * @link https://www.php.net/manual/ru/ds-set.toarray.php
         * @return array An array containing all the values in the same order as
         * the collection.
         */
        public function toArray(): array {}
        ...
        /**
         * Specify data which should be serialized to JSON
         * @link https://php.net/manual/ru/ds-set.jsonserialize.php
         * @return mixed data which can be serialized by <b>json_encode</b>,
         * which is a value of any type other than a resource.
         * @since 5.4
         */
     ...
     * @package Ds
     *
     * @link https://www.php.net/manual/ru/class.ds-stack.php
     */
    class Stack implements Collection
    {
         ...
         * for the initial values.
         *
         * @link https://www.php.net/manual/ru/ds-stack.construct.php
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-stack.allocate.php
         *
         * @param int $capacity The number of values for which capacity should
         * be allocated.
         *
         ...
         * Returns the current capacity.
         *
         * @link https://www.php.net/manual/ru/ds-stack.capacity.php
         *
         * @return int The current capacity.
         */
        public function capacity(): int {}
         ...
         * @link https://www.php.net/manual/ru/ds-stack.clear.php
         */
        public function clear(): void {}

        /**
         * Count elements of an object
         * @link https://php.net/manual/ru/ds-stack.count.php
         * @return int The custom count as an integer.
         * </p>
         * <p>
         * The return value is cast to an integer.
        ...
        /**
         * Returns a shallow copy of the collection.
         * @link https://www.php.net/manual/ru/ds-stack.copy.php
         * @return Stack
         */
        ...
        /**
         * Returns whether the collection is empty.
         * @link https://www.php.net/manual/ru/ds-stack.isempty.php
         * @return bool
         */
        public function isEmpty(): bool {}
         ...
         * Converts the collection to an array.
         * <p><b>Note:</b> Casting to an array is not supported yet.</p>
         * @link https://www.php.net/manual/ru/ds-stack.toarray.php
         * @return array An array containing all the values in the same order as
         * the collection.
         */
        public function toArray(): array {}
         ...
         *
         * @link https://www.php.net/manual/ru/ds-queue.peek.php
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-queue.pop.php
         *
         ...
         *
         * @link https://www.php.net/manual/ru/ds-queue.push.php
         *
    ...
    class Queue implements Collection
    {
         ...
         * for the initial values.
         *
         * @link https://www.php.net/manual/ru/ds-queue.construct.php
         *
         * @param iterable $values A traversable object or an
         * array to use for the initial values.
         */
         ...
         * removes the need to reallocate the internal as values are added.
         *
         * @link https://www.php.net/manual/ru/ds-queue.allocate.php
         *
         * @param int $capacity The number of values for which capacity should
         * be allocated.
         *
         ...
         * Returns the current capacity.
         *
         * @link https://www.php.net/manual/ru/ds-queue.capacity.php
         *
         * @return int The current capacity.
         */
        public function capacity(): int {}
         ...
         * @link https://www.php.net/manual/ru/ds-queue.clear.php
         */
        public function clear(): void {}

        /**
         * Count elements of an object
         * @link https://php.net/manual/ru/ds-queue.count.php
         * @return int The custom count as an integer.
         * </p>
         * <p>
         * The return value is cast to an integer.
        ...
        /**
         * Returns a shallow copy of the collection.
         * @link https://www.php.net/manual/ru/ds-queue.copy.php
         * @return Stack
         */
        public function copy(): Stack {}
        ...
        /**
         * Returns whether the collection is empty.
         * @link https://www.php.net/manual/ru/ds-queue.isempty.php
         * @return bool
         */
        public function isEmpty(): bool {}
         ...
         * Converts the collection to an array.
         * <p><b>Note:</b> Casting to an array is not supported yet.</p>
         * @link https://www.php.net/manual/ru/ds-queue.toarray.php
         * @return array An array containing all the values in the same order as
         * the collection.
         */
        public function toArray(): array {}
     ...
     * @package Ds
     *
     * @link https://www.php.net/manual/ru/class.ds-priorityqueue.php
     */
