 ...
 * @link https://php.net/manual/ru/class.ziparchive.php
 */
class ZipArchive implements Countable
{
    /**
     * Zip library version
     * @link https://php.net/manual/ru/zip.constants.php
     * @since 7.4.3
     */
    ...
    /**
     * No encryption
     * @link https://secure.php.net/manual/ru/zip.constants.php
     * @since 7.2
     */
    ...
    /**
     * @link https://www.php.net/manual/ru/zip.constants.php#ziparchive.constants.opsys.default
     * @since 5.6
     */
     ...
     *
     * @link https://php.net/manual/ru/ziparchive.open.php
     *
     ...
     * @link https://php.net/manual/ru/ziparchive.close.php
     ...
     * @link https://www.php.net/manual/ru/ziparchive.count.php
     * @return int
     * @since 7.2
     */
     ...
     * @link https://php.net/manual/ru/ziparchive.getstatusstring.php
     ...
     * Add a new directory
     * @link https://php.net/manual/ru/ziparchive.addemptydir.php
     ...
     * @link https://php.net/manual/ru/ziparchive.addfromstring.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.addfile.php
     ...
     * @link https://php.net/manual/ru/ziparchive.addglob.php
     ...
     * @link https://php.net/manual/ru/ziparchive.addpattern.php
     * @param string $pattern <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.renameindex.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.renamename.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.setarchivecomment.php
     ...
     * @link https://php.net/manual/ru/ziparchive.getarchivecomment.php
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.setcommentindex.php
     * @param int $index <p>
     * Index of the entry.
     * </p>
     * @param string $comment <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.setcommentname.php
     * @param string $name <p>
     * Name of the entry.
     * </p>
     * @param string $comment <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.setcompressionindex.php
     ...
     * https://secure.php.net/manual/ru/ziparchive.setcompressionname.php
     ...
     * @link https://php.net/manual/ru/ziparchive.setencryptionindex.php
     * @param int $index Index of the entry.
     ...
     * @link https://php.net/manual/ru/ziparchive.setencryptionname.php
     * @param string $name Name of the entry.
     * @param int $method The encryption method defined by one of the ZipArchive::EM_ constants.
     * @param string|null $password [optional] Optional password, default used when missing.
     * @return bool Returns TRUE on success or FALSE on failure.
     ...
     * @link https://php.net/manual/ru/ziparchive.getcommentindex.php
     * @param int $index <p>
     * Index of the entry
     * </p>
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.getcommentname.php
     * @param string $name <p>
     * Name of the entry
     * </p>
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.deleteindex.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.deletename.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.statname.php
     * @param string $name <p>
     * Name of the entry
     * </p>
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.statindex.php
     * @param int $index <p>
     * Index of the entry
     * </p>
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.locatename.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.getnameindex.php
     * @param int $index <p>
     * Index of the entry.
     * </p>
     * @param int $flags [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.unchangearchive.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/ziparchive.unchangeall.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/ru/ziparchive.unchangeindex.php
     * @param int $index <p>
     * Index of the entry.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/ru/ziparchive.unchangename.php
     * @param string $name <p>
     * Name of the entry.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/ru/ziparchive.extractto.php
     ...
     * @link https://php.net/manual/ru/ziparchive.getfromname.php
     * @param string $name <p>
     * Name of the entry
     * </p>
     ...
     * @link https://php.net/manual/ru/ziparchive.getfromindex.php
     * @param int $index <p>
     * Index of the entry
     * </p>
     * @param int $len [optional] <p>
     ...
     * @link https://php.net/manual/ru/ziparchive.getstream.php
     * @param string $name <p>
     ...
     * @link https://www.php.net/manual/ru/ziparchive.setexternalattributesname.php
     * @param string $name Name of the entry
     ...
     * @link https://www.php.net/manual/ru/ziparchive.getexternalattributesname.php
     * @param string $name Name of the entry
     ...
     * @link https://www.php.net/manual/ru/ziparchive.setexternalattributesindex.php
     * @param int $index Index of the entry.
     * @param int $opsys The operating system code defined by one of the ZipArchive::OPSYS_ constants.
     * @param int $attr The external attributes. Value depends on operating system.
     * @param int $flags [optional] Optional flags. Currently unused.
     ...
     * @link https://www.php.net/manual/ru/ziparchive.getexternalattributesindex.php
     * @param int $index Index of the entry.
     * @param int &$opsys On success, receive the operating system code defined by one of the ZipArchive::OPSYS_ constants.
     * @param int &$attr On success, receive the external attributes. Value depends on operating system.
     * @param int $flags [optional] If flags is set to ZipArchive::FL_UNCHANGED, the original unchanged attributes are returned.
 ...
 * Open a ZIP file archive
 * @link https://php.net/manual/ru/function.zip-open.php
 * @param string $filename <p>
 * The file name of the ZIP archive to open.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.zip-close.php
 ...
 * @link https://php.net/manual/ru/function.zip-read.php
 * @param resource $zip <p>
 * A ZIP file previously opened with <b>zip_open</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-open.php
 ...
 * @link https://php.net/manual/ru/function.zip-entry-close.php
 * @param resource $zip_entry <p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-read.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 * @param int $len [optional] <p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-filesize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-name.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-compressedsize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://php.net/manual/ru/function.zip-entry-compressionmethod.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
