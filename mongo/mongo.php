 ...
 * Gathered from https://secure.php.net/manual/ru/book.mongo.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongoclient.php
 */
class MongoClient
{
     ...
     * @link https://php.net/manual/ru/mongo.construct.php
     ...
     *         connection {@link https://php.net/manual/ru/mongo.connecting.ssl.php#mongo.connecting.context.ssl context options for SSL}
     *         or {@link https://php.net/manual/ru/context.mongodb.php logging callbacks}.
     *         </p><ul>
     *         <li>
     *         <p>
     *         <em>"context"</em>
     ...
     *         {@link https://php.net/manual/ru/context.ssl.php SSL context options}. See the
     *         {@link https://php.net/manual/ru/mongo.connecting.ssl.php#mongo.connecting.context.ssl Connecting over SSL} tutorial.
     *         </p>
     *         </li>
     *         </ul>
     ...
     * @link https://secure.php.net/manual/ru/mongoclient.close.php
     ...
     *
     * @link https://secure.php.net/manual/ru/mongoclient.connect.php
     *
     * @throws MongoConnectionException
     ...
     * Drops a database
     *
     * @link https://secure.php.net/manual/ru/mongoclient.dropdb.php
     ...
     * (PECL mongo &gt;= 1.3.0)<br/>
     * Gets a database
     * @link https://php.net/manual/ru/mongoclient.get.php
     ...
     * @link https://secure.php.net/manual/ru/mongoclient.killcursor.php
     * @param string $server_hash <p>
     * The server hash that has the cursor. This can be obtained through
     * {@link https://secure.php.net/manual/ru/mongocursor.info.php MongoCursor::info()}.
     * </p>
     * @param int|MongoInt64 $id
     * <p>
     * The ID of the cursor to kill. You can either supply an {@link https://secure.php.net/manual/ru/language.types.integer.php int}
     * containing the 64 bit cursor ID, or an object of the
     * {@link https://secure.php.net/manual/ru/class.mongoint64.php MongoInt64} class. The latter is necessary on 32
     ...
     * @link https://php.net/manual/ru/mongoclient.listdbs.php
     ...
     * @link https://secure.php.net/manual/ru/mongoclient.selectcollection.php
     ...
     * (PECL mongo &gt;= 1.3.0)<br/>
     * Gets a database
     * @link https://secure.php.net/manual/ru/mongo.selectdb.php
     ...
     * @link https://secure.php.net/manual/ru/mongo.switchslave.php
     ...
     * @link https://secure.php.net/manual/ru/mongoclient.tostring.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongo.php
...
class Mongo extends MongoClient
{
     ...
     * @link https://php.net/manual/ru/mongo.getpoolsize.php
     ...
     * @link https://php.net/manual/ru/mongo.getslave.php
     ...
     * @link https://php.net/manual/ru/mongo.getslaveokay.php
     * @return bool Returns the value of slaveOkay for this instance.
     */
    public function getSlaveOkay() {}
    /**
     * Connects to paired database server
     * @link https://secure.php.net/manual/ru/mongo.pairconnect.php
     * @throws MongoConnectionException
     * @return bool
     */
     ...
     * @link https://php.net/manual/ru/mongo.pooldebug.php
     ...
     * @link https://php.net/manual/ru/mongo.setslaveokay.php
     ...
     * @link https://php.net/manual/ru/mongo.setpoolsize.php
     ...
     * @link https://secure.php.net/manual/ru/mongo.persistconnect.php
     ...
     * @link https://secure.php.net/manual/ru/mongo.pairpersistconnect.php
     * @param string $username A username used to identify the connection.
     * @param string $password A password used to identify the connection.
     * @throws MongoConnectionException
     * @return bool If the connection was successful.
     ...
     *
     * @link https://secure.php.net/manual/ru/mongo.connectutil.php
     * @throws MongoConnectionException
     * @return bool If the connection was successful.
     */
    ...
    * @link https://secure.php.net/manual/ru/mongo.lasterror.php
    ...
    * @link https://secure.php.net/manual/ru/mongo.preverror.php
   ...
   #[Deprecated('Use MongoDB::prevError() instead.')]
     ...
     * @link https://secure.php.net/manual/ru/mongo.reseterror.php
     ...
     * @link https://secure.php.net/manual/ru/mongo.forceerror.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongodb.php
 */
class MongoDB
{
    /**
     * Profiling is off.
     * @link https://php.net/manual/ru/class.mongodb.php#mongodb.constants.profiling-off
     */
    public const PROFILING_OFF = 0;

    /**
     * Profiling is on for slow operations (>100 ms).
     * @link https://php.net/manual/ru/class.mongodb.php#mongodb.constants.profiling-slow
     */
    public const PROFILING_SLOW = 1;

    /**
     * Profiling is on for all operations.
     * @link https://php.net/manual/ru/class.mongodb.php#mongodb.constants.profiling-on
     */
     ...
     * Inherited by instances of {@link https://php.net/manual/ru/class.mongocollection.php MongoCollection} derived
     ...
     * ( {@link https://php.net/manual/ru/mongocollection.insert.php MongoCollection::insert()},
     * {@link https://php.net/manual/ru/mongocollection.update.php MongoCollection::update()},
     * {@link https://php.net/manual/ru/mongocollection.remove.php MongoCollection::remove()},
     * {@link https://php.net/manual/ru/mongocollection.save.php MongoCollection::save()}, and
     * {@link https://php.net/manual/ru/mongocollection.ensureindex.php MongoCollection::ensureIndex()} all support this
     ...
     * {@link https://php.net/manual/ru/class.mongocursorexception.php MongoCursorException}. It is tempting to set
     ...
     * {@link https://secure.php.net/manual/ru/class.mongocollection.php MongoCollection} derived from this.
     ...
     * @link https://secure.php.net/manual/ru/mongodb.construct.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.--tostring.php
     ...
     * (PECL mongo &gt;= 1.0.2)<br/>
     * Gets a collection
     * @link https://secure.php.net/manual/ru/mongodb.get.php
    ...
    /**
     * (PECL mongo &gt;= 1.3.0)<br/>
     * @link https://secure.php.net/manual/ru/mongodb.getcollectionnames.php
     ...
     * {@link https://secure.php.net/manual/ru/language.types.array.php array}.
     */
     ...
     * @link https://secure.php.net/manual/ru/mongodb.getgridfs.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.getprofilinglevel.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.getslaveokay.php
     * @return bool Returns the value of slaveOkay for this instance.
     */
    public function getSlaveOkay() {}
    /**
     ...
     * @link https://secure.php.net/manual/ru/mongodb.setprofilinglevel.php
     ...
     * (PECL mongo &gt;= 0.9.0)<br/>
     * Drops this database
     * @link https://secure.php.net/manual/ru/mongodb.drop.php
     * @return array Returns the database response.
     */
     ...
     * @link https://secure.php.net/manual/ru/mongodb.repair.php
     ...
     * (PECL mongo &gt;= 0.9.0)<br/>
     * Gets a collection
     * @link https://secure.php.net/manual/ru/mongodb.selectcollection.php
     ...
     * @link https://php.net/manual/ru/mongodb.setslaveokay.php
     * @param bool $ok [optional] <p>
     * If reads should be sent to secondary members of a replica set for all
     * possible queries using this {@link https://secure.php.net/manual/ru/class.mongodb.php MongoDB} instance.
     * </p>
     * @return bool Returns the former value of slaveOkay for this instance.
     */
     ...
     * @link https://secure.php.net/manual/ru/mongodb.createcollection.php
     * @param string $name The name of the collection.
     ...
     * (PECL mongo &gt;= 0.9.0)<br/>
     * Drops a collection
     * @link https://secure.php.net/manual/ru/mongodb.dropcollection.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.listcollections.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.createdbref.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.getdbref.php
     ...
     * @link https://php.net/manual/ru/mongodb.getwriteconcern.php
     * @return array <p>This function returns an array describing the write concern.
     * The array contains the values w for an integer acknowledgement level or string mode,
     * and wtimeout denoting the maximum number of milliseconds to wait for the server to satisfy the write concern.</p>
     */
     ...
     * @link https://secure.php.net/manual/ru/mongodb.execute.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.command.php
     ...
     * (PECL mongo &gt;= 0.9.5)<br/>
     * Check if there was an error on the most recent db operation performed
     * @link https://secure.php.net/manual/ru/mongodb.lasterror.php
     ...
     * (PECL mongo &gt;= 0.9.5)<br/>
     * Checks for the last error thrown during a database operation
     * @link https://secure.php.net/manual/ru/mongodb.preverror.php
     * @return array Returns the error and the number of operations ago it occurred.
     */
    public function prevError() {}
     ...
     * @link https://secure.php.net/manual/ru/mongodb.reseterror.php
     * @return array Returns the database response.
     */
    public function resetError() {}
     ...
     * @link https://secure.php.net/manual/ru/mongodb.forceerror.php
     ...
     *
     * @link https://secure.php.net/manual/ru/mongodb.authenticate.php
     *
     ...
     * @link https://secure.php.net/manual/ru/mongodb.getreadpreference.php
     ...
     * @link https://secure.php.net/manual/ru/mongodb.setreadpreference.php
    ...
    /**
     * (PECL mongo &gt;= 1.5.0)<br/>
     * @link https://php.net/manual/ru/mongodb.setwriteconcern.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongocollection.php
 */
class MongoCollection
{
    /**
     * @link https://php.net/manual/ru/class.mongocollection.php#mongocollection.constants.ascending
     */
    public const ASCENDING = 1;

    /**
     * @link https://php.net/manual/ru/class.mongocollection.php#mongocollection.constants.descending
     */
     ...
     * {@link https://secure.php.net/manual/ru/class.mongodb.php MongoDB} class has a more detailed description of
     * how <em>w</em> works.
     * </p>
     */
    public $w;
     ...
     * The {@link https://secure.php.net/manual/ru/class.mongodb.php MongoDB} class has a more detailed description
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.construct.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.--tostring.php
    ...
    /**
     * Gets a collection
     * @link https://secure.php.net/manual/ru/mongocollection.get.php
     ...
     * </p>
     * @link https://secure.php.net/manual/ru/mongocollection.aggregate.php
     ...
     * {@link https://php.net/manual/ru/mongocollection.aggregate.php MongoCollection::aggregate()}.
     * This method returns a {@link https://php.net/manual/ru/class.mongocommandcursor.php MongoCommandCursor} object.
     * This cursor object implements the {@link https://php.net/manual/ru/class.iterator.php Iterator} interface
     * just like the {@link https://php.net/manual/ru/class.mongocursor.php MongoCursor} objects that are returned
     * by the {@link https://php.net/manual/ru/mongocollection.find.php MongoCollection::find()} method
     * </p>
     *
     * @link https://php.net/manual/ru/mongocollection.aggregatecursor.php
     *
     ...
     *
     * @return MongoCommandCursor Returns a {@link https://php.net/manual/ru/class.mongocommandcursor.php MongoCommandCursor} object
     */
    public function aggregateCursor(array $pipeline, array $options) {}

    /**
     * Returns this collection's name
     * @link https://secure.php.net/manual/ru/mongocollection.getname.php
     * @return string
     */
     ...
     * (PECL mongo &gt;= 1.1.0)<br/>
     * <p>
     * See {@link https://secure.php.net/manual/ru/mongo.queries.php the query section} of this manual for
     * information on distributing reads to secondaries.
     * </p>
     * @link https://secure.php.net/manual/ru/mongocollection.getslaveokay.php
     * @return bool Returns the value of slaveOkay for this instance.
     */
    public function getSlaveOkay() {}
     ...
     * information on distributing reads to secondaries.
     * </p>
     * @link https://secure.php.net/manual/ru/mongocollection.setslaveokay.php
     * @param bool $ok [optional] <p>
     * If reads should be sent to secondary members of a replica set for all
     * possible queries using this {@link https://secure.php.net/manual/ru/class.mongocollection.php MongoCollection}
     * instance.
     * @return bool Returns the former value of slaveOkay for this instance.
     * </p>
     */
    ...
    /**
     * (PECL mongo &gt;= 1.3.0)<br/>
     * @link https://secure.php.net/manual/ru/mongocollection.getreadpreference.php
     ...
     * (corresponding to the {@link https://secure.php.net/manual/ru/class.mongoclient.php MongoClient} constants), and <em>tagsets</em> containing a list of all tag set criteria. If no tag sets were specified, <em>tagsets</em> will not be present in the array.
     */
    public function getReadPreference() {}
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.drop.php
     * @return array Returns the database response.
     */
    public function drop() {}
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.validate.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.insert.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.batchinsert.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.update.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.remove.php
     ...
     * include:
     * </p><ul>
     * <li><p><em>"w"</em></p><p>See {@link https://secure.php.net/manual/ru/mongo.writeconcerns.php Write Concerns}. The default value for <b>MongoClient</b> is <em>1</em>.</p></li>
     * <li>
     * <p>
     * <em>"justOne"</em>
     * </p>
     ...
     * <li><p><em>"w"</em></p><p>See {@link https://secure.php.net/manual/ru/mongo.writeconcerns.php Write Concerns}. The default value for <b>MongoClient</b> is <em>1</em>.</p></li>
     * <li><p><em>"wTimeoutMS"</em></p><p>This option specifies the time limit, in milliseconds, for {@link https://secure.php.net/manual/ru/mongo.writeconcerns.php write concern} acknowledgement. It is only applicable when <em>"w"</em> is greater than <em>1</em>, as the timeout pertains to replication. If the write concern is not satisfied within the time limit, a <a href="class.mongocursorexception.php" class="classname">MongoCursorException</a> will be thrown. A value of <em>0</em> may be specified to block indefinitely. The default value for {@link https://secure.php.net/manual/ru/class.mongoclient.php MongoClient} is <em>10000</em> (ten seconds).</p></li>
     * </ul>
     *
     * <p>
     * The following options are deprecated and should no longer be used:
     * </p><ul>
     * <li><p><em>"safe"</em></p><p>Deprecated. Please use the {@link https://secure.php.net/manual/ru/mongo.writeconcerns.php write concern} <em>"w"</em> option.</p></li>
     * <li><p><em>"timeout"</em></p><p>Deprecated alias for <em>"socketTimeoutMS"</em>.</p></li>
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.find.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.findone.php
     * @param array $query The fields for which to search.
     * @param array $fields Fields of the results to return.
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.createindex.php
    ...
    /**
     * Creates an index on the given field(s), or does nothing if the index already exists
     * @link https://secure.php.net/manual/ru/mongocollection.ensureindex.php
     * @param array $keys Field or fields to use as index.
     * @param array $options [optional] This parameter is an associative array of the form array("optionname" => `<boolean>`, ...).
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.deleteindex.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.deleteindexes.php
     * @return array Returns the database response.
     */
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.getindexinfo.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.count.php
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.save.php
    ...
    /**
     * Creates a database reference
     * @link https://secure.php.net/manual/ru/mongocollection.createdbref.php
    ...
    /**
     * Fetches the document pointed to by a database reference
     * @link https://secure.php.net/manual/ru/mongocollection.getdbref.php
     * @param array $ref A database reference.
     ...
     * @link https://secure.php.net/manual/ru/mongocollection.group.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongocursor.php
 */
class MongoCursor implements Iterator
{
    /**
     * @link https://php.net/manual/ru/class.mongocursor.php#mongocursor.props.slaveokay
     * @var bool
     */
     ...
     * {link https://secure.php.net/manual/ru/mongocursor.timeout.php MongoCursor::timeout()}. This does not cause the
     * MongoDB server to cancel the operation; it only instructs the driver to
     * stop waiting for a response and throw a
     * {@link https://php.net/manual/ru/class.mongocursortimeoutexception.php MongoCursorTimeoutException} after a set time.
     * </p>
     */
    public static $timeout = 30000;
    /**
     * Create a new cursor
     * @link https://secure.php.net/manual/ru/mongocursor.construct.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.hasnext.php
     * @throws MongoConnectionException
     * @throws MongoCursorTimeoutException
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.getnext.php
     * @throws MongoConnectionException
     * @throws MongoCursorTimeoutException
    ...
    /**
     * (PECL mongo &gt;= 1.3.3)<br/>
     * @link https://secure.php.net/manual/ru/mongocursor.getreadpreference.php
     ...
     * read preference mode (corresponding to the {@link https://secure.php.net/manual/ru/class.mongoclient.php MongoClient} constants), and <em>tagsets</em> containing a list of all tag set criteria. If no tag sets were specified, <em>tagsets</em> will not be present in the array.
     */
    public function getReadPreference() {}

    /**
     * Limits the number of results returned
     * @link https://secure.php.net/manual/ru/mongocursor.limit.php
    ...
    /**
     * (PECL mongo &gt;= 1.2.0)<br/>
     * @link https://secure.php.net/manual/ru/mongocursor.partial.php
    ...
    /**
     * (PECL mongo &gt;= 1.2.1)<br/>
     * @link https://secure.php.net/manual/ru/mongocursor.setflag.php
     * @param int $flag <p>
    ...
    /**
     * (PECL mongo &gt;= 1.3.3)<br/>
     * @link https://secure.php.net/manual/ru/mongocursor.setreadpreference.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.skip.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.slaveOkay.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.tailable.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.immortal.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.timeout.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.dead.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.snapshot.php
     * @throws MongoCursorException
     * @return MongoCursor Returns this cursor
     */
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.sort.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.hint.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.addoption.php
    ...
    /**
     * Execute the query
     * @link https://secure.php.net/manual/ru/mongocursor.doquery.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.current.php
     * @return array
     */
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.key.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.next.php
     * @throws MongoConnectionException
     * @throws MongoCursorTimeoutException
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.valid.php
    ...
    /**
     * Clears the cursor
     * @link https://secure.php.net/manual/ru/mongocursor.reset.php
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.explain.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.count.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.fields.php
     ...
     * @link https://secure.php.net/manual/ru/mongocursor.info.php
     ...
     *
     * @return MongoCursor Returns this cursor.
     * @link https://secure.php.net/manual/ru/mongocursor.batchsize.php
     */
     ...
     * @link https://php.net/manual/ru/mongocursor.maxtimems.php
     * @param int $ms <p>
...
class MongoCommandCursor implements MongoCursorInterface
{
     ...
     * @link https://php.net/manual/ru/iterator.current.php
     ...
     * @link https://php.net/manual/ru/iterator.next.php
     ...
     * @link https://php.net/manual/ru/iterator.key.php
     ...
     * @link https://php.net/manual/ru/iterator.valid.php
     ...
     * @link https://php.net/manual/ru/iterator.rewind.php
     * @return void Any returned value is ignored.
     * @since 5.0.0
     */
    public function rewind() {}
...
class MongoGridFS extends MongoCollection
{
    ...
    /**
     * @link https://php.net/manual/ru/class.mongogridfs.php#mongogridfs.props.chunks
     * @var MongoCollection
     */
    public $chunks;

    /**
     * @link https://php.net/manual/ru/class.mongogridfs.php#mongogridfs.props.filesname
     * @var string
     */
    protected $filesName;

    /**
     * @link https://php.net/manual/ru/class.mongogridfs.php#mongogridfs.props.chunksname
     * @var string
     */
     ...
     *
     * @link https://php.net/manual/ru/mongogridfs.construct.php
     ...
     * @link https://php.net/manual/ru/mongogridfs.drop.php
     * @return array The database response
     */
    public function drop() {}

    /**
     * @link https://php.net/manual/ru/mongogridfs.find.php
     ...
     * @link https://php.net/manual/ru/mongogridfs.storefile.php
     ...
     * @link https://php.net/manual/ru/mongogridfs.storebytes.php
     ...
     * @link https://secure.php.net/manual/ru/mongogridfs.findone.php
     * @param array $query The fields for which to search.
     * @param array $fields Fields of the results to return.
     ...
     * @link https://secure.php.net/manual/ru/mongogridfs.remove.php
     ...
     * @link https://php.net/manual/ru/mongogridfs.delete.php
     ...
     * @link https://secure.php.net/manual/ru/mongogridfs.storeupload.php
     ...
     * @link https://secure.php.net/manual/ru/mongogridfs.get.php
    ...
    /**
     * Stores a file in the database
     * @link https://php.net/manual/ru/mongogridfs.put.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongogridfsfile.php#mongogridfsfile.props.file
     * @var array|null
     */
    public $file;

    /**
     * @link https://php.net/manual/ru/class.mongogridfsfile.php#mongogridfsfile.props.gridfs
     * @var MongoGridFS|null
     */
    protected $gridfs;

    /**
     * @link https://php.net/manual/ru/mongogridfsfile.construct.php
     ...
     * @link https://php.net/manual/ru/mongogridfsfile.getfilename.php
     ...
     * @link https://php.net/manual/ru/mongogridfsfile.getsize.php
     ...
     * @link https://php.net/manual/ru/mongogridfsfile.write.php
     ...
     * @link https://php.net/manual/ru/mongogridfsfile.getbytes.php
     ...
     *
     * @link https://php.net/manual/ru/mongogridfsfile.getresource.php
...
class MongoGridFSCursor extends MongoCursor implements Traversable, Iterator
{
    ...
    /**
     * @link https://php.net/manual/ru/class.mongogridfscursor.php#mongogridfscursor.props.gridfs
     * @var MongoGridFS|null
     */
    protected $gridfs;
    ...
    /**
     * Create a new cursor
     * @link https://php.net/manual/ru/mongogridfscursor.construct.php
     ...
     * @link https://php.net/manual/ru/mongogridfscursor.getnext.php
     ...
     * @link https://php.net/manual/ru/mongogridfscursor.current.php
     ...
     * @link https://php.net/manual/ru/mongogridfscursor.key.php
 ...
 * @link https://secure.php.net/manual/ru/class.mongoid.php
 */
class MongoId
{
     /**
      * @var string <p> Note: The property name begins with a $ character. It may be accessed using
      * {@link https://php.net/manual/ru/language.types.string.php#language.types.string.parsing.complex complex variable parsed syntax} (e.g. $mongoId->{'$id'}).</p>
      */
     public $id = null;
     ...
     * (PECL mongo &gt;= 0.8.0)
     * Creates a new id
     * @link https://secure.php.net/manual/ru/mongoid.construct.php
     ...
     * @link https://php.net/manual/ru/mongoid.isvalid.php
     ...
     * @link https://secure.php.net/manual/ru/mongoid.tostring.php
     ...
     * @link https://php.net/manual/ru/mongoid.getinc.php
     ...
     * (PECL mongo &gt;= 1.0.11)
     * Gets the process ID
     * @link https://php.net/manual/ru/mongoid.getpid.php
     ...
     * @link https://secure.php.net/manual/ru/mongoid.gettimestamp.php
     * @return int
     */
     ...
     * @link https://secure.php.net/manual/ru/mongoid.gethostname.php
     ...
     * @link https://php.net/manual/ru/mongoid.set-state.php
...
class MongoCode
{
     ...
     * .
     *
     * @link https://php.net/manual/ru/mongocode.construct.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongoregex.php#mongoregex.props.regex
     * @var string
     */
    public $regex;

    /**
     * @link https://php.net/manual/ru/class.mongoregex.php#mongoregex.props.flags
     * @var string
     */
    public $flags;
     ...
     *
     * @link https://php.net/manual/ru/mongoregex.construct.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongodate.php#mongodate.props.sec
     * @var int
     */
    public $sec;

    /**
     * @link https://php.net/manual/ru/class.mongodate.php#mongodate.props.usec
     * @var int
     */
    public $usec;
     ...
     *
     * @link https://php.net/manual/ru/mongodate.construct.php
     ...
     * @link https://php.net/manual/ru/mongodate.todatetime.php
     * @return DateTime
     */
...
class MongoBinData
{
    /**
     * Generic binary data.
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.constants.custom
     */
    public const GENERIC = 0x0;

    /**
     * Function
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.constants.func
     */
    public const FUNC = 0x1;

    /**
     * Generic binary data (deprecated in favor of MongoBinData::GENERIC)
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.constants.byte-array
     */
    public const BYTE_ARRAY = 0x2;

    /**
     * Universally unique identifier (deprecated in favor of MongoBinData::UUID_RFC4122)
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.constants.uuid
     */
    ...
    /**
     * MD5
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.constants.md5
     */
    ...
    /**
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.props.bin
     * @var string
     */
    public $bin;

    /**
     * @link https://php.net/manual/ru/class.mongobindata.php#mongobindata.props.type
     * @var int
     */
    public $type;
     ...
     *
     * @link https://php.net/manual/ru/mongobindata.construct.php
...
class MongoDBRef
{
     ...
     *
     * @link https://php.net/manual/ru/mongodbref.create.php
     ...
     *
     * @link https://php.net/manual/ru/mongodbref.isref.php
     ...
     * @link https://php.net/manual/ru/mongodbref.get.php
...
class MongoWriteBatch
{
     ...
     * @link https://php.net/manual/ru/mongowritebatch.construct.php
     * @param MongoCollection $collection The {@see MongoCollection} to execute the batch on.
     * Its {@link https://php.net/manual/ru/mongo.writeconcerns.php write concern}
     ...
     * </thead>
     * <tbody><tr><td>w (int|string)</td><td>{@link https://php.net/manual/ru/mongo.writeconcerns.php Write concern} value</td></tr>
     * <tr><td>wtimeout (int)</td><td>{@link https://php.net/manual/ru/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
     ...
     * @link https://php.net/manual/ru/mongowritebatch.add.php
     * @param array $item <p>
     ...
     * @link https://php.net/manual/ru/mongowritebatch.execute.php
...
class MongoUpdateBatch extends MongoWriteBatch
{
     ...
     * @link https://php.net/manual/ru/mongoupdatebatch.construct.php
     ...
     * </thead>
     * <tbody class="tbody"><tr><td>w (int|string)</td><td>{@link https://php.net/manual/ru/mongo.writeconcerns.php Write concern} value</td></tr>
     * <tr><td>wtimeout (int)</td><td>{@link https://php.net/manual/ru/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://php.net/manual/ru/class.mongowriteconcernexception.php#class.mongowriteconcernexception
 */
class MongoWriteConcernException extends MongoCursorException
{
    /**
     * Get the error document
     * @link https://php.net/manual/ru/mongowriteconcernexception.getdocument.php
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://php.net/manual/ru/class.mongoexecutiontimeoutexception.php
 */
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://php.net/manual/ru/class.mongoduplicatekeyexception.php
 */
class MongoDuplicateKeyException extends MongoWriteConcernException {}

/**
 * <p>(PECL mongo &gt;= 1.3.0)</p>
 * @link https://php.net/manual/ru/class.mongoresultexception.php#mongoresultexception.props.document
 */
class MongoResultException extends MongoException
{
     ...
     * https://secure.php.net/manual/ru/mongoresultexception.getdocument.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongotimestamp.php#mongotimestamp.props.sec
     * @var int
     */
    public $sec;

    /**
     * @link https://php.net/manual/ru/class.mongotimestamp.php#mongotimestamp.props.inc
     * @var int
     */
    public $inc;
     ...
     *
     * @link https://php.net/manual/ru/mongotimestamp.construct.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongoint32.php#mongoint32.props.value
     * @var string
     */
    public $value;
     ...
     *
     * @link https://php.net/manual/ru/mongoint32.construct.php
...
{
    /**
     * @link https://php.net/manual/ru/class.mongoint64.php#mongoint64.props.value
     * @var string
     */
    public $value;
     ...
     *
     * @link https://php.net/manual/ru/mongoint64.construct.php
     * @param string $value A number
     */
    public function __construct($value) {}
...
{
    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.none
     */
    public const NONE = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.all
     */
    public const ALL = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.warning
     */
    public const WARNING = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.info
     */
    public const INFO = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.fine
     */
    public const FINE = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.rs
     */
    public const RS = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.pool
     */
    public const POOL = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.io
     */
    public const IO = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.server
     */
    public const SERVER = 0;

    /**
     * @link https://php.net/manual/ru/class.mongolog.php#mongolog.constants.parse
     */
     ...
     * (PECL mongo &gt;= 1.3.0)<br/>
     * <p>
     * This function will set a callback function to be called for {@link https://secure.php.net/manual/ru/class.mongolog.php MongoLog} events
     * instead of triggering warnings.
     * </p>
     * @link https://secure.php.net/manual/ru/mongolog.setcallback.php
     ...
     * <b><i>module</i></b>
     *
     * <p>One of the {@link https://secure.php.net/manual/ru/class.mongolog.php#mongolog.constants.module MongoLog module constants}.</p>
     * </li>
     * <li>
     * <b><i>level</i></b>
     *
     * <p>One of the {@link https://secure.php.net/manual/ru/class.mongolog.php#mongolog.constants.level MongoLog level constants}.</p>
     * </li>
     * <li>
     * <b><i>message</i></b>
     *
     ...
     *
     * @link https://php.net/manual/ru/mongolog.setlevel.php
     ...
     *
     * @link https://php.net/manual/ru/mongolog.getlevel.php
     ...
     *
     * @link https://php.net/manual/ru/mongolog.setmodule.php
     ...
     *
     * @link https://php.net/manual/ru/mongolog.getmodule.php
...
class MongoPool
{
     ...
     *
     * @link https://php.net/manual/ru/mongopool.info.php
     ...
     *
     * @link https://php.net/manual/ru/mongopool.setsize.php
     ...
     * .
     *
     * @link https://php.net/manual/ru/mongopool.getsize.php
     * @return int Returns the current pool size
     */
