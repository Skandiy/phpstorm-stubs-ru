...
/**
 * @link https://php.net/manual/ru/apc.constants.php
 */
 ...
 * @link https://php.net/manual/ru/function.apc-cache-info.php
 ...
 * @link https://php.net/manual/ru/function.apc-clear-cache.php
 ...
 * @link https://php.net/manual/ru/function.apc-sma-info.php
 ...
 * @link https://php.net/manual/ru/function.apc-store.php
 ...
 * @link https://php.net/manual/ru/function.apc-fetch.php
 ...
 * @link https://php.net/manual/ru/function.apc-delete.php
 ...
 *
 * @link https://php.net/manual/ru/function.apc-define-constants.php
 ...
 * @link https://php.net/manual/ru/function.apc-add.php
 ...
 * @link https://php.net/manual/ru/function.apc-compile-file.php
 ...
 * @link https://php.net/manual/ru/function.apc-load-constants.php
 ...
 * @link https://php.net/manual/ru/function.apc-exists.php
 ...
 *
 * @link https://php.net/manual/ru/function.apc-delete-file.php
 ...
 * @link https://php.net/manual/ru/function.apc-inc.php
 ...
 * @link https://php.net/manual/ru/function.apc-dec.php
 ...
 * @link https://php.net/manual/ru/function.apc-cas.php
 * @param string $key
 * @param int $old
 * @param int $new
 * @return bool
 ...
 *
 * @link https://php.net/manual/ru/function.apc-bin-dump.php
 ...
 * @link https://php.net/manual/ru/function.apc-bin-dumpfile.php
 ...
 * @link https://php.net/manual/ru/function.apc-bin-load.php
 ...
 * @link https://php.net/manual/ru/function.apc-bin-loadfile.php
 ...
 *
 * @link https://php.net/manual/ru/class.apciterator.php
 */
class APCIterator implements Iterator
{
    /**
     * Constructs an APCIterator iterator object
     * @link https://php.net/manual/ru/apciterator.construct.php
     ...
     * @link https://php.net/manual/ru/apciterator.rewind.php
     */
    public function rewind() {}

    /**
     * Checks if the current iterator position is valid
     * @link https://php.net/manual/ru/apciterator.valid.php
     ...
     * @link https://php.net/manual/ru/apciterator.current.php
     ...
     * @link https://php.net/manual/ru/apciterator.key.php
     ...
     * @link https://php.net/manual/ru/apciterator.next.php
     * @return bool Returns TRUE on success or FALSE on failure.
     */
     ...
     * @link https://php.net/manual/ru/apciterator.gettotalhits.php
     ...
     * @link https://php.net/manual/ru/apciterator.gettotalsize.php
    ...
    /**
     * Get the total count
     * @link https://php.net/manual/ru/apciterator.gettotalcount.php
...
/**
 * @link https://php.net/manual/ru/apcu.constants.php
 */
 ...
 * @link https://php.net/manual/ru/function.apcu-clear-cache.php
 *
 ...
 * @link https://php.net/manual/ru/function.apcu-sma-info.php
...
/**
 * Cache a variable in the data store
 * @link https://php.net/manual/ru/function.apcu-store.php
...
/**
 * Fetch a stored variable from the cache
 * @link https://php.net/manual/ru/function.apcu-fetch.php
...
/**
 * Removes a stored variable from the cache
 * @link https://php.net/manual/ru/function.apcu-delete.php
...
/**
 * Caches a variable in the data store, only if it's not already stored
 * @link https://php.net/manual/ru/function.apcu-add.php
 ...
 * @link https://php.net/manual/ru/function.apcu-exists.php
 * @param string|string[] $keys A string, or an array of strings, that contain keys.
 * @return bool|string[] Returns TRUE if the key exists, otherwise FALSE
 * Or if an array was passed to keys, then an array is returned that
 * contains all existing keys, or an empty array if none exist.
...
/**
 * Increase a stored number
 * @link https://php.net/manual/ru/function.apcu-inc.php
 * @param string $key The key of the value being increased.
 * @param int $step The step, or value to increase.
 * @param int $ttl Time To Live; store var in the cache for ttl seconds. After the ttl has passed,
 * the stored variable will be expunged from the cache (on the next request). If no ttl is supplied
...
/**
 * Decrease a stored number
 * @link https://php.net/manual/ru/function.apcu-dec.php
 * @param string $key The key of the value being decreased.
 * @param int $step The step, or value to decrease.
 * @param int $ttl Time To Live; store var in the cache for ttl seconds. After the ttl has passed,
 * the stored variable will be expunged from the cache (on the next request). If no ttl is supplied
 ...
 *
 * @link https://php.net/manual/ru/function.apcu-cas.php
 ...
 * </p>
 *
 * @link https://php.net/manual/ru/function.apcu-entry.php
 *
 ...
 *
 * @link https://php.net/manual/ru/function.apcu-cache-info.php
 *
 ...
 *
 * @link https://www.php.net/manual/ru/function.apcu-enabled.php
 *
 * @return bool
 */
 ...
 * efficient as it's been moved to the C level.
 *
 * @link https://php.net/manual/ru/class.apcuiterator.php
 * @since APCu 5.0.0
 */
class APCUIterator implements Iterator
{
     ...
     * @link https://php.net/manual/ru/apcuiterator.construct.php
    ...
    /**
     * Rewinds back the iterator to the first element
     * @link https://php.net/manual/ru/apcuiterator.rewind.php
     */
    public function rewind() {}

    /**
     * Checks if the current iterator position is valid
     * @link https://php.net/manual/ru/apcuiterator.valid.php
     * @return bool Returns TRUE if the current iterator position is valid, otherwise FALSE.
     */
    public function valid() {}
     ...
     * @link https://php.net/manual/ru/apcuiterator.current.php
     * @return mixed|false Returns the current item on success, or FALSE if no more items or exist, or on failure.
     */
    public function current() {}
    ...
    /**
     * Gets the current iterator key
     * @link https://php.net/manual/ru/apcuiterator.key.php
     * @return string|int|false Returns the key on success, or FALSE upon failure.
     */
    public function key() {}
    ...
    /**
     * Moves the iterator pointer to the next element
     * @link https://php.net/manual/ru/apcuiterator.next.php
     * @return bool Returns TRUE on success or FALSE on failure.
     */
    public function next() {}
    ...
    /**
     * Gets the total number of cache hits
     * @link https://php.net/manual/ru/apcuiterator.gettotalhits.php
     * @return int|false The number of hits on success, or FALSE on failure.
     */
    public function getTotalHits() {}
    ...
    /**
     * Gets the total cache size
     * @link https://php.net/manual/ru/apcuiterator.gettotalsize.php
    ...
    /**
     * Get the total count
     * @link https://php.net/manual/ru/apcuiterator.gettotalcount.php
