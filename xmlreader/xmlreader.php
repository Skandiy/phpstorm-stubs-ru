 ...
 * on the way.
 * @link https://php.net/manual/ru/class.xmlreader.php
 *
...
class XMLReader
{
     ...
     * @link https://php.net/manual/ru/xmlreader.close.php
     ...
     * @link https://php.net/manual/ru/xmlreader.getattribute.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.getattributeno.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.getattributens.php
     * @param string $name <p>
     * The local name.
     * </p>
     ...
     * @link https://php.net/manual/ru/xmlreader.getparserproperty.php
     ...
     * @link https://php.net/manual/ru/xmlreader.isvalid.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/xmlreader.lookupnamespace.php
     ...
     * @link https://php.net/manual/ru/xmlreader.movetoattributeno.php
     * @param int $index <p>
     * The position of the attribute.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/ru/xmlreader.movetoattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
    ...
    /**
     * Move cursor to a named attribute
     * @link https://php.net/manual/ru/xmlreader.movetoattributens.php
     * @param string $name <p>
     * The local name.
     * </p>
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.movetoelement.php
     ...
     * @link https://php.net/manual/ru/xmlreader.movetofirstattribute.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/xmlreader.movetonextattribute.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/xmlreader.open.php
     * @param string $uri <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.read.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/ru/xmlreader.next.php
     ...
     * @link https://php.net/manual/ru/xmlreader.readinnerxml.php
     ...
     * @link https://php.net/manual/ru/xmlreader.readouterxml.php
     ...
     * @link https://php.net/manual/ru/xmlreader.readstring.php
     ...
     * @link https://php.net/manual/ru/xmlreader.setschema.php
    ...
    /**
     * Set parser options
     * @link https://php.net/manual/ru/xmlreader.setparserproperty.php
     * @param int $property <p>
     * One of the parser option
     * constants.
     * </p>
     ...
     * @link https://php.net/manual/ru/xmlreader.setrelaxngschema.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.setrelaxngschemasource.php
     ...
     * @link https://php.net/manual/ru/xmlreader.xml.php
     * @param string $source <p>
     ...
     * @link https://php.net/manual/ru/xmlreader.expand.php
