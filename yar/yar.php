 ...
 * @link https://secure.php.net/manual/ru/yar.constants.php
 */
 ...
 * @link https://secure.php.net/manual/ru/class.yar-server.php
 */
class Yar_Server
{
    protected $_executor;
     ...
     * @link https://secure.php.net/manual/ru/yar-server.construct.php
     */
     ...
     * @return bool
     * @link https://secure.php.net/manual/ru/yar-server.handle.php
     */
...
class Yar_Client
{
     ...
     * @link https://secure.php.net/manual/ru/yar-client.call.php
     */
     ...
     * @link https://secure.php.net/manual/ru/yar-client.construct.php
     */
     ...
     * @link https://secure.php.net/manual/ru/yar-client.setopt.php
     */
...
class Yar_Concurrent_Client
{
     ...
     * @link https://secure.php.net/manual/ru/yar-concurrent-client.call.php
     */
     ...
     * @return bool
     * @link https://secure.php.net/manual/ru/yar-concurrent-client.loop.php
     */
     ...
     * Clean all registered calls
     * @return bool
     * @link https://secure.php.net/manual/ru/yar-concurrent-client.reset.php
     */
 ...
 * @author weizhimiao001@lianjia.com
 * @link https://secure.php.net/manual/ru/class.yar-server-exception.php
 */
class Yar_Server_Exception extends Exception
{
     ...
     * @return string
     * @link https://secure.php.net/manual/ru/yar-server-exception.gettype.php
     */
 ...
 * @author weizhimiao001@lianjia.com
 * @link https://secure.php.net/manual/ru/class.yar-client-exception.php
 */
class Yar_Client_Exception extends Exception
{
     ...
     * @link https://secure.php.net/manual/ru/yar-client-exception.gettype.php
     */
    public function getType() {}
}
