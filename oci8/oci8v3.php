 ...
 * @link https://php.net/manual/ru/class.OCICollection.php
 * @since 8.0
 */
class OCICollection
{
 ...
 * @link https://php.net/manual/ru/function.oci-set-call-timout.php
 ...
 * @link https://www.php.net/manual/ru/function.oci-set-db-operation.php
 * @param resource $connection <p>An Oracle connection identifier,
 * returned by {@see oci_connect}, {@see oci_pconnect},
 * or {@see oci_new_connect}.</p>
