...
/**
 * Class ZMQ
 * @link https://secure.php.net/manual/ru/class.zmq.php
 */
class ZMQ
{
    /**
     ...
     * @link https://secure.php.net/manual/ru/zmq.construct.php
     */
    private function __construct() {}
}
/**
 * Class ZMQContext
 * @link https://secure.php.net/manual/ru/class.zmqcontext.php
 */
class ZMQContext
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqcontext.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqcontext.getopt.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqcontext.getsocket.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqcontext.ispersistent.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqcontext.setopt.php
     *
...
/**
 * Class ZMQSocket
 * @link https://secure.php.net/manual/ru/class.zmqsocket.php
 */
class ZMQSocket
{
    /**
     ...
     * The on_new_socket is called only when a new underlying socket structure is created.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.bind.php
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.connect.php
     *
     * @param string $dsn The bind dsn, for example transport://address.
     * @param bool $force Tries to bind even if the socket has already been bound to the given endpoint.
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.disconnect.php
     *
     * @param string $dsn The bind dsn, for example transport://address.
     *
     * @return ZMQSocket
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.getendpoints.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.getpersistentid.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.getsockopt.php
     *
     * @since 0MQ 2.0.7
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.getsockettype.php
     *
     * @return int <p>
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.ispersistent.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.recv.php
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.recvmulti.php
     *
     * @param int $mode Pass mode flags to receive multipart messages or non-blocking operation. See ZMQ::MODE_* constants.
     *
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.send.php
     *
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.sendmulti.php
     *
     ...
     * @see ZMQ Constant Types for more information.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.setsockopt.php
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/ru/zmqsocket.unbind.php
     *
...
/**
 * Class ZMQPoll
 * @link https://secure.php.net/manual/ru/class.zmqpoll.php
 */
class ZMQPoll
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.add.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.clear.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.count.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.getlasterrors.php
     *
     * @return int[]
     */
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.poll.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqpoll.remove.php
     *
...
/**
 * Class ZMQDevice
 * @link https://secure.php.net/manual/ru/class.zmqdevice.php
 */
class ZMQDevice
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.getidletimeout.php
     *
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.gettimertimeout.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.run.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.setidlecallback.php
     *
     ...
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.setidletimeout.php
     *
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.settimercallback.php
     *
     * @param callable $cb_func Callback function to invoke when the device is idle. Returning false or a value that evaluates to false from this function will cause the device to stop.
     * @param int $timeout How often to invoke the idle callback in milliseconds. The idle callback is invoked periodically when there is no activity on the device. The timeout value guarantees that there is at least this amount of milliseconds between invocations of the callback function.
     * @param mixed $user_data Additional data to pass to the callback function.
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/ru/zmqdevice.settimertimeout.php
     *
